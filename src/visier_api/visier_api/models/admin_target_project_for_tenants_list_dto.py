...
class AdminTargetProjectForTenantsListDTO(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTargetProjectForTenantsListDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTargetProjectForTenantsListDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "targetProjectForTenants": [AdminTargetProjectForTenantDTO.from_dict(_item) for _item in obj["targetProjectForTenants"]] if obj.get("targetProjectForTenants") is not None else None
        })
        return _obj
