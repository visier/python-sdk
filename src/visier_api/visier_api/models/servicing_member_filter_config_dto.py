...
class ServicingMemberFilterConfigDTO(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingMemberFilterConfigDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingMemberFilterConfigDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dimensionFilters": [ServicingDimensionFilterDTO.from_dict(_item) for _item in obj["dimensionFilters"]] if obj.get("dimensionFilters") is not None else None
        })
        return _obj
