...
class ServicingUserUpdateAPIRequestDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["displayName", "employeeId", "accountEnabled", "email", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingUserUpdateAPIRequestDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingUserUpdateAPIRequestDTO from a dict"""
        if obj is None:
            return None
