...
class DataservicesDatamodelCurrencyRatesDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    currency_rates: Optional[List[DataservicesDatamodelCurrencyRateDTO]] = Field(default=None, alias="currencyRates")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelCurrencyRatesDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelCurrencyRatesDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "currencyRates": [DataservicesDatamodelCurrencyRateDTO.from_dict(_item) for _item in obj["currencyRates"]] if obj.get("currencyRates") is not None else None
        })
        return _obj
