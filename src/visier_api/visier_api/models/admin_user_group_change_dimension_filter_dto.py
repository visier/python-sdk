...
class AdminUserGroupChangeDimensionFilterDTO(BaseModel):
    """
    AdminUserGroupChangeDimensionFilterDTO
    """ # noqa: E501
    ...
    member_selections: Optional[List[AdminUserGroupChangeMemberSelectionDTO]] = Field(default=None, description="The dimension members to select in the dynamic filter.", alias="memberSelections")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminUserGroupChangeDimensionFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminUserGroupChangeDimensionFilterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "subjectReferencePath": AdminElementIDsDTO.from_dict(obj["subjectReferencePath"]) if obj.get("subjectReferencePath") is not None else None,
            "memberSelections": [AdminUserGroupChangeMemberSelectionDTO.from_dict(_item) for _item in obj["memberSelections"]] if obj.get("memberSelections") is not None else None
        })
        return _obj
