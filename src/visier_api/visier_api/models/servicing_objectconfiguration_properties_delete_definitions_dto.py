...
class ServicingObjectconfigurationPropertiesDeleteDefinitionsDTO(BaseModel):
    """
    ...
    properties_by_tenant: Optional[List[ServicingObjectconfigurationPropertyDeleteDefinitionsByTenantDTO]] = Field(default=None, description="The properties to delete for each tenant.", alias="propertiesByTenant")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingObjectconfigurationPropertiesDeleteDefinitionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingObjectconfigurationPropertiesDeleteDefinitionsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "propertiesByTenant": [ServicingObjectconfigurationPropertyDeleteDefinitionsByTenantDTO.from_dict(_item) for _item in obj["propertiesByTenant"]] if obj.get("propertiesByTenant") is not None else None
        })
        return _obj
