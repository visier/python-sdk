...
class DataInDataVersionObject(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["tenantCode", "dataVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataInDataVersionObject from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataInDataVersionObject from a dict"""
        if obj is None:
            return None
