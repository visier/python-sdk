...
class DesignerIcimsAuthParamsDTO(BaseModel):
    """
    DesignerIcimsAuthParamsDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["customerId", "username", "password", "clientId", "clientSecret", "region"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerIcimsAuthParamsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerIcimsAuthParamsDTO from a dict"""
        if obj is None:
            return None
