...
class DataInProcessingJobAndStatusResponse(BaseModel):
    """
    ...
    processing_jobs: Optional[List[DataInProcessingJob]] = Field(default=None, description="A list of processing job information.", alias="processingJobs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataInProcessingJobAndStatusResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataInProcessingJobAndStatusResponse from a dict"""
        if obj is None:
            return None
