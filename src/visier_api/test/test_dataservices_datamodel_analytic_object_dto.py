    ...
    def make_instance(self, include_optional) -> DataservicesDatamodelAnalyticObjectDTO:
        ...
        if include_optional:
            return DataservicesDatamodelAnalyticObjectDTO(
                ...
                object_references = [
                    visier_api.models.dataservices/datamodel/object_reference_dto.dataservices.datamodel.ObjectReferenceDTO(
                        id = '', 
                        display_name = '', 
                        description = '', 
                        from_object = '', 
                ...
                population_configuration = visier_api.models.dataservices/datamodel/population_configuration_dto.dataservices.datamodel.PopulationConfigurationDTO(
                    distinguishing_properties = [
                        visier_api.models.dataservices/datamodel/property_reference_dto.dataservices.datamodel.PropertyReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], 
                    ...
                    grouping_dimensions = [
                        visier_api.models.dataservices/datamodel/dimension_reference_dto.dataservices.datamodel.DimensionReferenceDTO(
                            name = '', 
                            qualifying_path = '', )
                        ], )
            )
