        ...
        if include_optional:
            return DesignerDataVersionExportsDTO(
                data_version_exports = [
                    visier_api.models.designer/data_version_export_dto.designer.DataVersionExportDTO(
                        uuid = '', 
                        timestamp = '', 
                        data_version_number = '', 
                        base_data_version_number = '', 
                        tables = [
                            visier_api.models.designer/data_version_export_table_dto.designer.DataVersionExportTableDTO(
                                name = '', 
                                common_columns = None, 
                                new_columns = None, 
                                deleted_columns = [
