    ...
    def make_instance(self, include_optional) -> AdminUserGroupChangeDefinitionDTO:
        ...
        if include_optional:
            return AdminUserGroupChangeDefinitionDTO(
                ...
                display_name = '',
                description = '',
                permission_ids = visier_api.models.admin/element_ids_dto.admin.ElementIDsDTO(
                    ids = [
                        ''
                        ], ),
                users = visier_api.models.admin/user_group_change_users_dto.admin.UserGroupChangeUsersDTO(
