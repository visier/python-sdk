    ...
    def make_instance(self, include_optional) -> ServicingAccessibleTenantProfileAssignmentResponseDTO:
        ...
        if include_optional:
            return ServicingAccessibleTenantProfileAssignmentResponseDTO(
                errors = True,
                bad_tenant_codes = [
                    visier_api.models.servicing/tenant_code_error_dto.servicing.TenantCodeErrorDTO(
                        tenant_code = '', 
                        for_all_children = True, 
                        error = None, )
                    ],
                bad_user_ids = [
                    visier_api.models.servicing/user_id_error_dto.servicing.UserIdErrorDTO(
                        user_id = '', 
                        error = None, )
                    ],
                failed_assignments = [
                    visier_api.models.servicing/failed_accessible_tenant_profile_assignment_dto.servicing.FailedAccessibleTenantProfileAssignmentDTO(
                        user_id = '', 
                        tenant_code = '', 
                        for_all_children = True, 
                        error = None, )
                ...
                successful_assignments = [
                    visier_api.models.servicing/successful_accessible_tenant_profile_assignment_dto.servicing.SuccessfulAccessibleTenantProfileAssignmentDTO(
                        user_id = '', 
                        tenant_code = '', 
                        for_all_children = True, )
                    ]
