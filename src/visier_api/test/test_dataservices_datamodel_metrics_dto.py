    ...
    def make_instance(self, include_optional) -> DataservicesDatamodelMetricsDTO:
        ...
        if include_optional:
            return DataservicesDatamodelMetricsDTO(
                metrics = [
                    visier_api.models.dataservices/datamodel/metric_dto.dataservices.datamodel.MetricDTO(
                        id = '', 
                        display_name = '', 
                        description = '', 
                        data_start_date = '', 
                        ...
                        analytic_object_id = '', 
                        parameters = [
                            visier_api.models.dataservices/datamodel/parameter_definition_dto.dataservices.datamodel.ParameterDefinitionDTO(
