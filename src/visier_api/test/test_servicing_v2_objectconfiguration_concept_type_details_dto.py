    ...
    def make_instance(self, include_optional) -> ServicingV2ObjectconfigurationConceptTypeDetailsDTO:
        ...
        if include_optional:
            return ServicingV2ObjectconfigurationConceptTypeDetailsDTO(
                process = visier_api.models.servicing/v2/objectconfiguration/process_concept_definition_dto.servicing.v2.objectconfiguration.ProcessConceptDefinitionDTO(
