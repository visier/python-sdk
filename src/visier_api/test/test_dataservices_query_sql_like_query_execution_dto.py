    ...
    def make_instance(self, include_optional) -> DataservicesQuerySqlLikeQueryExecutionDTO:
        ...
        if include_optional:
            return DataservicesQuerySqlLikeQueryExecutionDTO(
                query = '',
                options = visier_api.models.dataservices/query/query_execution_options_dto.dataservices.query.QueryExecutionOptionsDTO(
                    ...
                    cell_distribution_options = visier_api.models.dataservices/query/cell_distribution_options_dto.dataservices.query.CellDistributionOptionsDTO(
                        bin_count = 56, ), 
                    axis_visibility = 'SIMPLE', 
                    enable_sparse_results = True, 
                    internal = visier_api.models.dataservices/query/internal_query_execution_options_dto.dataservices.query.InternalQueryExecutionOptionsDTO(
