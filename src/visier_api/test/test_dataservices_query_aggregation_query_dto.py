    ...
    def make_instance(self, include_optional) -> DataservicesQueryAggregationQueryDTO:
        ...
        if include_optional:
            return DataservicesQueryAggregationQueryDTO(
                source = visier_api.models.dataservices/query/aggregation_query_source_dto.dataservices.query.AggregationQuerySourceDTO(
                    formula = '', 
                    metric = '', 
                    metrics = None, ),
                filters = [
                ...
                axes = [
                    visier_api.models.dataservices/query/query_axis_dto.dataservices.query.QueryAxisDTO(
                        formula = '', 
                        selection_concept = None, 
