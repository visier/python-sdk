...
class TestDataInPushDataCancelResponse(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataInPushDataCancelResponse:
        ...
        # uncomment below to create an instance of `DataInPushDataCancelResponse`
        """
        model = DataInPushDataCancelResponse()
        if include_optional:
            return DataInPushDataCancelResponse(
                message = '',
                transfer_session_id = '',
                data_transfer_result_details = [
                    visier_api.models.data_in/data_transfer_result_detail.data_in.DataTransferResultDetail(
                        tenant_code = '', 
                        source_names = [
                            ''
                            ], 
