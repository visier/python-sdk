...
class UploadToExclude(BaseModel):
    ...
    upload_times: Optional[List[StrictStr]] = Field(default=None, description="A comma-separated list of strings representing the upload time of each data upload to exclude.", alias="uploadTimes")
    __properties: ClassVar[List[str]] = ["excludeAll", "tenantCode", "uploadTimes"]
