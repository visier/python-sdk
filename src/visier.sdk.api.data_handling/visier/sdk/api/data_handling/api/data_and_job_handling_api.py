...
from visier.sdk.api.data_handling.api_client import ApiClient, RequestSerialized
from visier.sdk.api.data_handling.api_response import ApiResponse
from visier.sdk.api.data_handling.rest import RESTResponseType
...
class DataAndJobHandlingApi:
    ...
    def job_status(
        ...
        status: Annotated[Optional[StrictStr], Field(description="The specific status to restrict the list of job to.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type end_time: str
        :param status: The specific status to restrict the list of job to.
        :type status: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
