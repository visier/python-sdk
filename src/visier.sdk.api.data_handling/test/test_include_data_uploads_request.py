    ...
    def make_instance(self, include_optional) -> IncludeDataUploadsRequest:
        ...
        if include_optional:
            return IncludeDataUploadsRequest(
                model = visier.sdk.api.data_handling.models.upload_to_include_model.UploadToIncludeModel(
                    uploads = [
                        visier.sdk.api.data_handling.models.upload_to_include.UploadToInclude(
                            include_all = True, 
                            tenant_code = '', 
                            upload_times = [
                                ''
