...
class ServicingPublicapiTransfersDirectDataUploadFileResponseDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Upload response message from the provisioning service")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersDirectDataUploadFileResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersDirectDataUploadFileResponseDTO from a dict"""
        if obj is None:
            return None
