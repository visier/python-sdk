...
class AdminTransfersAssignConnectorCredentialsByTenantResponseDTO(BaseModel):
    """
    AdminTransfersAssignConnectorCredentialsByTenantResponseDTO
    """ # noqa: E501
    connectors: Optional[List[AdminTransfersAssignConnectorWithCredentialsResponseDTO]] = Field(default=None, description="A list of objects representing the assigned credentials and connectors.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersAssignConnectorCredentialsByTenantResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersAssignConnectorCredentialsByTenantResponseDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "connectors": [AdminTransfersAssignConnectorWithCredentialsResponseDTO.from_dict(_item) for _item in obj["connectors"]] if obj.get("connectors") is not None else None,
