...
class AdminExtractorSettingAPIDTO(BaseModel):
    """
    AdminExtractorSettingAPIDTO
    """ # noqa: E501
    ...
    connector_settings: Optional[List[AdminExtractorSettingKeyValueAPIDTO]] = Field(default=None, description="A list of objects representing the settings that are available for the data connector.", alias="connectorSettings")
    __properties: ClassVar[List[str]] = ["connectorId", "displayName", "connectorSettings"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminExtractorSettingAPIDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminExtractorSettingAPIDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "connectorSettings": [AdminExtractorSettingKeyValueAPIDTO.from_dict(_item) for _item in obj["connectorSettings"]] if obj.get("connectorSettings") is not None else None
        })
        return _obj
