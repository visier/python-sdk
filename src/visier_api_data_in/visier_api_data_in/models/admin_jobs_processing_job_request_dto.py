...
class AdminJobsProcessingJobRequestDTO(BaseModel):
    """
    AdminJobsProcessingJobRequestDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tenants", "allTenants", "dataCategoryId", "publishToProduction", "excludedTenants"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminJobsProcessingJobRequestDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminJobsProcessingJobRequestDTO from a dict"""
        if obj is None:
            return None
