...
class ImportDefinitionsAPIDTO(BaseModel):
    ...
    """ # noqa: E501
    data_connectors: Optional[List[ImportDefinitionAPIDTO]] = Field(default=None, description="A list of objects representing all the available data connectors in Production.", alias="dataConnectors")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataConnectors": [ImportDefinitionAPIDTO.from_dict(_item) for _item in obj["dataConnectors"]] if obj.get("dataConnectors") is not None else None,
            "limit": obj.get("limit"),
            "start": obj.get("start")
        })
        return _obj
