...
class DesignerTransfersMedalliaAuthParamsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clientId", "clientSecret", "instanceUrl", "tenantDomainName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerTransfersMedalliaAuthParamsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerTransfersMedalliaAuthParamsDTO from a dict"""
        if obj is None:
            return None
