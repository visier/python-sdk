...
class AssignConnectorCredentialsResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    tenants: Optional[List[AssignConnectorCredentialsByTenantResponseDTO]] = Field(default=None, description="A list of objects representing the tenants and data connectors that were assigned connector credentials.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tenants": [AssignConnectorCredentialsByTenantResponseDTO.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
