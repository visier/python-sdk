...
class DesignerTransfersWorkdayAuthParamsDTO(BaseModel):
    """
    DesignerTransfersWorkdayAuthParamsDTO
    """ # noqa: E501
    ...
    o_auth: Optional[DesignerTransfersWorkdayOAuthParamsDTO] = Field(default=None, alias="oAuth")
    password: Optional[StrictStr] = None
    ref_token: Optional[DesignerTransfersWorkdayRefreshTokenParamsDTO] = Field(default=None, alias="refToken")
    user_id: Optional[StrictStr] = Field(default=None, alias="userId")
    __properties: ClassVar[List[str]] = ["apiKey", "domainName", "implementationName", "integrationSystemId", "oAuth", "password", "refToken", "userId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerTransfersWorkdayAuthParamsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerTransfersWorkdayAuthParamsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "oAuth": DesignerTransfersWorkdayOAuthParamsDTO.from_dict(obj["oAuth"]) if obj.get("oAuth") is not None else None,
            "password": obj.get("password"),
            "refToken": DesignerTransfersWorkdayRefreshTokenParamsDTO.from_dict(obj["refToken"]) if obj.get("refToken") is not None else None,
