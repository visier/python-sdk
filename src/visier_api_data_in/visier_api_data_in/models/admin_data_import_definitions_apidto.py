...
class AdminDataImportDefinitionsAPIDTO(BaseModel):
    """
    AdminDataImportDefinitionsAPIDTO
    """ # noqa: E501
    data_connectors: Optional[List[AdminDataImportDefinitionAPIDTO]] = Field(default=None, description="A list of objects representing all the available data connectors in Production.", alias="dataConnectors")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminDataImportDefinitionsAPIDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminDataImportDefinitionsAPIDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dataConnectors": [AdminDataImportDefinitionAPIDTO.from_dict(_item) for _item in obj["dataConnectors"]] if obj.get("dataConnectors") is not None else None,
            "limit": obj.get("limit"),
            "start": obj.get("start")
        })
        return _obj
