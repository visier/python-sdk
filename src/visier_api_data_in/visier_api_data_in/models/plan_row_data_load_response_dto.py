...
class PlanRowDataLoadResponseDTO(BaseModel):
    ...
    errors: Optional[List[PlanDataLoadErrorDTO]] = Field(default=None, description="A collection of errors encountered during the data load process.")
    ...
    __properties: ClassVar[List[str]] = ["addedRowsCount", "errors", "potentialAddedRowsCount", "potentialRemovedRowsCount", "removedRowsCount"]
