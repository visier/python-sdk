...
class DesignerTransfersCredentialCreationAPIResponseDTO(BaseModel):
    """
    DesignerTransfersCredentialCreationAPIResponseDTO
    """ # noqa: E501
    missing_connection_properties: Optional[List[DesignerTransfersSubjectMissingAccessDTO]] = Field(default=None, description="The properties that the credential cannot access despite successful authentication.  This is only returned for authentications that do not grant access to all data.", alias="missingConnectionProperties")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerTransfersCredentialCreationAPIResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerTransfersCredentialCreationAPIResponseDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "missingConnectionProperties": [DesignerTransfersSubjectMissingAccessDTO.from_dict(_item) for _item in obj["missingConnectionProperties"]] if obj.get("missingConnectionProperties") is not None else None,
