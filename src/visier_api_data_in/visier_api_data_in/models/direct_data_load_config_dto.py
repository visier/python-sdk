...
class DirectDataLoadConfigDTO(BaseModel):
    """
    The configuration for the direct data intake, such as the  direct data intake job type.
    """ # noqa: E501
    job: Optional[DirectDataJobConfigDTO] = Field(default=None, description="The direct data intake job configuration.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "job": DirectDataJobConfigDTO.from_dict(obj["job"]) if obj.get("job") is not None else None
        })
        return _obj
