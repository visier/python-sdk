...
class AdminTransfersExtractorSettingAPIDTO(BaseModel):
    """
    AdminTransfersExtractorSettingAPIDTO
    """ # noqa: E501
    ...
    connector_settings: Optional[List[AdminTransfersExtractorSettingKeyValueAPIDTO]] = Field(default=None, description="A list of objects representing the settings that are available for the data connector.", alias="connectorSettings")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersExtractorSettingAPIDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersExtractorSettingAPIDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "connectorSettings": [AdminTransfersExtractorSettingKeyValueAPIDTO.from_dict(_item) for _item in obj["connectorSettings"]] if obj.get("connectorSettings") is not None else None,
