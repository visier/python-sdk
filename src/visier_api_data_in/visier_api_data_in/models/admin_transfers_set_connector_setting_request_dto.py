...
class AdminTransfersSetConnectorSettingRequestDTO(BaseModel):
    """
    ...
    tenants: Optional[List[AdminTransfersTenantConnectorSettingsRequestDTO]] = Field(default=None, description="The tenant codes and data connector settings to update.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersSetConnectorSettingRequestDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersSetConnectorSettingRequestDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tenants": [AdminTransfersTenantConnectorSettingsRequestDTO.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
