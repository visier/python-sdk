...
class TestAdminAssignConnectorCredentialsByTenantResponseDTO(unittest.TestCase):
    ...
    def testAdminAssignConnectorCredentialsByTenantResponseDTO(self):
        ...
        def validate_instance(instance):
            AdminAssignConnectorCredentialsByTenantResponseDTO.model_validate(inst_req_only)
            instance_deserialized = AdminAssignConnectorCredentialsByTenantResponseDTO.from_dict(instance.to_dict())
