    ...
    def make_instance(self, include_optional) -> DataProviderAuthInformationDTO:
        ...
        if include_optional:
            return DataProviderAuthInformationDTO(
                data_provider_auth_params = visier_api_data_in.models.data_provider_auth_params_dto.DataProviderAuthParamsDTO(
                    ...
                    zoom_auth_params = visier_api_data_in.models.zoom_auth_params_dto.ZoomAuthParamsDTO(
                        ...
                        client_id = '', 
                        client_secret = '', ), ),
                data_provider_basic_information = visier_api_data_in.models.data_provider_basic_information_dto.DataProviderBasicInformationDTO(
                    description = '', 
                    display_name = '', ),
                data_provider_metadata = visier_api_data_in.models.data_provider_basic_metadata_dto.DataProviderBasicMetadataDTO(
