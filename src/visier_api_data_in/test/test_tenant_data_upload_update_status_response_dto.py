...
class TestTenantDataUploadUpdateStatusResponseDTO(unittest.TestCase):
    ...
    def testTenantDataUploadUpdateStatusResponseDTO(self):
        ...
        def validate_instance(instance):
            TenantDataUploadUpdateStatusResponseDTO.model_validate(inst_req_only)
            instance_deserialized = TenantDataUploadUpdateStatusResponseDTO.from_dict(instance.to_dict())
