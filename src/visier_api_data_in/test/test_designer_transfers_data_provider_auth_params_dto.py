...
class TestDesignerTransfersDataProviderAuthParamsDTO(unittest.TestCase):
    """DesignerTransfersDataProviderAuthParamsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignerTransfersDataProviderAuthParamsDTO:
        """Test DesignerTransfersDataProviderAuthParamsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DesignerTransfersDataProviderAuthParamsDTO(
    ...
    def testDesignerTransfersDataProviderAuthParamsDTO(self):
        """Test DesignerTransfersDataProviderAuthParamsDTO"""
        def validate_instance(instance):
            DesignerTransfersDataProviderAuthParamsDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerTransfersDataProviderAuthParamsDTO.from_dict(instance.to_dict())
