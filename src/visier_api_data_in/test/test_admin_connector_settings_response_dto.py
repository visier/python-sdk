...
class TestAdminConnectorSettingsResponseDTO(unittest.TestCase):
    """AdminConnectorSettingsResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminConnectorSettingsResponseDTO:
        """Test AdminConnectorSettingsResponseDTO
    ...
    def testAdminConnectorSettingsResponseDTO(self):
        """Test AdminConnectorSettingsResponseDTO"""
        def validate_instance(instance):
            AdminConnectorSettingsResponseDTO.model_validate(inst_req_only)
            instance_deserialized = AdminConnectorSettingsResponseDTO.from_dict(instance.to_dict())
