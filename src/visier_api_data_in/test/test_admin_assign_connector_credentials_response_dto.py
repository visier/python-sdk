...
class TestAdminAssignConnectorCredentialsResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AdminAssignConnectorCredentialsResponseDTO:
        ...
        if include_optional:
            return AdminAssignConnectorCredentialsResponseDTO(
                tenants = [
                    visier_api_data_in.models.admin/assign_connector_credentials_by_tenant_response_dto.admin.AssignConnectorCredentialsByTenantResponseDTO(
                        tenant_code = '', 
                        connectors = [
                            visier_api_data_in.models.admin/assign_connector_with_credentials_response_dto.admin.AssignConnectorWithCredentialsResponseDTO(
                                connector = None, 
                                credential = None, )
                            ], 
                        status = 'Unknown', 
    ...
    def testAdminAssignConnectorCredentialsResponseDTO(self):
        ...
        def validate_instance(instance):
            AdminAssignConnectorCredentialsResponseDTO.model_validate(inst_req_only)
            instance_deserialized = AdminAssignConnectorCredentialsResponseDTO.from_dict(instance.to_dict())
