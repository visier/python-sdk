...
class TestUserGroupChangeDimensionFilterDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserGroupChangeDimensionFilterDTO:
        ...
        if include_optional:
            return UserGroupChangeDimensionFilterDTO(
                ...
                subject_reference_path = visier_api_administration.models.element_ids_dto.ElementIDsDTO(
                    ids = [
                        ''
                        ], )
            )
    ...
    def testUserGroupChangeDimensionFilterDTO(self):
        ...
        def validate_instance(instance):
            UserGroupChangeDimensionFilterDTO.model_validate(inst_req_only)
            instance_deserialized = UserGroupChangeDimensionFilterDTO.from_dict(instance.to_dict())
