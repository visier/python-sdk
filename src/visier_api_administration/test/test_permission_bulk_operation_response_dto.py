...
class TestPermissionBulkOperationResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionBulkOperationResponseDTO:
        ...
        if include_optional:
            return PermissionBulkOperationResponseDTO(
                failures = [
                    visier_api_administration.models.permission_failure_dto.PermissionFailureDTO(
                        display_name = '', 
                        error = None, 
                        permission_id = '', )
                    ],
                successes = [
                    visier_api_administration.models.permission_success_dto.PermissionSuccessDTO(
                        display_name = '', 
                        permission_id = '', )
                    ]
            )
    ...
    def testPermissionBulkOperationResponseDTO(self):
        ...
        def validate_instance(instance):
            PermissionBulkOperationResponseDTO.model_validate(inst_req_only)
            instance_deserialized = PermissionBulkOperationResponseDTO.from_dict(instance.to_dict())
