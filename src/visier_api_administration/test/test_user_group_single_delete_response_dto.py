...
class TestUserGroupSingleDeleteResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UserGroupSingleDeleteResponseDTO:
        ...
        if include_optional:
            return UserGroupSingleDeleteResponseDTO(
                failure = visier_api_administration.models.user_group_delete_failure_dto.UserGroupDeleteFailureDTO(
                    message = '', 
                    project_id = '', 
                    rci = '', 
                    tenant_code = '', 
                    user_group_id = '', ),
                success = visier_api_administration.models.user_group_delete_success_dto.UserGroupDeleteSuccessDTO(
                    project_id = '', 
                    tenant_code = '', 
                    user_group_id = '', )
            )
    ...
    def testUserGroupSingleDeleteResponseDTO(self):
        ...
        def validate_instance(instance):
            UserGroupSingleDeleteResponseDTO.model_validate(inst_req_only)
            instance_deserialized = UserGroupSingleDeleteResponseDTO.from_dict(instance.to_dict())
