...
class TestServicingAnalyticObjectDTO(unittest.TestCase):
    """ServicingAnalyticObjectDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServicingAnalyticObjectDTO:
        """Test ServicingAnalyticObjectDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return ServicingAnalyticObjectDTO(
                analytic_object_id = '',
                display_name = '',
                object_type = 'Event',
                related_objects = [
    ...
    def testServicingAnalyticObjectDTO(self):
        """Test ServicingAnalyticObjectDTO"""
        def validate_instance(instance):
            ServicingAnalyticObjectDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingAnalyticObjectDTO.from_dict(instance.to_dict())
