    ...
    def make_instance(self, include_optional) -> DataSecurityProfileDTO:
        ...
        if include_optional:
            return DataSecurityProfileDTO(
                ...
                inherited_reference_member_filter_config = visier_api_administration.models.inherited_reference_member_filter_config_dto.InheritedReferenceMemberFilterConfigDTO(
                ...
                property_set_config = visier_api_administration.models.property_set_config_dto.PropertySetConfigDTO(
                    property_access_configs = [
                        visier_api_administration.models.property_access_config_dto.PropertyAccessConfigDTO(
                            access_level = 'None', 
                            analytic_object_id = '', 
