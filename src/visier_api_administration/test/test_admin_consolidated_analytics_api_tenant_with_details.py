...
class TestAdminConsolidatedAnalyticsAPITenantWithDetails(unittest.TestCase):
    ...
    def testAdminConsolidatedAnalyticsAPITenantWithDetails(self):
        ...
        def validate_instance(instance):
            AdminConsolidatedAnalyticsAPITenantWithDetails.model_validate(inst_req_only)
            instance_deserialized = AdminConsolidatedAnalyticsAPITenantWithDetails.from_dict(instance.to_dict())
