...
class TestServicingMemberFilterConfigDTO(unittest.TestCase):
    """ServicingMemberFilterConfigDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServicingMemberFilterConfigDTO:
        ...
        if include_optional:
            return ServicingMemberFilterConfigDTO(
                dimension_filters = [
    ...
    def testServicingMemberFilterConfigDTO(self):
        """Test ServicingMemberFilterConfigDTO"""
        def validate_instance(instance):
            ServicingMemberFilterConfigDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingMemberFilterConfigDTO.from_dict(instance.to_dict())
