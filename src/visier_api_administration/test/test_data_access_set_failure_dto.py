...
class TestDataAccessSetFailureDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DataAccessSetFailureDTO:
        ...
        if include_optional:
            return DataAccessSetFailureDTO(
                data_access_set_id = '',
                display_name = '',
                error = visier_api_administration.models.data_access_set_error_dto.DataAccessSetErrorDTO(
                    message = '', 
                    rci = '', )
            )
        else:
    ...
    def testDataAccessSetFailureDTO(self):
        ...
        def validate_instance(instance):
            DataAccessSetFailureDTO.model_validate(inst_req_only)
            instance_deserialized = DataAccessSetFailureDTO.from_dict(instance.to_dict())
