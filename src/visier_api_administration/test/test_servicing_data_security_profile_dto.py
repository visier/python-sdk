...
class TestServicingDataSecurityProfileDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ServicingDataSecurityProfileDTO:
        ...
        if include_optional:
            return ServicingDataSecurityProfileDTO(
                analytic_object_id = '',
                property_set_config = visier_api_administration.models.servicing/property_set_config_dto.servicing.PropertySetConfigDTO(
                    property_access_configs = [
                        visier_api_administration.models.servicing/property_access_config_dto.servicing.PropertyAccessConfigDTO(
                            property_id = '', 
                            analytic_object_id = '', 
                ...
                inherited_reference_member_filter_config = visier_api_administration.models.servicing/inherited_reference_member_filter_config_dto.servicing.InheritedReferenceMemberFilterConfigDTO(
    ...
    def testServicingDataSecurityProfileDTO(self):
        ...
        def validate_instance(instance):
            ServicingDataSecurityProfileDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingDataSecurityProfileDTO.from_dict(instance.to_dict())
