...
class TestLocalTenantProfileAssignmentResponseDTO(unittest.TestCase):
    ...
    def testLocalTenantProfileAssignmentResponseDTO(self):
        ...
        def validate_instance(instance):
            LocalTenantProfileAssignmentResponseDTO.model_validate(inst_req_only)
            instance_deserialized = LocalTenantProfileAssignmentResponseDTO.from_dict(instance.to_dict())
