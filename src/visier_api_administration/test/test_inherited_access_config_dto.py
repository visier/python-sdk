...
class TestInheritedAccessConfigDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> InheritedAccessConfigDTO:
        """Test InheritedAccessConfigDTO
    ...
    def testInheritedAccessConfigDTO(self):
        """Test InheritedAccessConfigDTO"""
        def validate_instance(instance):
            InheritedAccessConfigDTO.model_validate(inst_req_only)
            instance_deserialized = InheritedAccessConfigDTO.from_dict(instance.to_dict())
