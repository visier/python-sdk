...
class TestProfileAssignedForAccessibleTenantDTO(unittest.TestCase):
    ...
    def testProfileAssignedForAccessibleTenantDTO(self):
        ...
        def validate_instance(instance):
            ProfileAssignedForAccessibleTenantDTO.model_validate(inst_req_only)
            instance_deserialized = ProfileAssignedForAccessibleTenantDTO.from_dict(instance.to_dict())
