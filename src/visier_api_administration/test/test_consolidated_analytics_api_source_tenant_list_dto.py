...
class TestConsolidatedAnalyticsAPISourceTenantListDTO(unittest.TestCase):
    ...
    def testConsolidatedAnalyticsAPISourceTenantListDTO(self):
        ...
        def validate_instance(instance):
            ConsolidatedAnalyticsAPISourceTenantListDTO.model_validate(inst_req_only)
            instance_deserialized = ConsolidatedAnalyticsAPISourceTenantListDTO.from_dict(instance.to_dict())
