...
class TestAdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO(unittest.TestCase):
    """AdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO:
        """Test AdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO
    ...
    def testAdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO(self):
        """Test AdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO"""
        def validate_instance(instance):
            AdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO.model_validate(inst_req_only)
            instance_deserialized = AdminPublicapiTransfersTenantManagementAPIUpdateRequestDTO.from_dict(instance.to_dict())
