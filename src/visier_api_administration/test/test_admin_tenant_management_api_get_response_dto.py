...
class TestAdminTenantManagementAPIGetResponseDTO(unittest.TestCase):
    ...
    def testAdminTenantManagementAPIGetResponseDTO(self):
        ...
        def validate_instance(instance):
            AdminTenantManagementAPIGetResponseDTO.model_validate(inst_req_only)
            instance_deserialized = AdminTenantManagementAPIGetResponseDTO.from_dict(instance.to_dict())
