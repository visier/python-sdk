...
class TestPermissionFailureDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionFailureDTO:
        ...
        if include_optional:
            return PermissionFailureDTO(
                display_name = '',
                error = visier_api_administration.models.permission_error_dto.PermissionErrorDTO(
                    message = '', 
                    rci = '', ),
                permission_id = ''
            )
    ...
    def testPermissionFailureDTO(self):
        ...
        def validate_instance(instance):
            PermissionFailureDTO.model_validate(inst_req_only)
            instance_deserialized = PermissionFailureDTO.from_dict(instance.to_dict())
