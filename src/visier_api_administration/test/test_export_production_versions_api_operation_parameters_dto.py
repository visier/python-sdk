...
class TestExportProductionVersionsAPIOperationParametersDTO(unittest.TestCase):
    ...
    def testExportProductionVersionsAPIOperationParametersDTO(self):
        ...
        def validate_instance(instance):
            ExportProductionVersionsAPIOperationParametersDTO.model_validate(inst_req_only)
            instance_deserialized = ExportProductionVersionsAPIOperationParametersDTO.from_dict(instance.to_dict())
