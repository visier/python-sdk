...
class TestUsersUpdateAPIRequestDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> UsersUpdateAPIRequestDTO:
        ...
        if include_optional:
            return UsersUpdateAPIRequestDTO(
                users = [
                    visier_api_administration.models.users_update_api_user_dto.UsersUpdateAPIUserDTO(
                        account_enabled = '', 
                        display_name = '', 
                        email = '', 
                        employee_id = '', 
    ...
    def testUsersUpdateAPIRequestDTO(self):
        ...
        def validate_instance(instance):
            UsersUpdateAPIRequestDTO.model_validate(inst_req_only)
            instance_deserialized = UsersUpdateAPIRequestDTO.from_dict(instance.to_dict())
