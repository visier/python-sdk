    ...
    def make_instance(self, include_optional) -> UserGroupChangeDefinitionDTO:
        ...
        if include_optional:
            return UserGroupChangeDefinitionDTO(
                description = '',
                display_name = '',
                permission_ids = visier_api_administration.models.element_ids_dto.ElementIDsDTO(
                    ids = [
                        ''
                        ], ),
                project_id = '',
                tenant_code = '',
                user_group_id = '',
                users = visier_api_administration.models.user_group_change_users_dto.UserGroupChangeUsersDTO(
