...
class TestFailedAccessibleTenantProfileAssignmentDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> FailedAccessibleTenantProfileAssignmentDTO:
        ...
        if include_optional:
            return FailedAccessibleTenantProfileAssignmentDTO(
                error = visier_api_administration.models.error_dto.ErrorDTO(
                    error_code = '', 
                    error_message = '', 
                    root_cause_id = '', ),
    ...
    def testFailedAccessibleTenantProfileAssignmentDTO(self):
        ...
        def validate_instance(instance):
            FailedAccessibleTenantProfileAssignmentDTO.model_validate(inst_req_only)
            instance_deserialized = FailedAccessibleTenantProfileAssignmentDTO.from_dict(instance.to_dict())
