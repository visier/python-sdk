    ...
    def make_instance(self, include_optional) -> PermissionDTO:
        ...
        if include_optional:
            return PermissionDTO(
                admin_capability_config = visier_api_administration.models.admin_capability_config_dto.AdminCapabilityConfigDTO(
                ...
                display_name = '',
                permission_id = '',
                role_modules_config = visier_api_administration.models.role_modules_config_dto.RoleModulesConfigDTO(
                    content_package_ids = [
                        ''
                        ], )
            )
