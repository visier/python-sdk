...
class TestDynamicPropertyMappingDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DynamicPropertyMappingDTO:
        ...
        if include_optional:
            return DynamicPropertyMappingDTO(
                ...
                user_property = visier_api_administration.models.user_property_dto.UserPropertyDTO(
                    name = '', )
            )
        else:
            return DynamicPropertyMappingDTO(
    ...
    def testDynamicPropertyMappingDTO(self):
        ...
        def validate_instance(instance):
            DynamicPropertyMappingDTO.model_validate(inst_req_only)
            instance_deserialized = DynamicPropertyMappingDTO.from_dict(instance.to_dict())
