...
class TestAdminPublicapiTransfersTenantManagementAPIListResponseDTO(unittest.TestCase):
    """AdminPublicapiTransfersTenantManagementAPIListResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminPublicapiTransfersTenantManagementAPIListResponseDTO:
        ...
        if include_optional:
            return AdminPublicapiTransfersTenantManagementAPIListResponseDTO(
                limit = 56,
                start = 56,
                tenants = [
                    visier_api_administration.models.admin/publicapi/transfers/tenant_management_api_get_response_dto.admin.publicapi.transfers.TenantManagementAPIGetResponseDTO(
    ...
    def testAdminPublicapiTransfersTenantManagementAPIListResponseDTO(self):
        """Test AdminPublicapiTransfersTenantManagementAPIListResponseDTO"""
        def validate_instance(instance):
            AdminPublicapiTransfersTenantManagementAPIListResponseDTO.model_validate(inst_req_only)
            instance_deserialized = AdminPublicapiTransfersTenantManagementAPIListResponseDTO.from_dict(instance.to_dict())
