...
class TestServicingDimensionFilterDTO(unittest.TestCase):
    """ServicingDimensionFilterDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ServicingDimensionFilterDTO:
        """Test ServicingDimensionFilterDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return ServicingDimensionFilterDTO(
    ...
    def testServicingDimensionFilterDTO(self):
        """Test ServicingDimensionFilterDTO"""
        def validate_instance(instance):
            ServicingDimensionFilterDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingDimensionFilterDTO.from_dict(instance.to_dict())
