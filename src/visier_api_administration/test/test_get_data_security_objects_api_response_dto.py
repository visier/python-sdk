...
class TestGetDataSecurityObjectsAPIResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetDataSecurityObjectsAPIResponseDTO:
        ...
        if include_optional:
            return GetDataSecurityObjectsAPIResponseDTO(
                analytic_objects = [
                    visier_api_administration.models.analytic_object_dto.AnalyticObjectDTO(
                        analytic_object_id = '', 
                        display_name = '', 
                        object_type = 'Event', 
                        related_objects = [
    ...
    def testGetDataSecurityObjectsAPIResponseDTO(self):
        ...
        def validate_instance(instance):
            GetDataSecurityObjectsAPIResponseDTO.model_validate(inst_req_only)
            instance_deserialized = GetDataSecurityObjectsAPIResponseDTO.from_dict(instance.to_dict())
