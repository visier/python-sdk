...
class TestProjectOperationResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> ProjectOperationResponseDTO:
        ...
        if include_optional:
            return ProjectOperationResponseDTO(
                commit_and_publish = visier_api_administration.models.commit_and_publish_operation_response_dto.CommitAndPublishOperationResponseDTO(
    ...
    def testProjectOperationResponseDTO(self):
        ...
        def validate_instance(instance):
            ProjectOperationResponseDTO.model_validate(inst_req_only)
            instance_deserialized = ProjectOperationResponseDTO.from_dict(instance.to_dict())
