...
class TestAdminPublicapiTransfersTenantManagementAPIGetResponseDTO(unittest.TestCase):
    """AdminPublicapiTransfersTenantManagementAPIGetResponseDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> AdminPublicapiTransfersTenantManagementAPIGetResponseDTO:
        """Test AdminPublicapiTransfersTenantManagementAPIGetResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return AdminPublicapiTransfersTenantManagementAPIGetResponseDTO(
    ...
    def testAdminPublicapiTransfersTenantManagementAPIGetResponseDTO(self):
        """Test AdminPublicapiTransfersTenantManagementAPIGetResponseDTO"""
        def validate_instance(instance):
            AdminPublicapiTransfersTenantManagementAPIGetResponseDTO.model_validate(inst_req_only)
            instance_deserialized = AdminPublicapiTransfersTenantManagementAPIGetResponseDTO.from_dict(instance.to_dict())
