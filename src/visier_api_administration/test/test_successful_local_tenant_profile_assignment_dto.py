...
class TestSuccessfulLocalTenantProfileAssignmentDTO(unittest.TestCase):
    ...
    def testSuccessfulLocalTenantProfileAssignmentDTO(self):
        ...
        def validate_instance(instance):
            SuccessfulLocalTenantProfileAssignmentDTO.model_validate(inst_req_only)
            instance_deserialized = SuccessfulLocalTenantProfileAssignmentDTO.from_dict(instance.to_dict())
