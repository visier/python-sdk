...
class PermissionsToUserGroupsRequestDTO(BaseModel):
    ...
    """ # noqa: E501
    user_groups: Optional[List[PermissionsToUserGroupRequestDTO]] = Field(default=None, description="A list of objects representing the user groups and permissions to assign or remove.", alias="userGroups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userGroups": [PermissionsToUserGroupRequestDTO.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None
        })
        return _obj
