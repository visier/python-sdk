...
class ServicingUsersUpdateAPIUserDTO(BaseModel):
    """
    ServicingUsersUpdateAPIUserDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["userId", "displayName", "employeeId", "accountEnabled", "email", "username"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingUsersUpdateAPIUserDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingUsersUpdateAPIUserDTO from a dict"""
        if obj is None:
            return None
