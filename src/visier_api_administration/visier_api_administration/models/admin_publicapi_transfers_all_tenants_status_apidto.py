...
class AdminPublicapiTransfersAllTenantsStatusAPIDTO(BaseModel):
    """
    ...
    tenants: Optional[List[AdminPublicapiTransfersTenantDetailAPIDTO]] = Field(default=None, description="A list of objects representing all the analytic tenants.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminPublicapiTransfersAllTenantsStatusAPIDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminPublicapiTransfersAllTenantsStatusAPIDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "limit": obj.get("limit"),
            "start": obj.get("start"),
            "tenants": [AdminPublicapiTransfersTenantDetailAPIDTO.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
