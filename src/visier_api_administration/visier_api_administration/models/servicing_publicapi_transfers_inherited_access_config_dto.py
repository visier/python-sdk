...
class ServicingPublicapiTransfersInheritedAccessConfigDTO(BaseModel):
    """
    ...
    member_filter_configs: Optional[List[ServicingPublicapiTransfersMemberFilterConfigDTO]] = Field(default=None, description="Custom filters that define population access for an inherited analytic object in the permission.", alias="memberFilterConfigs")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersInheritedAccessConfigDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersInheritedAccessConfigDTO from a dict"""
        if obj is None:
            return None
