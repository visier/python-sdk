...
class ServicingPublicapiTransfersAssignRevokePermissionByTenantDTO(BaseModel):
    """
    ...
    permissions: Optional[List[ServicingPublicapiTransfersAssignRevokePermissionByPermissionDTO]] = Field(default=None, description="A list of objects representing the assigned or removed permissions.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersAssignRevokePermissionByTenantDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersAssignRevokePermissionByTenantDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "permissions": [ServicingPublicapiTransfersAssignRevokePermissionByPermissionDTO.from_dict(_item) for _item in obj["permissions"]] if obj.get("permissions") is not None else None,
