...
class AdminTransfersUserGroupsGetAPIResponseDTO(BaseModel):
    """
    ...
    user_groups: Optional[List[AdminTransfersUserGroupGetAPIResponseDTO]] = Field(default=None, description="A list of user groups.", alias="userGroups")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersUserGroupsGetAPIResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersUserGroupsGetAPIResponseDTO from a dict"""
        if obj is None:
            return None
