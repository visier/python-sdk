...
class AdminUpdateTenantModel(BaseModel):
    """
    AdminUpdateTenantModel
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tenantDisplayName", "industryCode", "purchasedModules", "embeddableDomains", "customProperties", "ssoInstanceIssuers"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminUpdateTenantModel from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminUpdateTenantModel from a dict"""
        if obj is None:
            return None
