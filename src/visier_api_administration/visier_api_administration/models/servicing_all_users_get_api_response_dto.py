...
class ServicingAllUsersGetAPIResponseDTO(BaseModel):
    """
    ServicingAllUsersGetAPIResponseDTO
    """ # noqa: E501
    users: Optional[List[ServicingUserGetAPIResponseDTO]] = Field(default=None, description="A list of available users.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingAllUsersGetAPIResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingAllUsersGetAPIResponseDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "users": [ServicingUserGetAPIResponseDTO.from_dict(_item) for _item in obj["users"]] if obj.get("users") is not None else None,
            "limit": obj.get("limit"),
            "start": obj.get("start")
        })
        return _obj
