...
class ServicingPublicapiTransfersMemberFilterConfigDTO(BaseModel):
    """
    ServicingPublicapiTransfersMemberFilterConfigDTO
    """ # noqa: E501
    dimension_filters: Optional[List[ServicingPublicapiTransfersDimensionFilterDTO]] = Field(default=None, description="A list of objects representing the custom filters that define population access for the item.   A custom filter can be a \"member filter\" (`staticDimensionFilter`) or a \"dynamic filter\" (`dynamicDimensionFilter`).", alias="dimensionFilters")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersMemberFilterConfigDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersMemberFilterConfigDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "dimensionFilters": [ServicingPublicapiTransfersDimensionFilterDTO.from_dict(_item) for _item in obj["dimensionFilters"]] if obj.get("dimensionFilters") is not None else None
        })
        return _obj
