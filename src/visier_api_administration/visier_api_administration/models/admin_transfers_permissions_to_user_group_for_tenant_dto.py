...
class AdminTransfersPermissionsToUserGroupForTenantDTO(BaseModel):
    """
    ...
    user_groups: Optional[List[AdminTransfersUserGroupGetAPIResponseDTO]] = Field(default=None, description="A list of objects representing user groups and the permissions to assign to or remove from them.", alias="userGroups")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersPermissionsToUserGroupForTenantDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersPermissionsToUserGroupForTenantDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "userGroups": [AdminTransfersUserGroupGetAPIResponseDTO.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None
        })
        return _obj
