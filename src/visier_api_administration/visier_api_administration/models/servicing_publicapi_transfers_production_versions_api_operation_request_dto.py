...
class ServicingPublicapiTransfersProductionVersionsAPIOperationRequestDTO(BaseModel):
    """
    ServicingPublicapiTransfersProductionVersionsAPIOperationRequestDTO
    """ # noqa: E501
    export_parameters: Optional[ServicingPublicapiTransfersExportProductionVersionsAPIOperationParametersDTO] = Field(default=None, description="The parameters for the `export` option, such as the production version to start exporting versions from. Required for `export` operations.", alias="exportParameters")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersProductionVersionsAPIOperationRequestDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersProductionVersionsAPIOperationRequestDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "exportParameters": ServicingPublicapiTransfersExportProductionVersionsAPIOperationParametersDTO.from_dict(obj["exportParameters"]) if obj.get("exportParameters") is not None else None,
