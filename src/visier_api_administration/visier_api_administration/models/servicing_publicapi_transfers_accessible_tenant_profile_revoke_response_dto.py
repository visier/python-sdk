...
class ServicingPublicapiTransfersAccessibleTenantProfileRevokeResponseDTO(BaseModel):
    """
    ServicingPublicapiTransfersAccessibleTenantProfileRevokeResponseDTO
    """ # noqa: E501
    bad_tenant_codes: Optional[List[ServicingPublicapiTransfersReducedTenantCodeErrorDTO]] = Field(default=None, description="A list of objects representing any tenants that returned errors.", alias="badTenantCodes")
    bad_user_ids: Optional[List[ServicingPublicapiTransfersReducedUserIdErrorDTO]] = Field(default=None, description="A list of objects representing the user IDs that may not be valid.", alias="badUserIds")
    succeeded: Optional[List[ServicingPublicapiTransfersSuccessfulLocalTenantProfileAssignmentDTO]] = Field(default=None, description="A list of objects representing the valid user IDs that succeeded.")
    unaffected_users: Optional[List[ServicingPublicapiTransfersSuccessfulLocalTenantProfileAssignmentDTO]] = Field(default=None, description="A list of objects representing the valid user IDs that were not affected.", alias="unaffectedUsers")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersAccessibleTenantProfileRevokeResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersAccessibleTenantProfileRevokeResponseDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "badTenantCodes": [ServicingPublicapiTransfersReducedTenantCodeErrorDTO.from_dict(_item) for _item in obj["badTenantCodes"]] if obj.get("badTenantCodes") is not None else None,
            "badUserIds": [ServicingPublicapiTransfersReducedUserIdErrorDTO.from_dict(_item) for _item in obj["badUserIds"]] if obj.get("badUserIds") is not None else None,
            ...
            "unaffectedUsers": [ServicingPublicapiTransfersSuccessfulLocalTenantProfileAssignmentDTO.from_dict(_item) for _item in obj["unaffectedUsers"]] if obj.get("unaffectedUsers") is not None else None
        })
        return _obj
