...
class ServicingPublicapiTransfersSecurableDimensionDTO(BaseModel):
    """
    ServicingPublicapiTransfersSecurableDimensionDTO
    """ # noqa: E501
    ...
    hierarchy_properties: Optional[List[ServicingPublicapiTransfersHierarchyPropertyDTO]] = Field(default=None, description="The list of hierarchies you can map to a user in a permission's dynamic filter.", alias="hierarchyProperties")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersSecurableDimensionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersSecurableDimensionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "hierarchyProperties": [ServicingPublicapiTransfersHierarchyPropertyDTO.from_dict(_item) for _item in obj["hierarchyProperties"]] if obj.get("hierarchyProperties") is not None else None
        })
        return _obj
