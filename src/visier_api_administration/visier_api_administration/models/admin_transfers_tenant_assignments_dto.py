...
class AdminTransfersTenantAssignmentsDTO(BaseModel):
    """
    AdminTransfersTenantAssignmentsDTO
    """ # noqa: E501
    assignments: Optional[List[AdminTransfersUserSecurityAssignmentsDTO]] = Field(default=None, description="A list of objects representing the user group and user assignments.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersTenantAssignmentsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersTenantAssignmentsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "assignments": [AdminTransfersUserSecurityAssignmentsDTO.from_dict(_item) for _item in obj["assignments"]] if obj.get("assignments") is not None else None,
