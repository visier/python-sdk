...
class ServicingPublicapiTransfersStaticDimensionFilterDTO(BaseModel):
    """
    ServicingPublicapiTransfersStaticDimensionFilterDTO
    """ # noqa: E501
    ...
    member_selections: Optional[List[ServicingPublicapiTransfersMemberSelectionDTO]] = Field(default=None, description="A list of objects representing the dimension members assigned population access in the member filter.", alias="memberSelections")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersStaticDimensionFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersStaticDimensionFilterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "memberSelections": [ServicingPublicapiTransfersMemberSelectionDTO.from_dict(_item) for _item in obj["memberSelections"]] if obj.get("memberSelections") is not None else None,
