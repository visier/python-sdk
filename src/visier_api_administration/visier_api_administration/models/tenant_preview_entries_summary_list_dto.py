...
class TenantPreviewEntriesSummaryListDTO(BaseModel):
    ...
    tenants: Optional[List[TenantPreviewEntriesSummaryDTO]] = Field(default=None, description="A list of objects representing all the analytic tenants.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "limit": obj.get("limit"),
            "start": obj.get("start"),
            "tenants": [TenantPreviewEntriesSummaryDTO.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None
        })
        return _obj
