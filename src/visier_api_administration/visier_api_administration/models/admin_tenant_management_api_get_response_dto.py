...
class AdminTenantManagementAPIGetResponseDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allowedOAuthIdpUrlDomains", "canAdministerOtherTenants", "clickThroughLink", "clickThroughLinkEnabled", "companySize", "currentDataVersion", "customProperties", "dataVersionDate", "defaultCurrency", "effectiveIndustryCode", "embeddableDomains", "homeAnalysisByUserGroup", "homeAnalysisId", "industryCode", "primaryBusinessLocation", "provisionDate", "purchasedModules", "ssoInstanceIssuers", "status", "tenantCode", "tenantDisplayName", "vanityUrlName"]
