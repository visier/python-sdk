...
class ServicingPublicapiTransfersPermissionFailureDTO(BaseModel):
    """
    ServicingPublicapiTransfersPermissionFailureDTO
    """ # noqa: E501
    ...
    error: Optional[ServicingPublicapiTransfersPermissionErrorDTO] = Field(default=None, description="The error associated with the failure.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersPermissionFailureDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersPermissionFailureDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "error": ServicingPublicapiTransfersPermissionErrorDTO.from_dict(obj["error"]) if obj.get("error") is not None else None,
