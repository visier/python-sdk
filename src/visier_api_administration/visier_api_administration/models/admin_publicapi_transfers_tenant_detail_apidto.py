...
class AdminPublicapiTransfersTenantDetailAPIDTO(BaseModel):
    """
    ...
    modules: Optional[List[DesignerTransfersTenantModuleDTO]] = Field(default=None, description="The modules assigned to the analytic tenant.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminPublicapiTransfersTenantDetailAPIDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminPublicapiTransfersTenantDetailAPIDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "modules": [DesignerTransfersTenantModuleDTO.from_dict(_item) for _item in obj["modules"]] if obj.get("modules") is not None else None,
