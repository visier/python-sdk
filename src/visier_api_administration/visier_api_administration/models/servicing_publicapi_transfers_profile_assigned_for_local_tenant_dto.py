...
class ServicingPublicapiTransfersProfileAssignedForLocalTenantDTO(BaseModel):
    """
    ServicingPublicapiTransfersProfileAssignedForLocalTenantDTO
    """ # noqa: E501
    additional_capabilities: Optional[ServicingPublicapiTransfersAdditionalCapabilitiesDTO] = Field(default=None, description="A list of the additional capabilities that are assigned to this profile.", alias="additionalCapabilities")
    capabilities: Optional[List[ServicingPublicapiTransfersCapabilitiesDTO]] = Field(default=None, description="A list of objects representing the access that this profile has for the capabilities of this profile.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersProfileAssignedForLocalTenantDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersProfileAssignedForLocalTenantDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "additionalCapabilities": ServicingPublicapiTransfersAdditionalCapabilitiesDTO.from_dict(obj["additionalCapabilities"]) if obj.get("additionalCapabilities") is not None else None,
            "capabilities": [ServicingPublicapiTransfersCapabilitiesDTO.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None,
