...
class ServicingPublicapiTransfersPermissionDTO(BaseModel):
    """
    ServicingPublicapiTransfersPermissionDTO
    """ # noqa: E501
    admin_capability_config: Optional[ServicingPublicapiTransfersAdminCapabilityConfigDTO] = Field(default=None, description="The capabilities assigned in the permission.", alias="adminCapabilityConfig")
    data_security_profiles: Optional[List[ServicingPublicapiTransfersDataSecurityProfileDTO]] = Field(default=None, description="A list of objects representing the data security for each item in a permission.", alias="dataSecurityProfiles")
    ...
    role_modules_config: Optional[ServicingPublicapiTransfersRoleModulesConfigDTO] = Field(default=None, description="A list of content packages assigned to the permission.", alias="roleModulesConfig")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersPermissionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiTransfersPermissionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "adminCapabilityConfig": ServicingPublicapiTransfersAdminCapabilityConfigDTO.from_dict(obj["adminCapabilityConfig"]) if obj.get("adminCapabilityConfig") is not None else None,
            "dataSecurityProfiles": [ServicingPublicapiTransfersDataSecurityProfileDTO.from_dict(_item) for _item in obj["dataSecurityProfiles"]] if obj.get("dataSecurityProfiles") is not None else None,
            "description": obj.get("description"),
            "displayName": obj.get("displayName"),
            "permissionId": obj.get("permissionId"),
            "roleModulesConfig": ServicingPublicapiTransfersRoleModulesConfigDTO.from_dict(obj["roleModulesConfig"]) if obj.get("roleModulesConfig") is not None else None
        })
        return _obj
