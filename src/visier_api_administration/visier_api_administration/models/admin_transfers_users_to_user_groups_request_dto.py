...
class AdminTransfersUsersToUserGroupsRequestDTO(BaseModel):
    """
    AdminTransfersUsersToUserGroupsRequestDTO
    """ # noqa: E501
    ...
    user_groups: Optional[List[AdminTransfersUsersToUserGroupRequestDTO]] = Field(default=None, description="A list of objects representing the user groups and users to assign or remove.", alias="userGroups")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminTransfersUsersToUserGroupsRequestDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminTransfersUsersToUserGroupsRequestDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "userGroups": [AdminTransfersUsersToUserGroupRequestDTO.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None
        })
        return _obj
