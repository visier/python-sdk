...
class UserGroupsChangeDTO(BaseModel):
    """
    UserGroupsChangeDTO
    """ # noqa: E501
    user_groups: Optional[List[UserGroupChangeDefinitionDTO]] = Field(default=None, description="The user groups and their definitions.", alias="userGroups")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "userGroups": [UserGroupChangeDefinitionDTO.from_dict(_item) for _item in obj["userGroups"]] if obj.get("userGroups") is not None else None
        })
        return _obj
