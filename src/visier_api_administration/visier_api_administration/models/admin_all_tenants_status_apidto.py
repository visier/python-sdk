...
class AdminAllTenantsStatusAPIDTO(BaseModel):
    """
    AdminAllTenantsStatusAPIDTO
    """ # noqa: E501
    tenants: Optional[List[AdminTenantDetailAPIDTO]] = Field(default=None, description="A list of objects representing all the analytic tenants.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AdminAllTenantsStatusAPIDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AdminAllTenantsStatusAPIDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "tenants": [AdminTenantDetailAPIDTO.from_dict(_item) for _item in obj["tenants"]] if obj.get("tenants") is not None else None,
            "limit": obj.get("limit"),
            "start": obj.get("start")
        })
        return _obj
