    ...
    def make_instance(self, include_optional) -> CalculationConceptDTO:
        ...
        if include_optional:
            return CalculationConceptDTO(
                configuration = visier.sdk.api.object_configuration.models.calculation_concept_configuration_dto.CalculationConceptConfigurationDTO(
                    perspectives = [
                        visier.sdk.api.object_configuration.models.perspective_configuration_dto.PerspectiveConfigurationDTO(
                            perspective_id = '', 
                            perspective_name = '', 
                            perspective_nodes = [
