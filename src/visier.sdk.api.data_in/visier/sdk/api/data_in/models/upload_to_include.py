...
class UploadToInclude(BaseModel):
    ...
    max_upload_time: Optional[StrictStr] = Field(default=None, description="An ISO8601 time for the latest upload time. If defined, omit `uploadTimes`. If omitted and `minUploadTime` is defined, includes files up to latest time available.", alias="maxUploadTime")
    min_upload_time: Optional[StrictStr] = Field(default=None, description="An ISO8601 time for the earliest upload time. If defined, omit `uploadTimes`. If omitted and `maxUploadTime` is defined, includes files up to earliest time available.", alias="minUploadTime")
    ...
    upload_times: Optional[List[StrictStr]] = Field(default=None, description="A comma-separated list of ISO8601 time strings representing the upload time of each data upload to include.", alias="uploadTimes")
