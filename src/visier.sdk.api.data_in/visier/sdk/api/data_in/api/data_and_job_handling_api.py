...
class DataAndJobHandlingApi:
    ...
    def adhoc_consolidated_analytics_job(
        self,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant code of the consolidated analytics tenant; for example, \"WFF_j1r~CAa7s\".")] = None,
        ...
        :param tenant_code: The tenant code of the consolidated analytics tenant; for example, \"WFF_j1r~CAa7s\".
    ...
    def adhoc_extraction_job(
        self,
        tenants: Annotated[Optional[List[StrictStr]], Field(description="The unique IDs of the tenants to run an extraction job for.")] = None,
        all_tenants: Annotated[Optional[StrictBool], Field(description="If \"true\", runs an extraction job for all tenants and ignores the tenants field.")] = None,
        override_last_extraction_timestamp: Annotated[Optional[StrictStr], Field(description="An epoch timestamp in milliseconds from which to retrieve data. This overrides the last extraction date to retrieve more data.")] = None,
        publish_data_load_artifacts: Annotated[Optional[StrictBool], Field(description="If \"true\", publishes the project to production.")] = None,
        run_processing_job: Annotated[Optional[StrictBool], Field(description="If \"true\", runs a processing job to generate a data version after the extraction job succeeds.")] = None,
        data_category_id: Annotated[Optional[StrictStr], Field(description="The unique ID of the data category in which to generate objects.")] = None,
        disable_artifact_generation: Annotated[Optional[StrictBool], Field(description="If \"true\", doesn't generate objects after the extraction jobs succeeds.")] = None,
        connector_ids: Annotated[Optional[List[StrictStr]], Field(description="The unique IDs of the connectors to run extraction jobs for.")] = None,
        last_extraction_time_offset_weeks: Annotated[Optional[StrictInt], Field(description="The number of weeks from which to retrieve data. This overrides the last extraction date to retrieve more data.")] = None,
        months_to_extract: Annotated[Optional[StrictInt], Field(description="The number of months to retrieve snapshot data from.")] = None,
        extract_to_time_override: Annotated[Optional[StrictStr], Field(description="An epoch timestamp in milliseconds for the end time up to which to retrieve data.")] = None,
        batch_size_override: Annotated[Optional[StrictInt], Field(description="The maximum amount of IDs the job can retrieve in each batch.")] = None,
        sql_batch_size: Annotated[Optional[StrictInt], Field(description="The maximum amount of SQL table records the job can retrieve in each batch.")] = None,
        force_update_existing_artifacts: Annotated[Optional[StrictBool], Field(description="If \"true\" and `disableArtifactGeneration` is \"false\", updates extractor artifacts, which may overwrite the artifacts' manual overrides. Ignored if `disableArtifactGeneration` is \"true\".")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenants: The unique IDs of the tenants to run an extraction job for.
        :type tenants: List[str]
        :param all_tenants: If \"true\", runs an extraction job for all tenants and ignores the tenants field.
        :type all_tenants: bool
        :param override_last_extraction_timestamp: An epoch timestamp in milliseconds from which to retrieve data. This overrides the last extraction date to retrieve more data.
        :type override_last_extraction_timestamp: str
        :param publish_data_load_artifacts: If \"true\", publishes the project to production.
        :type publish_data_load_artifacts: bool
        :param run_processing_job: If \"true\", runs a processing job to generate a data version after the extraction job succeeds.
        :type run_processing_job: bool
        :param data_category_id: The unique ID of the data category in which to generate objects.
        :type data_category_id: str
        :param disable_artifact_generation: If \"true\", doesn't generate objects after the extraction jobs succeeds.
        :type disable_artifact_generation: bool
        :param connector_ids: The unique IDs of the connectors to run extraction jobs for.
        :type connector_ids: List[str]
        :param last_extraction_time_offset_weeks: The number of weeks from which to retrieve data. This overrides the last extraction date to retrieve more data.
        :type last_extraction_time_offset_weeks: int
        :param months_to_extract: The number of months to retrieve snapshot data from.
        :type months_to_extract: int
        :param extract_to_time_override: An epoch timestamp in milliseconds for the end time up to which to retrieve data.
        :type extract_to_time_override: str
        :param batch_size_override: The maximum amount of IDs the job can retrieve in each batch.
        :type batch_size_override: int
        :param sql_batch_size: The maximum amount of SQL table records the job can retrieve in each batch.
        :type sql_batch_size: int
        :param force_update_existing_artifacts: If \"true\" and `disableArtifactGeneration` is \"false\", updates extractor artifacts, which may overwrite the artifacts' manual overrides. Ignored if `disableArtifactGeneration` is \"true\".
        :type force_update_existing_artifacts: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._adhoc_extraction_job_serialize(
            ...
            override_last_extraction_timestamp=override_last_extraction_timestamp,
            publish_data_load_artifacts=publish_data_load_artifacts,
            run_processing_job=run_processing_job,
            data_category_id=data_category_id,
            disable_artifact_generation=disable_artifact_generation,
            connector_ids=connector_ids,
            last_extraction_time_offset_weeks=last_extraction_time_offset_weeks,
            months_to_extract=months_to_extract,
            extract_to_time_override=extract_to_time_override,
            batch_size_override=batch_size_override,
            sql_batch_size=sql_batch_size,
            force_update_existing_artifacts=force_update_existing_artifacts,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _adhoc_extraction_job_serialize(
        ...
        publish_data_load_artifacts,
        run_processing_job,
        data_category_id,
        disable_artifact_generation,
        connector_ids,
        ...
        if tenants is not None:
            ...
            _query_params.append(('tenants', tenants))
            
        if all_tenants is not None:
            
            _query_params.append(('allTenants', all_tenants))
            
        if override_last_extraction_timestamp is not None:
            
            _query_params.append(('overrideLastExtractionTimestamp', override_last_extraction_timestamp))
            
        if publish_data_load_artifacts is not None:
            
            _query_params.append(('publishDataLoadArtifacts', publish_data_load_artifacts))
            
        if run_processing_job is not None:
            
            _query_params.append(('runProcessingJob', run_processing_job))
            
        if data_category_id is not None:
            
            _query_params.append(('dataCategoryId', data_category_id))
            
        if disable_artifact_generation is not None:
            
            _query_params.append(('disableArtifactGeneration', disable_artifact_generation))
            
        if connector_ids is not None:
            
            _query_params.append(('connectorIds', connector_ids))
            
        if last_extraction_time_offset_weeks is not None:
            
            _query_params.append(('lastExtractionTimeOffsetWeeks', last_extraction_time_offset_weeks))
            
        if months_to_extract is not None:
            
            _query_params.append(('monthsToExtract', months_to_extract))
            
        if extract_to_time_override is not None:
            
            _query_params.append(('extractToTimeOverride', extract_to_time_override))
            
        if batch_size_override is not None:
            
            _query_params.append(('batchSizeOverride', batch_size_override))
            
        if sql_batch_size is not None:
            
            _query_params.append(('sqlBatchSize', sql_batch_size))
            
        if force_update_existing_artifacts is not None:
            
            _query_params.append(('forceUpdateExistingArtifacts', force_update_existing_artifacts))
    ...
    def adhoc_processing_jobs(
        self,
        tenants: Annotated[Optional[List[StrictStr]], Field(description="The tenant codes of the tenants to run processing jobs for. If omitted, runs a processing job for the tenant associated with the user who made the API request.")] = None,
        all_tenants: Annotated[Optional[StrictBool], Field(description="If `true`, runs processing jobs for all accessible analytic tenants. Default is `false`.")] = None,
        data_category_id: Annotated[Optional[StrictStr], Field(description="The unique identifier of the data category to run the job. If omitted, runs a job using the primary data category.  To retrieve a list of all data categories, see `GET /v1/op/data/categories`.")] = None,
        publish_to_production: Annotated[Optional[StrictBool], Field(description="If `true`, publishes the generated data version to production. Default is `false`.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param tenants: The tenant codes of the tenants to run processing jobs for. If omitted, runs a processing job for the tenant associated with the user who made the API request.
        :type tenants: List[str]
        :param all_tenants: If `true`, runs processing jobs for all accessible analytic tenants. Default is `false`.
        :type all_tenants: bool
        :param data_category_id: The unique identifier of the data category to run the job. If omitted, runs a job using the primary data category.  To retrieve a list of all data categories, see `GET /v1/op/data/categories`.
        :type data_category_id: str
        :param publish_to_production: If `true`, publishes the generated data version to production. Default is `false`.
        :type publish_to_production: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._adhoc_processing_jobs_serialize(
            ...
            all_tenants=all_tenants,
            data_category_id=data_category_id,
            publish_to_production=publish_to_production,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _adhoc_processing_jobs_serialize(
        ...
        if publish_to_production is not None:
            
            _query_params.append(('publishToProduction', publish_to_production))
