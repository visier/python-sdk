...
class OAuth2UserTenantDetailsDTO(BaseModel):
    """
    The details of all accessible analytic tenants
    """ # noqa: E501
    details: Optional[List[OAuth2UserTenantDetailDTO]] = Field(default=None, description="The details of all accessible analytic tenants.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "details": [OAuth2UserTenantDetailDTO.from_dict(_item) for _item in obj["details"]] if obj.get("details") is not None else None
        })
        return _obj
