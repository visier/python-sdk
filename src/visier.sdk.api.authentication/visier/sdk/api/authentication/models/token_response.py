...
class TokenResponse(BaseModel):
    ...
    TokenResponse
    """ # noqa: E501
    token: Optional[StrictStr] = Field(default=None, description="The security token. Use this token in your API calls to authenticate the call. Expires after 60 minutes.")
