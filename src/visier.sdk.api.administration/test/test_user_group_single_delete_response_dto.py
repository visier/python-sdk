    ...
    def make_instance(self, include_optional) -> UserGroupSingleDeleteResponseDTO:
        ...
        if include_optional:
            return UserGroupSingleDeleteResponseDTO(
                failure = visier.sdk.api.administration.models.user_group_delete_failure_dto.UserGroupDeleteFailureDTO(
                    message = '', 
                    project_id = '', 
                    rci = '', 
                    tenant_code = '', 
                    user_group_id = '', ),
                success = visier.sdk.api.administration.models.user_group_delete_success_dto.UserGroupDeleteSuccessDTO(
                    project_id = '', 
                    tenant_code = '', 
                    user_group_id = '', )
            )
