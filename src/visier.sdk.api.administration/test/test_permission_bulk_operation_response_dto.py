    ...
    def make_instance(self, include_optional) -> PermissionBulkOperationResponseDTO:
        ...
        if include_optional:
            return PermissionBulkOperationResponseDTO(
                failures = [
                    visier.sdk.api.administration.models.permission_failure_dto.PermissionFailureDTO(
                        display_name = '', 
                        error = null, 
                        permission_id = '', )
                    ],
                successes = [
                    visier.sdk.api.administration.models.permission_success_dto.PermissionSuccessDTO(
                        display_name = '', 
                        permission_id = '', )
                    ]
            )
