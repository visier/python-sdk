    ...
    def make_instance(self, include_optional) -> UserGroupFiltersDTO:
        ...
        if include_optional:
            return UserGroupFiltersDTO(
                filters = [
                    visier.sdk.api.administration.models.user_group_change_filter_dto.UserGroupChangeFilterDTO(
                        analytic_object_id = '', 
                        dimension_filters = [
                            visier.sdk.api.administration.models.user_group_change_dimension_filter_dto.UserGroupChangeDimensionFilterDTO(
                                dimension_id = '', 
                                member_selections = [
