    ...
    def make_instance(self, include_optional) -> UserGroupChangeDefinitionDTO:
        ...
        if include_optional:
            return UserGroupChangeDefinitionDTO(
                description = '',
                display_name = '',
                permission_ids = visier.sdk.api.administration.models.element_ids_dto.ElementIDsDTO(
                    ids = [
                        ''
                        ], ),
                project_id = '',
                tenant_code = '',
                user_group_id = '',
                users = visier.sdk.api.administration.models.user_group_change_users_dto.UserGroupChangeUsersDTO(
