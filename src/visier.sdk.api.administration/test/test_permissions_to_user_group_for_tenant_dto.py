    ...
    def make_instance(self, include_optional) -> PermissionsToUserGroupForTenantDTO:
        ...
        if include_optional:
            return PermissionsToUserGroupForTenantDTO(
                ...
                tenant_code = '',
                user_groups = [
                    visier.sdk.api.administration.models.user_group_get_api_response_dto.UserGroupGetAPIResponseDTO(
                        display_name = '', 
                        permissions = [
                            visier.sdk.api.administration.models.permission_response_dto.PermissionResponseDTO(
                                display_name = '', 
                                permission_id = '', )
                            ], 
                        user_group_id = '', )
