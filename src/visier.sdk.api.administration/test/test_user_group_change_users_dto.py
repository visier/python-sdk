    ...
    def make_instance(self, include_optional) -> UserGroupChangeUsersDTO:
        ...
        if include_optional:
            return UserGroupChangeUsersDTO(
                dynamic_filter_definition = visier.sdk.api.administration.models.user_group_filters_dto.UserGroupFiltersDTO(
                    filters = [
                ...
                manually_excluded_ids = visier.sdk.api.administration.models.element_ids_dto.ElementIDsDTO(
                    ids = [
                        ''
                        ], ),
                manually_included_ids = visier.sdk.api.administration.models.element_ids_dto.ElementIDsDTO(
                    ids = [
                        ''
                        ], )
            )
