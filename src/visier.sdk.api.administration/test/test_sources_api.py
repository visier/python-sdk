...
class TestSourcesApi(unittest.TestCase):
    ...
    def test_sources_put_sources(self) -> None:
        """Test case for sources_put_sources

        Import a ZIP file that contains a list of sources
        """
        pass

    def test_sources_run_sources_operation(self) -> None:
        """Test case for sources_run_sources_operation
