...
class DataSecurityProfileDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["allDataPointAccess", "analyticObjectId", "inheritedAccessConfigs", "inheritedReferenceMemberFilterConfig", "memberFilterConfigs", "propertySetConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.inherited_access_configs:
            for _item in self.inherited_access_configs:
                if _item:
