...
class GetDataAccessSetsAPIResponseDTO(BaseModel):
    """
    GetDataAccessSetsAPIResponseDTO
    """ # noqa: E501
    data_access_sets: Optional[List[DataAccessSetDTO]] = Field(default=None, description="A list of objects representing the shareable data access sets.", alias="dataAccessSets")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.data_access_sets:
            for _item in self.data_access_sets:
                if _item:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dataAccessSets": [DataAccessSetDTO.from_dict(_item) for _item in obj["dataAccessSets"]] if obj.get("dataAccessSets") is not None else None
        })
        return _obj
