...
from visier_platform_sdk.models.analysis_common_vee_conversation_dto import AnalysisCommonVeeConversationDTO
...
class TestAnalysisCommonVeeConversationDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnalysisCommonVeeConversationDTO:
        ...
        # uncomment below to create an instance of `AnalysisCommonVeeConversationDTO`
        """
        model = AnalysisCommonVeeConversationDTO()
        if include_optional:
