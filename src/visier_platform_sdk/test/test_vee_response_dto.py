...
class TestVeeResponseDTO(unittest.TestCase):
        ...
        if include_optional:
            return VeeResponseDTO(
                ...
                visual = visier_platform_sdk.models.vee_visual_dto.VeeVisualDTO(
                    ...
                    context = '', ),
                reworded_question = '',
                related_documents = visier_platform_sdk.models.vee_related_document_list_dto.VeeRelatedDocumentListDTO(
                    analyses = [
                ...
                suggestions = [
                    visier_platform_sdk.models.vee_suggestion_dto.VeeSuggestionDTO(
                        suggestion = '', )
                    ]
            )
        else:
    ...
    def testVeeResponseDTO(self):
        ...
        def validate_instance(instance):
            VeeResponseDTO.model_validate(instance)
