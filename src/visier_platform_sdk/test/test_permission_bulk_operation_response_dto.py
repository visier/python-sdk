...
class TestPermissionBulkOperationResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> PermissionBulkOperationResponseDTO:
        ...
        if include_optional:
            return PermissionBulkOperationResponseDTO(
                successes = [
                    visier_platform_sdk.models.permission_success_dto.PermissionSuccessDTO(
                        permission_id = '', 
                        display_name = '', 
                        correlation_id = '', )
                    ],
                failures = [
                    visier_platform_sdk.models.permission_failure_dto.PermissionFailureDTO(
                        permission_id = '', 
                        display_name = '', 
                        error = None, 
                        correlation_id = '', )
    ...
    def testPermissionBulkOperationResponseDTO(self):
        ...
        def validate_instance(instance):
            PermissionBulkOperationResponseDTO.model_validate(instance)
