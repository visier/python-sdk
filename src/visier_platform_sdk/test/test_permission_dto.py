...
class TestPermissionDTO(unittest.TestCase):
        ...
        if include_optional:
            return PermissionDTO(
                    ...
                    visier_platform_sdk.models.data_security_profile_dto.DataSecurityProfileDTO(
                            ...
                            visier_platform_sdk.models.member_filter_config_dto.MemberFilterConfigDTO(
                                dimension_filters = [
                                    visier_platform_sdk.models.dimension_filter_dto.DimensionFilterDTO(
                                        static_dimension_filter = visier_platform_sdk.models.static_dimension_filter_dto.StaticDimensionFilterDTO(
                                            dimension_id = '', 
                                        ...
                                        dynamic_dimension_filter = visier_platform_sdk.models.dynamic_dimension_filter_dto.DynamicDimensionFilterDTO(
                                            dimension_id = '', 
                                            dynamic_property_mappings = [
                                                visier_platform_sdk.models.dynamic_property_mapping_dto.DynamicPropertyMappingDTO(
                        ...
                        inherited_access_configs = [
                            visier_platform_sdk.models.inherited_access_config_dto.InheritedAccessConfigDTO(
                                analytic_object_id = '', 
                                remove_access = True, 
                                shareable_security_filters = [
                                    visier_platform_sdk.models.shareable_security_filter_dto.ShareableSecurityFilterDTO(
                                        security_filter_id = '', )
                                    ], )
                            ], 
                ...
                source_security_config = visier_platform_sdk.models.source_security_config_dto.SourceSecurityConfigDTO(
                    ...
                    has_write_access_to_all_sources = True, ),
    ...
    def testPermissionDTO(self):
        ...
        def validate_instance(instance):
            PermissionDTO.model_validate(instance)
