...
class TestSetConnectorSettingRequestDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SetConnectorSettingRequestDTO:
        ...
        if include_optional:
            return SetConnectorSettingRequestDTO(
                connector_id = '',
                tenants = [
                    visier_platform_sdk.models.tenant_connector_settings_request_dto.TenantConnectorSettingsRequestDTO(
                        tenant_code = '', 
                        connector_settings = [
    ...
    def testSetConnectorSettingRequestDTO(self):
        ...
        def validate_instance(instance):
            SetConnectorSettingRequestDTO.model_validate(instance)
