...
class TestLocalTenantProfileRevokeResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> LocalTenantProfileRevokeResponseDTO:
        ...
        if include_optional:
            return LocalTenantProfileRevokeResponseDTO(
                failed = [
                    visier_platform_sdk.models.failed_local_tenant_profile_revoke_dto.FailedLocalTenantProfileRevokeDTO(
                        user_id = '', 
                        message = '', )
                    ],
                succeeded = [
    ...
    def testLocalTenantProfileRevokeResponseDTO(self):
        ...
        def validate_instance(instance):
            LocalTenantProfileRevokeResponseDTO.model_validate(inst_req_only)
            instance_deserialized = LocalTenantProfileRevokeResponseDTO.from_dict(instance.to_dict())
