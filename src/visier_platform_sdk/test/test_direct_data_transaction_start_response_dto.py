...
class TestDirectDataTransactionStartResponseDTO(unittest.TestCase):
    ...
    def testDirectDataTransactionStartResponseDTO(self):
        ...
        def validate_instance(instance):
            DirectDataTransactionStartResponseDTO.model_validate(inst_req_only)
            instance_deserialized = DirectDataTransactionStartResponseDTO.from_dict(instance.to_dict())
