...
class TestTenantDataUploadsResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> TenantDataUploadsResponseDTO:
        ...
        if include_optional:
            return TenantDataUploadsResponseDTO(
                tenant_code = '',
                uploads = [
                    visier_platform_sdk.models.tenant_data_upload_status_response_dto.TenantDataUploadStatusResponseDTO(
                        upload_time = '', 
                        included = True, )
                    ]
            )
    ...
    def testTenantDataUploadsResponseDTO(self):
        ...
        def validate_instance(instance):
            TenantDataUploadsResponseDTO.model_validate(instance)
