...
class TestAssignConnectorCredentialRequest(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AssignConnectorCredentialRequest:
        ...
        if include_optional:
            return AssignConnectorCredentialRequest(
                connectors = [
                    visier_platform_sdk.models.connector.Connector(
                        connector_id = '', 
                        tenants = [
                            visier_platform_sdk.models.tenant_and_credential.TenantAndCredential(
                                tenant_code = '', 
                                credential_id = '', )
                            ], )
                    ]
    ...
    def testAssignConnectorCredentialRequest(self):
        ...
        def validate_instance(instance):
            AssignConnectorCredentialRequest.model_validate(instance)
