...
class TestServicingCapabilityProtoEnumAccessLookupDTO(unittest.TestCase):
    ...
    def testServicingCapabilityProtoEnumAccessLookupDTO(self):
        ...
        def validate_instance(instance):
            ServicingCapabilityProtoEnumAccessLookupDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingCapabilityProtoEnumAccessLookupDTO.from_dict(instance.to_dict())
