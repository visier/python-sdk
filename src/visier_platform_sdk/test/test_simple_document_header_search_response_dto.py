...
class TestSimpleDocumentHeaderSearchResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleDocumentHeaderSearchResponseDTO:
        ...
        if include_optional:
            return SimpleDocumentHeaderSearchResponseDTO(
                document_headers = [
                    visier_platform_sdk.models.simple_document_header_search_result_dto.SimpleDocumentHeaderSearchResultDTO(
                        display_name = '', 
                        description = '', 
                        relevance = 1.337, 
                        view_link = None, )
    ...
    def testSimpleDocumentHeaderSearchResponseDTO(self):
        ...
        def validate_instance(instance):
            SimpleDocumentHeaderSearchResponseDTO.model_validate(instance)
