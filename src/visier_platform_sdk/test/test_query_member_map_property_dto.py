...
class TestQueryMemberMapPropertyDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> QueryMemberMapPropertyDTO:
        ...
        if include_optional:
            return QueryMemberMapPropertyDTO(
                member_map = visier_platform_sdk.models.data_model_dimension_reference_dto.DataModelDimensionReferenceDTO(
                    name = '', 
                    qualifying_path = '', ),
    ...
    def testQueryMemberMapPropertyDTO(self):
        ...
        def validate_instance(instance):
            QueryMemberMapPropertyDTO.model_validate(instance)
