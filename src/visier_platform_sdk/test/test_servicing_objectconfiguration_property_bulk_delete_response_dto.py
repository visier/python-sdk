    ...
    def make_instance(self, include_optional) -> ServicingObjectconfigurationPropertyBulkDeleteResponseDTO:
        ...
        if include_optional:
            return ServicingObjectconfigurationPropertyBulkDeleteResponseDTO(
                successes = [
                    visier_platform_sdk.models.servicing/objectconfiguration/property_delete_success_dto.servicing.objectconfiguration.PropertyDeleteSuccessDTO(
                        id = '', 
                        display_name = '', 
                        tenant_code = '', 
                        project_id = '', 
                ...
                failures = [
                    visier_platform_sdk.models.servicing/objectconfiguration/property_delete_failure_dto.servicing.objectconfiguration.PropertyDeleteFailureDTO(
                        id = '', 
                        display_name = '', 
                        message = '', 
                        rci = '', 
