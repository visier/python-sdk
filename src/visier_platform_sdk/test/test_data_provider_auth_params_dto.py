...
class TestDataProviderAuthParamsDTO(unittest.TestCase):
            ...
            return DataProviderAuthParamsDTO(
                ...
                echo_auth_params = visier_platform_sdk.models.echo_auth_params_dto.EchoAuthParamsDTO(
                    ...
                    basic_auth = visier_platform_sdk.models.echo_basic_auth_dto.EchoBasicAuthDTO(
                        ...
                        password = '', 
                        asid_token = '', ), 
                    o_auth = visier_platform_sdk.models.echo_o_auth_dto.EchoOAuthDTO(
                        client_id = '', 
                        client_secret = '', 
                        auth_code = '', 
                        access_token = '', 
                        refresh_token = '', 
                        expire_timestamp = '', ), ),
                snowflake_v2_auth_params = visier_platform_sdk.models.snowflake_v2_auth_params_dto.SnowflakeV2AuthParamsDTO(
                    account_identifier = '', 
                    database = '', 
                    schema = '', 
                    username = '', 
                    ...
                    role = '', 
                    tenant_code_column = '', ),
                sse_auth_params = visier_platform_sdk.models.sse_auth_params_dto.SSEAuthParamsDTO(
                    endpoint = '', 
                    username = '', 
                    password = '', 
                    stream_name = '', ),
                cdk_auth_params = visier_platform_sdk.models.cdk_auth_params_dto.CdkAuthParamsDTO(
                    docker_image = '', 
                    connector_config_json = '', ),
                viva_glint_auth_params = visier_platform_sdk.models.viva_glint_auth_params_dto.VivaGlintAuthParamsDTO(
                    tenant_id = '', 
                    client_id = '', 
                    client_secret = '', 
                    client_name = '', ),
                databricks_oidc_auth_params = visier_platform_sdk.models.databricks_oidc_auth_params_dto.DatabricksOIDCAuthParamsDTO(
                    client_id = '', 
                    client_secret = '', 
                    token_endpoint = '', 
                    endpoint = '', 
    ...
    def testDataProviderAuthParamsDTO(self):
        ...
        def validate_instance(instance):
            DataProviderAuthParamsDTO.model_validate(instance)
