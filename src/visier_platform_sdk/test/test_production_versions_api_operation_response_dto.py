...
class TestProductionVersionsAPIOperationResponseDTO(unittest.TestCase):
    ...
    def testProductionVersionsAPIOperationResponseDTO(self):
        ...
        def validate_instance(instance):
            ProductionVersionsAPIOperationResponseDTO.model_validate(inst_req_only)
            instance_deserialized = ProductionVersionsAPIOperationResponseDTO.from_dict(instance.to_dict())
