...
class TestDataAndJobHandlingApi(unittest.TestCase):
    ...
    def test_retrieve_receiving_job_extracted_files(self) -> None:
        """Test case for retrieve_receiving_job_extracted_files

        Retrieve a receiving job's files
        """
        pass

    def test_retrieve_tenant_source_files(self) -> None:
        """Test case for retrieve_tenant_source_files
