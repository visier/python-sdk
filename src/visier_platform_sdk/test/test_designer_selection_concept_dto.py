...
class TestDesignerSelectionConceptDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DesignerSelectionConceptDTO:
        ...
        if include_optional:
            return DesignerSelectionConceptDTO(
                uuid = '',
                name = '',
                configuration = visier_platform_sdk.models.selection_concept_configuration_dto.SelectionConceptConfigurationDTO(
    ...
    def testDesignerSelectionConceptDTO(self):
        ...
        def validate_instance(instance):
            DesignerSelectionConceptDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerSelectionConceptDTO.from_dict(instance.to_dict())
