...
class DataIntakeApi:
    ...
    def get_sources(
        ...
        Retrieve target sources before transferring data. Sources store data and map it to the Visier data model.   Contact Visier Customer Success to set up new sources. Query this endpoint to list available sources, schemas, and required fields.
    ...
    def push_data(
        self,
        transfer_session_id: Annotated[StrictStr, Field(description="The unique identifier of the transfer session.")],
        body: StrictStr,
        source_id: Annotated[Optional[StrictStr], Field(description="The unique identifier of the source to transfer data to.")] = None,
        sequence: Annotated[Optional[StrictInt], Field(description="The unique sequence number of a batch of records.")] = None,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The code of the tenant to transfer data to. For example, `WFF_j1r` or `WFF_j1r~c7o`.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Transfer record batches to Visier. Provide data as a comma-separated array with headers in the first row. Include header rows in all subsequent requests.   Each request transfers a batch to one source. Transfer sessions support multiple batches before completion.   Use sequence numbers to track and identify delivery issues across batches.   Batch limits:  - Batch size: 10 MB  - Record count: 300,000 rows

        :param transfer_session_id: The unique identifier of the transfer session. (required)
        :type transfer_session_id: str
        :param body: (required)
        :type body: str
        :param source_id: The unique identifier of the source to transfer data to.
        :type source_id: str
        :param sequence: The unique sequence number of a batch of records.
        :type sequence: int
        :param tenant_code: The code of the tenant to transfer data to. For example, `WFF_j1r` or `WFF_j1r~c7o`.
    ...
    def push_data_cancel(
        self,
        transfer_session_id: Annotated[StrictStr, Field(description="The unique identifier of the transfer session to cancel.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Cancel an active transfer session. Cancelled sessions don't persist data in Visier.   Start a new session and resend all data if you cancel a transfer.   Cancel sessions when:  - A batch request fails.  - Data records are incomplete.  - Infrastructure errors occur.

        :param transfer_session_id: The unique identifier of the transfer session to cancel. (required)
        :type transfer_session_id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def push_data_complete(
        ...
        Complete a transfer session and start a receiving job. The receiving job validates data and adds it to the Visier data store.   Optionally trigger a processing job immediately after completion to generate a data version.
    ...
    def start_transfer(
        ...
        Start a transfer session. Transfer sessions contain one or more record batches sent as JSON or file payloads.   For optimal performance, include all record batches in one transfer session.
