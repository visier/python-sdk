...
class PGPKeysApi:
    ...
    def delete_pgp_key_pair(
        self,
        key_id: Annotated[StrictStr, Field(description="The unique identifier of the generated key pair in 16-letter hexadecimal format, including leading zeros.")],
        ...
        :param key_id: The unique identifier of the generated key pair in 16-letter hexadecimal format, including leading zeros. (required)
        :type key_id: str
    ...
    def generate_pgp_key_pair(
        ...
        Generate a PGP key pair and retrieve the public encryption key.    Set key expiration in UTC using ISO 8601 format in the request body. Expiration must be between 2 and 10 years. Default is 2 years.
