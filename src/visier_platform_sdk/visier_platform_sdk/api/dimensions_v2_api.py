...
class DimensionsV2Api:
    ...
    def create_dimensions(
        ...
        Create new dimensions. Returns creation results for each dimension.  Assign a unique object name when creating objects. Do not set a UUID; Visier generates UUIDs for new objects.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def delete_dimensions(
        ...
        Delete existing dimensions. Returns deletion results for each dimension.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_all_dimensions(
        self,
        type: Annotated[Optional[List[StrictStr]], Field(description="The type of the dimension to retrieve. If unspecified, retrieves all dimension types. Valid values:  - `leveled`: Retrieves leveled dimensions.  - `parentChild`: Retrieves parent-child dimensions.")] = None,
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the dimension. Default is `basic`. Valid values:  - `basic`: Retrieves the dimension's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as levels and settings.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        analytic_object_name: Annotated[Optional[List[StrictStr]], Field(description="The object names of the analytic objects from which to retrieve dimensions. Default is all analytic objects.")] = None,
        analytic_object_uuid: Annotated[Optional[List[StrictStr]], Field(description="The UUIDs of the analytic objects from which to retrieve dimensions. Default is all analytic objects.")] = None,
        ...
        Retrieve dimensions in your Visier tenant. Optionally filter dimensions by dimension type or analytic object.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>

        :param type: The type of the dimension to retrieve. If unspecified, retrieves all dimension types. Valid values:  - `leveled`: Retrieves leveled dimensions.  - `parentChild`: Retrieves parent-child dimensions.
        :type type: List[str]
        :param var_with: The level of information to retrieve for the dimension. Default is `basic`. Valid values:  - `basic`: Retrieves the dimension's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as levels and settings.  - `version`: Retrieves the object's version information, such as version type and last edited details.
        :type var_with: List[str]
        :param analytic_object_name: The object names of the analytic objects from which to retrieve dimensions. Default is all analytic objects.
        :type analytic_object_name: List[str]
        :param analytic_object_uuid: The UUIDs of the analytic objects from which to retrieve dimensions. Default is all analytic objects.
    ...
    def get_one_dimension(
        ...
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the dimension. Default is `details`. Valid values:  - `basic`: Retrieves the dimension's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as levels and settings.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param var_with: The level of information to retrieve for the dimension. Default is `details`. Valid values:  - `basic`: Retrieves the dimension's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as levels and settings.  - `version`: Retrieves the object's version information, such as version type and last edited details.
        :type var_with: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def patch_dimensions(
        ...
        Partially update existing dimensions. Returns update results for each dimension. Retrieve dimension definitions using `GET` before patching. Use the `GET` response in `PATCH` requests.   Use `PATCH` to update specific fields without changing omitted fields. To replace full definitions, see `PUT /v2alpha/data/model/dimensions`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def put_dimensions(
        ...
        Update existing dimensions. Returns update results for each dimension. Retrieve dimension definitions using `GET` before updating. Use the `GET` response in `PUT` requests.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed. To partially update dimensions, see `PATCH /v2alpha/data/model/dimensions`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
