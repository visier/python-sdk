...
class SystemStatusApi:
    ...
    def post_system_status(
        ...
        Check the current overall status of Visier's systems.   Overall status values:  * `UP` : All systems are operational.  * `DOWN`: At least one system is not fully operational.
