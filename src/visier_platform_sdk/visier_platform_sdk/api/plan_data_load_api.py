...
class PlanDataLoadApi:
    ...
    def plan_data_upload(
        ...
        calculation: Annotated[Optional[StrictStr], Field(description="Sets the plan values to rollup, distribute, or neither. Default is `NONE`. Valid values:   - `ROLLUP`: Roll up loaded data values to parent and ancestor rows. If the data provides a parent value and its child value, this method prioritizes the loaded value for the child and overwrites the parent.   - `DISTRIBUTE`: Distribute loaded data values to their children and descendent rows. If the data provides a parent value and its child value, this method prioritizes the parent values and overrides the loaded child value.   - `NONE`: Loaded values aren't rolled up or distributed.")] = None,
        currency: Annotated[Optional[StrictStr], Field(description="The 3-digit ISO 4217 currency code of the data. If unspecified, default is the plan's consolidation currency. If the currency differs from the plan's consolidation currency, values convert to the consolidation currency using conversion rates loaded for the plan's baseline period.")] = None,
        method: Annotated[Optional[StrictStr], Field(description="Sets how to validate the data being loaded into Visier. Default is `STRICT_UPLOAD`. Valid values:   - `VALIDATE`: Runs a test load through all validation steps without putting data into the plan. Use `VALIDATE` to find errors before using `STRICT_UPLOAD` to load data.   - `SKIP_ERRORS`: Loads all data without errors into the plan. Rows with errors are excluded from the plan update.   - `STRICT_UPLOAD`: Loads data into the plan if there are no errors in any row. If errors exist, the load fails.")] = None,
        ...
        :param calculation: Sets the plan values to rollup, distribute, or neither. Default is `NONE`. Valid values:   - `ROLLUP`: Roll up loaded data values to parent and ancestor rows. If the data provides a parent value and its child value, this method prioritizes the loaded value for the child and overwrites the parent.   - `DISTRIBUTE`: Distribute loaded data values to their children and descendent rows. If the data provides a parent value and its child value, this method prioritizes the parent values and overrides the loaded child value.   - `NONE`: Loaded values aren't rolled up or distributed.
        :type calculation: str
        :param currency: The 3-digit ISO 4217 currency code of the data. If unspecified, default is the plan's consolidation currency. If the currency differs from the plan's consolidation currency, values convert to the consolidation currency using conversion rates loaded for the plan's baseline period.
        :type currency: str
        :param method: Sets how to validate the data being loaded into Visier. Default is `STRICT_UPLOAD`. Valid values:   - `VALIDATE`: Runs a test load through all validation steps without putting data into the plan. Use `VALIDATE` to find errors before using `STRICT_UPLOAD` to load data.   - `SKIP_ERRORS`: Loads all data without errors into the plan. Rows with errors are excluded from the plan update.   - `STRICT_UPLOAD`: Loads data into the plan if there are no errors in any row. If errors exist, the load fails.
        :type method: str
        ...
        _param = self._plan_data_upload_serialize(
            plan_id=plan_id,
    ...
    @validate_call
    def plan_data_upload_with_http_info(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the plan.")],
        scenario_id: Annotated[StrictStr, Field(description="The unique identifier of the plan scenario to load data into.")],
        calculation: Annotated[Optional[StrictStr], Field(description="Sets the plan values to rollup, distribute, or neither. Default is `NONE`. Valid values:   - `ROLLUP`: Roll up loaded data values to parent and ancestor rows. If the data provides a parent value and its child value, this method prioritizes the loaded value for the child and overwrites the parent.   - `DISTRIBUTE`: Distribute loaded data values to their children and descendent rows. If the data provides a parent value and its child value, this method prioritizes the parent values and overrides the loaded child value.   - `NONE`: Loaded values aren't rolled up or distributed.")] = None,
    ...
    @validate_call
    def plan_data_upload_without_preload_content(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the plan.")],
        scenario_id: Annotated[StrictStr, Field(description="The unique identifier of the plan scenario to load data into.")],
        calculation: Annotated[Optional[StrictStr], Field(description="Sets the plan values to rollup, distribute, or neither. Default is `NONE`. Valid values:   - `ROLLUP`: Roll up loaded data values to parent and ancestor rows. If the data provides a parent value and its child value, this method prioritizes the loaded value for the child and overwrites the parent.   - `DISTRIBUTE`: Distribute loaded data values to their children and descendent rows. If the data provides a parent value and its child value, this method prioritizes the parent values and overrides the loaded child value.   - `NONE`: Loaded values aren't rolled up or distributed.")] = None,
    ...
    def _plan_data_upload_serialize(
        self,
        plan_id,
        scenario_id,
        calculation,
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1/planning/data/plans/{planId}/scenarios/{scenarioId}/cells',
    ...
    def plan_row_data_load(
        ...
        _param = self._plan_row_data_load_serialize(
            plan_id=plan_id,
            method=method,
            target_tenant_id=target_tenant_id,
            file=file,
    ...
    @validate_call
    def plan_row_data_load_with_http_info(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the plan.")],
        method: Annotated[Optional[StrictStr], Field(description="Sets how to validate the data being loaded into Visier. Default is `STRICT_UPLOAD`. Valid values:   - `VALIDATE`: Runs a test load through all validation steps without putting data into the plan. Use `VALIDATE` to find errors before using `STRICT_UPLOAD` to load data.   - `SKIP_ERRORS`: Loads all data without errors into the plan. Rows with errors are excluded from the plan update.   - `STRICT_UPLOAD`: Loads data into the plan if there are no errors in any row. If errors exist, the load fails.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
    ...
    @validate_call
    def plan_row_data_load_without_preload_content(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the plan.")],
        method: Annotated[Optional[StrictStr], Field(description="Sets how to validate the data being loaded into Visier. Default is `STRICT_UPLOAD`. Valid values:   - `VALIDATE`: Runs a test load through all validation steps without putting data into the plan. Use `VALIDATE` to find errors before using `STRICT_UPLOAD` to load data.   - `SKIP_ERRORS`: Loads all data without errors into the plan. Rows with errors are excluded from the plan update.   - `STRICT_UPLOAD`: Loads data into the plan if there are no errors in any row. If errors exist, the load fails.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
    ...
    def _plan_row_data_load_serialize(
        self,
        plan_id,
        method,
        target_tenant_id,
