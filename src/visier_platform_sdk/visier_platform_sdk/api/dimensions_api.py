...
class DimensionsApi:
    ...
    def get_jobs_v1(
        ...
        _param = self._get_jobs_v1_serialize(
            hierarchy=hierarchy,
            parent=parent,
            term=term,
            naics_code=naics_code,
    ...
    @validate_call
    def get_jobs_v1_with_http_info(
        self,
        hierarchy: Annotated[Optional[StrictStr], Field(description="The ID of the job hierarchy to navigate.  If not provided, Visier's default job hierarchy is used. In the default hierarchy, jobs are organized into three levels with domain and subdomain groupings. ")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="The ID of the parent member.  If the ID is provided, the response returns the immediate children of the parent member.  To get the top-level members, use the value `root`.  Member availability and the parent-child relationship depends on the selected hierarchy. Please refer to the `hierarchy` parameter. ")] = None,
        term: Annotated[Optional[StrictStr], Field(description="The input search term. The job members that are the most semantically similar to the search term are returned with the most relevant job members displayed first.  Your search term may not be included in the results as semantic search goes beyond keyword matching and attempts to interpret the meaning behind the query to provide search results.  The minimum length is 2 characters and the maximum length is 100 characters.  ***The search term must be URL encoded.*** ")] = None,
    ...
    @validate_call
    def get_jobs_v1_without_preload_content(
        self,
        hierarchy: Annotated[Optional[StrictStr], Field(description="The ID of the job hierarchy to navigate.  If not provided, Visier's default job hierarchy is used. In the default hierarchy, jobs are organized into three levels with domain and subdomain groupings. ")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="The ID of the parent member.  If the ID is provided, the response returns the immediate children of the parent member.  To get the top-level members, use the value `root`.  Member availability and the parent-child relationship depends on the selected hierarchy. Please refer to the `hierarchy` parameter. ")] = None,
        term: Annotated[Optional[StrictStr], Field(description="The input search term. The job members that are the most semantically similar to the search term are returned with the most relevant job members displayed first.  Your search term may not be included in the results as semantic search goes beyond keyword matching and attempts to interpret the meaning behind the query to provide search results.  The minimum length is 2 characters and the maximum length is 100 characters.  ***The search term must be URL encoded.*** ")] = None,
    ...
    def get_jobs_v2(
        ...
        show_hierarchy: Annotated[Optional[StrictBool], Field(description="If `true`, returns members in a tree structure based on the occupation hierarchy. Default is `false`. ")] = None,
        include_archived: Annotated[Optional[StrictBool], Field(description="If `true`, both `active` and `archived` members are returned. Default is `false`. Members are archived when taxonomy changes are made. ")] = None,
        page: Annotated[Optional[StrictInt], Field(description="The subset of the overall result set to return. The number of rows per page is equal to `limit`, except the last page which may contain fewer rows. Page is an index that begins at 0. The index to start retrieving results is calculated by multiplying `page` by `limit`. Default is to return results for page 0. ")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of entries to return. Default and maximum are 1000 entries. ")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Retrieve a list of all the jobs in Visier's ontology. Jobs V2 improves upon Jobs V1 in the following ways: - Supports pagination through the `page` and `limit` parameters. - Returns both the short and long versions of job descriptions and job typical titles. 
        ...
        :param include_archived: If `true`, both `active` and `archived` members are returned. Default is `false`. Members are archived when taxonomy changes are made. 
        :type include_archived: bool
        :param page: The subset of the overall result set to return. The number of rows per page is equal to `limit`, except the last page which may contain fewer rows. Page is an index that begins at 0. The index to start retrieving results is calculated by multiplying `page` by `limit`. Default is to return results for page 0. 
        :type page: int
        :param limit: The maximum number of entries to return. Default and maximum are 1000 entries. 
        :type limit: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._get_jobs_v2_serialize(
            hierarchy=hierarchy,
            parent=parent,
            term=term,
            naics_code=naics_code,
    ...
    @validate_call
    def get_jobs_v2_with_http_info(
        self,
        hierarchy: Annotated[Optional[StrictStr], Field(description="The ID of the job hierarchy to navigate.  If not provided, Visier's default job hierarchy is used. In the default hierarchy, jobs are organized into three levels with domain and subdomain groupings. ")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="The ID of the parent member.  If the ID is provided, the response returns the immediate children of the parent member.  To get the top-level members, use the value `root`.  Member availability and the parent-child relationship depends on the selected hierarchy. Please refer to the `hierarchy` parameter. ")] = None,
        term: Annotated[Optional[StrictStr], Field(description="The input search term. The job members that are the most semantically similar to the search term are returned with the most relevant job members displayed first.  Your search term may not be included in the results as semantic search goes beyond keyword matching and attempts to interpret the meaning behind the query to provide search results.  The minimum length is 2 characters and the maximum length is 100 characters.  ***The search term must be URL encoded.*** ")] = None,
    ...
    @validate_call
    def get_jobs_v2_without_preload_content(
        self,
        hierarchy: Annotated[Optional[StrictStr], Field(description="The ID of the job hierarchy to navigate.  If not provided, Visier's default job hierarchy is used. In the default hierarchy, jobs are organized into three levels with domain and subdomain groupings. ")] = None,
        parent: Annotated[Optional[StrictStr], Field(description="The ID of the parent member.  If the ID is provided, the response returns the immediate children of the parent member.  To get the top-level members, use the value `root`.  Member availability and the parent-child relationship depends on the selected hierarchy. Please refer to the `hierarchy` parameter. ")] = None,
        term: Annotated[Optional[StrictStr], Field(description="The input search term. The job members that are the most semantically similar to the search term are returned with the most relevant job members displayed first.  Your search term may not be included in the results as semantic search goes beyond keyword matching and attempts to interpret the meaning behind the query to provide search results.  The minimum length is 2 characters and the maximum length is 100 characters.  ***The search term must be URL encoded.*** ")] = None,
    ...
    def _get_jobs_v2_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/compensation-benchmarks/jobs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_taxonomy_change_info(
        ...
        _param = self._get_taxonomy_change_info_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def get_taxonomy_change_info_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_taxonomy_change_info_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_taxonomy_change_info_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/compensation-benchmarks/taxonomy-change-info',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
