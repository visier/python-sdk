...
class UserGroupsV2Api:
    ...
    def delete_user_group(
        self,
        user_group_id: Annotated[StrictStr, Field(description="The unique identifier of user group to delete.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        non_versioned: Annotated[Optional[StrictBool], Field(description="If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.")] = None,
        _request_timeout: Union[
        ...
        :param user_group_id: The unique identifier of user group to delete. (required)
    ...
    def get_user_group(
        self,
        user_group_id: Annotated[StrictStr, Field(description="The unique identifier of the user group.")],
    ...
    def get_user_groups(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of user groups to return. Default is 100. Maximum is 1000.")] = None,
        ...
        correlation_ids: Annotated[Optional[StrictStr], Field(description="If defined, `correlationIds` limits the response to the user groups associated with the specified correlation IDs.  You can specify multiple correlation IDs in the `correlationIds` parameter separated by commas; for example, `correlationIds=123,abc,456`.   **Note**:  - Correlation IDs must be between 3 and 64 characters long and may only contain alphanumeric characters, underscores and hyphens.  - Correlation IDs have a lifetime of up to 7 days after creation. After a correlation ID expires, you can only retrieve specific user groups using the user group ID.  - Correlation IDs are optional during user group creation and are only applicable to those objects created with a defined correlation ID.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        non_versioned: Annotated[Optional[StrictBool], Field(description="If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.")] = None,
        _request_timeout: Union[
        ...
        :type var_with: str
        :param limit: The maximum number of user groups to return. Default is 100. Maximum is 1000.
        :type limit: int
        ...
        :param correlation_ids: If defined, `correlationIds` limits the response to the user groups associated with the specified correlation IDs.  You can specify multiple correlation IDs in the `correlationIds` parameter separated by commas; for example, `correlationIds=123,abc,456`.   **Note**:  - Correlation IDs must be between 3 and 64 characters long and may only contain alphanumeric characters, underscores and hyphens.  - Correlation IDs have a lifetime of up to 7 days after creation. After a correlation ID expires, you can only retrieve specific user groups using the user group ID.  - Correlation IDs are optional during user group creation and are only applicable to those objects created with a defined correlation ID.
        :type correlation_ids: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
        :type project_id: str
    ...
    def _get_user_groups_serialize(
        ...
        if correlation_ids is not None:
            ...
            _query_params.append(('correlationIds', correlation_ids))
    ...
    def revert_user_groups_to_parent(
        ...
        Revert a user group to its parent version.    Reverting behavior by object type:  - Blueprint object: No changes. Objects are inherited from the parent.  - Tenant override object: Reverts to the Blueprint version or administrating tenant version.  - Tenant object: Request fails. Tenant-unique objects do not have Blueprint versions.
