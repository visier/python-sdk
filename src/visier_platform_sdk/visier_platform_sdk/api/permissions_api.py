...
class PermissionsApi:
    ...
    def create_security_filters(
        ...
        Create shareable security filters. Shareable security filters let you reuse a common population in multiple permissions.   To specify the project in which to create shareable security filters, provide a project UUID in the `ProjectID` request header.
    ...
    def delete_data_access_sets(
        ...
        Delete shareable data access sets.   To specify the project in which to delete shareable data access sets, provide a project UUID in the `ProjectID` request header.
    ...
    def delete_security_filters(
        ...
        Delete shareable security filters.   To specify the project in which to delete shareable security filters, provide a project UUID in the `ProjectID` request header.
    ...
    def get_security_filter(
        ...
        Retrieve a specific shareable security filter. You must know the ID of the security filter to retrieve its details. To retrieve security filter IDs, see `GET v1/admin/security-filters`.   To specify the project in which to retrieve the shareable security filter, provide a project UUID in the `ProjectID` request header.
    ...
    def get_security_filters(
        ...
        """Retrieve all security filters

        Retrieve all shareable security filters. Security filters define the population of members that users have access to for the analytic object in a permission.  You can assign security filters to a permission when creating or updating permissions.   To specify the project in which to retrieve the shareable security filters, provide a project UUID in the `ProjectID` request header.
    ...
    def sync_to_non_versioned(
        ...
        Copies permissions, data access sets, user groups, and user direct assignments from the versioned environment to the non-versioned environment. This operation immediately applies the security configurations, independent of data versioning.   The versioned environment utilizes projects and data versions while the non-versioned environment applies changes directly.   This endpoint always synchronizes permissions and data access sets. You can optionally synchronize user group assignments and direct permissions assignments to users.   Use this to apply security configurations immediately without waiting for data version changes. This is particularly useful for administrating tenants syncing security artifacts to analytic tenants.
    ...
    def update_data_access_sets(
        ...
        Update shareable data access sets. Shareable data access sets let you reuse common data access configurations in multiple permissions.   To specify the project in which to update shareable data access sets, provide a project UUID in the `ProjectID` request header.
    ...
    def update_security_filters(
        ...
        Update shareable security filters. Shareable security filters let you reuse a common population in multiple permissions.   To specify the project in which to update shareable security filters, provide a project UUID in the `ProjectID` request header.
