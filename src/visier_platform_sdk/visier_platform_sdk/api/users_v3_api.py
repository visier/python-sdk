...
class UsersV3Api:
    ...
    def update_users(
        ...
        Update a user if the user exists, otherwise create a new user. Use the user's `username` to specify the user to update or create.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed from the user if the user exists.
    ...
    def _update_users_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v3/admin/users/{username}',
