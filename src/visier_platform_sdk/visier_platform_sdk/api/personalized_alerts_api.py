...
class PersonalizedAlertsApi:
    ...
    def create_alert(
        ...
        Create a new personalized alert. Define display names and trigger criteria in the request body, including metrics, filters, time periods, and threshold values.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def delete_alert(
        ...
        Delete personalized alerts created by the requesting user. To disable alerts without deleting them, see `PUT /v1alpha/alerts/{alertId}/recipient-status`. You must know the ID of the alert to delete it. To retrieve all alert IDs, see `GET /v1alpha/alerts`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_alert(
        ...
        Retrieve the details of a specific personalized alert. You must know the ID of the alert to retrieve its details. To retrieve all alert IDs, see `GET /v1alpha/alerts`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_alerts(
        ...
        Retrieve accessible personalized alerts. Returns alert IDs, creators, and status.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_notifications(
        ...
        Retrieve active personalized alert notifications from the last 30 days. Returns trigger dates and criteria for active alerts.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def _get_notifications_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1alpha/notifications',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_alert(
        ...
        Update personalized alerts created by the requesting user. You must know the ID of the alert to update it. To retrieve all alert IDs, see `GET /v1alpha/alerts`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def update_recipient_status(
        ...
        Enable or disable personalized alerts. Disabling an alert removes notifications from the Home room and email digests. Re-enable alerts at any time.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
