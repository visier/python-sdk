...
class PlanAdministrationApi:
    ...
    def patch_plan(
        ...
        Make partial changes to a scenario in an existing plan. The response returns whether the scenario was successfully patched or not. When patching objects, we recommend that you first retrieve the object definition using `GET`. You can use the `GET` response in your `PATCH` request definition. To retrieve plan IDs and scenario IDs, see `GET /v1/planning/model/plans`. If the response includes a `parentPlanUuid`, then the plan is a subplan.   Use `PATCH` to change specific fields in the scenario without affecting omitted fields.
    ...
    def _patch_plan_serialize(
        ...
        return self.api_client.param_serialize(
            method='PATCH',
            resource_path='/v1/planning/data/plans/{planId}/scenarios/{scenarioId}',
    ...
    def patch_plan_alpha(
        ...
        _param = self._patch_plan_alpha_serialize(
            plan_id=plan_id,
            scenario_id=scenario_id,
            plan_scenario_patch_request=plan_scenario_patch_request,
            _request_auth=_request_auth,
    ...
    @validate_call
    def patch_plan_alpha_with_http_info(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the main plan or subplan. Use the main plan ID for consolidating, starting collaboration, or ending collaboration. Otherwise, use the subplan ID.")],
        scenario_id: Annotated[StrictStr, Field(description="The unique identifier of the plan scenario.")],
        plan_scenario_patch_request: PlanScenarioPatchRequest,
    ...
    @validate_call
    def patch_plan_alpha_without_preload_content(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the main plan or subplan. Use the main plan ID for consolidating, starting collaboration, or ending collaboration. Otherwise, use the subplan ID.")],
        scenario_id: Annotated[StrictStr, Field(description="The unique identifier of the plan scenario.")],
        plan_scenario_patch_request: PlanScenarioPatchRequest,
    ...
    def _patch_plan_alpha_serialize(
        self,
        plan_id,
        scenario_id,
        plan_scenario_patch_request,
    ...
    def plan_action(
        ...
        _param = self._plan_action_serialize(
            plan_id=plan_id,
    ...
    @validate_call
    def plan_action_with_http_info(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the plan.")],
        plan_patch_request: PlanPatchRequest,
        _request_timeout: Union[
    ...
    @validate_call
    def plan_action_without_preload_content(
        self,
        plan_id: Annotated[StrictStr, Field(description="The unique identifier of the plan.")],
        plan_patch_request: PlanPatchRequest,
        _request_timeout: Union[
