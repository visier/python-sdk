...
class ConsolidatedAnalyticsApi:
    ...
    def add_excluded_sources(
        self,
        tenant_id: Annotated[StrictStr, Field(description="The unique identifier of the tenant. For example, `WFF_{XXX}~CA{YYY}` where `{XXX}` is the administrating tenant code and `{YYY}`  is the consolidated analytic tenant code.")],
        ...
        :param tenant_id: The unique identifier of the tenant. For example, `WFF_{XXX}~CA{YYY}` where `{XXX}` is the administrating tenant code and `{YYY}`  is the consolidated analytic tenant code. (required)
        :type tenant_id: str
    ...
    def add_source_tenants(
        ...
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of source tenants to return. Default is 400. Maximum is 1000.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Add source tenants to the list of source tenants for a consolidated analytics tenant.   If successful, returns an updated list of source tenants.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>

        :param tenant_id: The unique identifier of the tenant. For example, `WFF_{XXX}~CA{YYY}` where `{XXX}` is the administrating tenant code and `{YYY}`  is the consolidated analytic tenant code. (required)
        :type tenant_id: str
        :param tenant_code_body: (required)
        :type tenant_code_body: TenantCodeBody
        :param limit: The maximum number of source tenants to return. Default is 400. Maximum is 1000.
        :type limit: int
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def list_tenants(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of tenants to return. Default is 400. Maximum is 1000.")] = None,
        ...
        :param limit: The maximum number of tenants to return. Default is 400. Maximum is 1000.
        :type limit: int
    ...
    def list_tenants_with_details(
        ...
        Retrieve the full list of consolidated analytics tenants and their details in your administrating tenant.   **Note**: If your consolidated analytics tenants have thousands of source tenants, use `GET /v1alpha/admin/consolidated-analytics/tenants` to get all CA tenants, then use `GET /v1alpha/admin/consolidated-analytics/tenants/{tenantId}/source-tenants` and `GET /v1alpha/admin/consolidated-analytics/tenants/{tenantId}/excluded-sources` to retrieve details for specific CA tenants.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def remove_source_tenants(
        ...
        Remove source tenants from the list of source tenants for a consolidated analytics tenant.   If successful, returns an updated list of source tenants.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def set_excluded_sources(
        ...
        Define the excluded sources for a consolidated analytics tenant.   After creating a CA tenant, define excluded sources to exclude their data from the CA tenant. You can also use this endpoint to replace excluded sources for an existing CA tenant.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def set_source_tenants(
        ...
        Define the source tenants for a consolidated analytics tenant.   After creating a CA tenant, define its source tenants. Source tenants provide data that aggregates into the CA tenant. You can also use this endpoint to replace source tenants for an existing CA tenant.   If successful, returns an updated list of source tenants.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
