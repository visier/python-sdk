...
class DirectDataIntakeApi:
    ...
    def commit_transaction(
        ...
        Process a transaction and its uploaded data files. This starts a processing job to load the files into Visier.   After committing a transaction, you can't upload more files to it. Monitor the job status using `GET /v1/data/directloads/{draftId}/transactions/{transactionId}`.
    ...
    def list_transactions(
        self,
        draft_id: Annotated[StrictStr, Field(description="The unique identifier of the project to retrieve open transactions from. Currently, the only supported value is `prod` to retrieve open transactions for the production version.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param draft_id: The unique identifier of the project to retrieve open transactions from. Currently, the only supported value is `prod` to retrieve open transactions for the production version. (required)
        :type draft_id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def load_sample_data(
        ...
        draft_id: Annotated[StrictStr, Field(description="The unique identifier of the project to load data into. Currently, the only supported value is `prod` to update the production version.")],
        transaction_id: Annotated[StrictStr, Field(description="The unique identifier of the transaction.")],
        object_name: Annotated[StrictStr, Field(description="The object name of the analytic object to load sample data into.")],
        direct_data_sample_data_dto: DirectDataSampleDataDTO,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param transaction_id: The unique identifier of the transaction. (required)
        :type transaction_id: str
        :param object_name: The object name of the analytic object to load sample data into. (required)
        :type object_name: str
        :param direct_data_sample_data_dto: (required)
        :type direct_data_sample_data_dto: DirectDataSampleDataDTO
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
        ...
        _param = self._load_sample_data_serialize(
            ...
            direct_data_sample_data_dto=direct_data_sample_data_dto,
            target_tenant_id=target_tenant_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _load_sample_data_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if direct_data_sample_data_dto is not None:
            _body_params = direct_data_sample_data_dto
    ...
    def object_schema(
        ...
        Retrieve the data load schema for an object. The load schema defines the required structure for uploading data files to the object.   Your data file must include column headers that match the schema exactly. Column names are case sensitive. Only columns with `isMandatory` set to `true` require values.
    ...
    def put_config(
        ...
        Configure the data intake settings, such as the direct data intake job type. Only provide values for settings that you want to change.   Settings that aren't present in the request body are ignored and remain unchanged.
    ...
    def rollback_transaction(
        ...
        Roll back a transaction. This deletes the transaction and discards all uploaded files.   After rolling back a transaction, you can't use it to upload data files.
    ...
    def start_transaction(
        ...
        Start a transaction to contain your data files. You can then upload files to objects in Visier.   After starting a transaction and uploading files, commit the transaction to process the files. You can also roll back the transaction to discard the files.
