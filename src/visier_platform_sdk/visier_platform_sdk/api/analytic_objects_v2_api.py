...
class AnalyticObjectsV2Api:
    ...
    def create_analytic_objects(
        ...
        Create new analytic objects. Returns creation results for each analytic object.  Assign a unique object name when creating objects. Do not set a UUID; Visier generates UUIDs for new objects.    <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def delete_analytic_objects(
        ...
        Delete existing analytic objects. Returns deletion results for each analytic object.    <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_all_analytic_objects(
        self,
        type: Annotated[Optional[List[StrictStr]], Field(description="The type of the analytic object to retrieve. If unspecified, retrieves all analytic object types. Valid values:  - `subject`: Retrieves subject analytic objects.  - `event`: Retrieves event analytic objects.")] = None,
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the analytic object. Default is `basic`. Valid values:  - `basic`: Retrieves the analytic object's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as properties, dimensions, and references.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        ...
        Retrieve analytic objects in your Visier tenant.    <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>

        :param type: The type of the analytic object to retrieve. If unspecified, retrieves all analytic object types. Valid values:  - `subject`: Retrieves subject analytic objects.  - `event`: Retrieves event analytic objects.
        :type type: List[str]
        :param var_with: The level of information to retrieve for the analytic object. Default is `basic`. Valid values:  - `basic`: Retrieves the analytic object's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as properties, dimensions, and references.  - `version`: Retrieves the object's version information, such as version type and last edited details.
    ...
    def get_one_analytic_object(
        ...
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the analytic object. Default is `details`. Valid values:  - `basic`: Retrieves the analytic object's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as properties, dimensions, and references.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param var_with: The level of information to retrieve for the analytic object. Default is `details`. Valid values:  - `basic`: Retrieves the analytic object's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as properties, dimensions, and references.  - `version`: Retrieves the object's version information, such as version type and last edited details.
        :type var_with: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def patch_analytic_objects(
        ...
        Partially update existing analytic objects. Returns update results for each analytic object. Retrieve object definitions using `GET` before patching. Use the `GET` response in `PATCH` requests.   Use `PATCH` to update specific fields without changing omitted fields. To replace full definitions, see `PUT /v2alpha/data/model/analytic-objects`.    <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def put_analytic_objects(
        ...
        Replace existing analytic objects. Returns update results for each analytic object. Retrieve object definitions using `GET` before updating. Use the `GET` response in `PUT` requests.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed. To partially update an analytic object, see `PATCH /v2alpha/data/model/analytic-objects`.    <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
