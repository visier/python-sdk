...
class ProfilesApi:
    ...
    def assign_analytic_profile(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile to assign.")],
        ...
        Assign an analytic tenant profile to a list of administrating tenant users for a list of analytic tenants.   **Note**:   - Administrating tenants only.   - Revoke a profile by setting `validityEndTime` to a past time.

        :param profile_id: The unique identifier of the profile to assign. (required)
        :type profile_id: str
    ...
    def assign_profile(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile to assign to a list of users.")],
        ...
        :param profile_id: The unique identifier of the profile to assign to a list of users. (required)
        :type profile_id: str
    ...
    def get_analytic_profile_detail(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile to retrieve details for.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Retrieve the details of an analytic tenant profile.   **Note**: Administrating tenants only.

        :param profile_id: The unique identifier of the profile to retrieve details for. (required)
        :type profile_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def remove_analytic_profile(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile to remove.")],
        ...
        :param profile_id: The unique identifier of the profile to remove. (required)
        :type profile_id: str
    ...
    def remove_profile(
        self,
        profile_id: Annotated[StrictStr, Field(description="The unique identifier of the profile to remove to a list of users.")],
        ...
        :param profile_id: The unique identifier of the profile to remove to a list of users. (required)
        :type profile_id: str
