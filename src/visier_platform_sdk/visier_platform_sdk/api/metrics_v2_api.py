...
class MetricsV2Api:
    ...
    def create_metrics(
        ...
        Create new simple or derived metrics. Returns creation results for each metric.  Assign a unique object name when creating objects. Do not set a UUID; Visier generates UUIDs for new objects.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def delete_metrics(
        ...
        Delete existing simple or derived metrics. Returns deletion results for each metric. Deleting a simple metric deletes dependent derived metrics.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_all_metrics(
        ...
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the metric. Default is `basic`. Valid values:  - `basic`: Retrieves the metric's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        ...
        Retrieve simple or derived metrics in your Visier tenant. Returns `basic` metric definitions by default.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
        ...
        :type type: List[str]
        :param var_with: The level of information to retrieve for the metric. Default is `basic`. Valid values:  - `basic`: Retrieves the metric's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.
    ...
    def get_analytic_object_metrics(
        ...
        Retrieve simple or derived metrics for an analytic object. Returns `basic` metric definitions by default.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_one_metric(
        ...
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the metric. Default is `details`. Valid values:  - `basic`: Retrieves the metric's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        Retrieve details for a specific simple or derived metric, including metric type and description. Returns detailed metric definitions by default.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>

        :param metric_id: The object name or UUID of the metric to retrieve. (required)
        :type metric_id: str
        :param var_with: The level of information to retrieve for the metric. Default is `details`. Valid values:  - `basic`: Retrieves the metric's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.
        :type var_with: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def patch_metrics(
        ...
        Partially update existing simple or derived metrics. Returns update results for each metric. Retrieve metric definitions using `GET` before patching. Use the `GET` response in `PATCH` requests.   Use `PATCH` to update specific fields without changing omitted fields. To replace full definitions, see `PUT /v2alpha/data/model/metrics`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def put_metrics(
        ...
        Update simple or derived metrics. Returns update results for each metric. Retrieve metric definitions using `GET` before updating. Use the `GET` response in `PUT` requests.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed. To partially update metrics, see `PATCH /v2alpha/data/model/metrics`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
