...
class ConceptsV2Api:
    ...
    def get_all_concepts(
        ...
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the concept. Default is `basic`. Valid values:  - `basic`: Retrieves the concept's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        ...
        :type type: List[str]
        :param var_with: The level of information to retrieve for the concept. Default is `basic`. Valid values:  - `basic`: Retrieves the concept's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.
    ...
    def get_one_concept(
        ...
        var_with: Annotated[Optional[List[StrictStr]], Field(description="The level of information to retrieve for the concept. Default is `details`. Valid values:  - `basic`: Retrieves the concept's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :type concept_id: str
        :param var_with: The level of information to retrieve for the concept. Default is `details`. Valid values:  - `basic`: Retrieves the concept's UUID, object name, and basic information.  - `details`: Retrieves the `basic` details and additional configurations, such as `visibleInAnalytics`.  - `version`: Retrieves the object's version information, such as version type and last edited details.
        :type var_with: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def patch_concepts(
        ...
        Partially update existing concepts. Returns update results for each concept. Retrieve concept definitions using `GET` before patching. Use the `GET` response in `PATCH` requests.   Use `PATCH` to update specific fields without changing omitted fields. To replace full definitions, see `PUT /v2/data/model/concepts`.
    ...
    def put_concepts(
        ...
        Update existing concepts. Returns update results for each concept. Retrieve concept definitions using `GET` before updating. Use the `GET` response in `PUT` requests.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed. To partially update concepts, see `PATCH /v2/data/model/concepts`.
