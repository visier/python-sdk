...
class DataQueryApi:
    ...
    def aggregate(
        ...
        data_version_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a data version against which to execute the query. If omitted, the request uses the current project's data version or the production version if no project is specified.")] = None,
        ...
        :type project_id: str
        :param data_version_id: Optionally, specify a data version against which to execute the query. If omitted, the request uses the current project's data version or the production version if no project is specified.
        :type data_version_id: str
    ...
    def _aggregate_serialize(
        ...
        if data_version_id is not None:
            _header_params['DataVersionID'] = data_version_id
    ...
    def list(
        ...
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        data_version_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a data version against which to execute the query. If omitted, the request uses the data version released by the current project or production version, if no project is specified.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
        :type project_id: str
        :param data_version_id: Optionally, specify a data version against which to execute the query. If omitted, the request uses the data version released by the current project or production version, if no project is specified.
        :type data_version_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
