...
from visier_platform_sdk.models.connector_version_dto import ConnectorVersionDTO
...
class DataQueryApi:
    ...
    def connector_version(
        self,
        connector_id: Annotated[Optional[StrictStr], Field(description="The name of the connector for which to retrieve the latest version. Valid values:  - `powerbi`: Retrieve the latest version of Visier's Power BI connector.  - `tableau`: Retrieve the latest version of Visier's Tableau connector.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param connector_id: The name of the connector for which to retrieve the latest version. Valid values:  - `powerbi`: Retrieve the latest version of Visier's Power BI connector.  - `tableau`: Retrieve the latest version of Visier's Tableau connector.
        ...
        _param = self._connector_version_serialize(
    ...
    @validate_call
    def connector_version_with_http_info(
        self,
        connector_id: Annotated[Optional[StrictStr], Field(description="The name of the connector for which to retrieve the latest version. Valid values:  - `powerbi`: Retrieve the latest version of Visier's Power BI connector.  - `tableau`: Retrieve the latest version of Visier's Tableau connector.")] = None,
        _request_timeout: Union[
            None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ConnectorVersionDTO]:
        """Retrieve a data out connector's latest version
    ...
    @validate_call
    def connector_version_without_preload_content(
        self,
        connector_id: Annotated[Optional[StrictStr], Field(description="The name of the connector for which to retrieve the latest version. Valid values:  - `powerbi`: Retrieve the latest version of Visier's Power BI connector.  - `tableau`: Retrieve the latest version of Visier's Tableau connector.")] = None,
        _request_timeout: Union[
            None,
    ...
    def _connector_version_serialize(
        self,
        connector_id,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/data/query/connector-version',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def query_snapshot(
        ...
        Retrieve detailed time series snapshots taken at defined intervals. Each snapshot links to an effective date timestamp when data was valid.   Snapshot queries differ from list queries:  * A snapshot query can include an `effectiveDateProperty` column to specify time. Add this object to the `columns` array:     ```json     {         \"columnName\": \"Snapshot_Date\",         \"columnDefinition\": {             \"effectiveDateProperty\": {}         }     }     ```  * A snapshot query uses `timeIntervals` instead of `timeInterval` to specify generated snapshot counts. Use `intervalCount` in `timeIntervals`:     ```json     {         \"timeIntervals\": {         \"fromDateTime\": \"2022-01-01\",         \"intervalPeriodType\": \"MONTH\",         \"intervalPeriodCount\": 6,         \"intervalCount\": 4     }     ```
    ...
    def sql_like(
        ...
        Query aggregate or list data using SQL-like syntax.  Responses match query types. Aggregate query results flatten into tabular formats when requested.   Queries containing metrics are aggregate queries and must specify time intervals divided into periods:  ```sql  SELECT    employeeCount() AS \"Employee Count\",    level(Gender, \"Gender\") AS Gender  FROM    Employee  WHERE   Visier_Time IN periods(date(\"2023-01-01\"), 4, period(3, Month));  ```   Queries without metrics are list queries and define time intervals as simple ranges:  ```sql  SELECT    EmployeeID AS \"Employee ID\",    level(Gender, \"Gender\") AS Gender  FROM    Employee  WHERE   Visier_Time BETWEEN date(\"2022-01-01\") AND date(\"2023-01-01\");  ```
