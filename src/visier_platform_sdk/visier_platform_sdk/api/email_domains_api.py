...
class EmailDomainsApi:
    ...
    def _add_allowed_email_domains_serialize(
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1alpha/admin/email-domains',
    ...
    def delete_allowed_email_domains(
        self,
        delete_email_domains_dto: DeleteEmailDomainsDTO,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param delete_email_domains_dto: (required)
        :type delete_email_domains_dto: DeleteEmailDomainsDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._delete_allowed_email_domains_serialize(
            delete_email_domains_dto=delete_email_domains_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def delete_allowed_email_domains_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DeleteEmailDomainsDTO]:
        """Remove domains from the list of allowed domains
    ...
    def _delete_allowed_email_domains_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if delete_email_domains_dto is not None:
            _body_params = delete_email_domains_dto
    ...
    @validate_call
    def list_allowed_email_domains(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        _param = self._list_allowed_email_domains_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    @validate_call
    def list_allowed_email_domains_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def list_allowed_email_domains_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _list_allowed_email_domains_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
