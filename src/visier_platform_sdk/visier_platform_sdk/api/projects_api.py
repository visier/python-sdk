...
class ProjectsApi:
    ...
    def delete_project(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the draft project to delete.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param project_id: The unique identifier of the draft project to delete. (required)
        :type project_id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_project(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the draft project to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param project_id: The unique identifier of the draft project to retrieve. (required)
        :type project_id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_project_commits(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the draft project to retrieve the committed changes for.")],
        ...
        :param project_id: The unique identifier of the draft project to retrieve the committed changes for. (required)
        :type project_id: str
    ...
    def get_projects(
        ...
        Retrieve a list of draft projects accessible to the requesting user in the tenant.   A project is accessible if it is owned by the user or shared to the user.
        ...
        :param limit: The maximum number of projects to return per type. Default is 100. Maximum is 1000.
        :type limit: int
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def put_project_commits(
        self,
        project_id: Annotated[StrictStr, Field(description="The unique identifier of the draft project to import committed changes into.")],
        ...
        :param project_id: The unique identifier of the draft project to import committed changes into. (required)
        :type project_id: str
        :param body: (required)
        :type body: bytearray
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
    ...
    def run_project_operation(
        ...
        Perform operations on a draft project. Supported operations:  * `commitAndPublish`: Commits project changes and publishes the project to production.
