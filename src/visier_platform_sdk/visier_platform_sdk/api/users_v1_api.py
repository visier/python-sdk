...
class UsersV1Api:
    ...
    def add_users_to_user_group(
        ...
        Assign users to specific user groups.  Administrating tenants can assign users to user groups in multiple analytic tenants by providing a tenant code and project ID in the request body.   We recommend that administrating tenants set the analytic tenant in which to execute the API call using the `TargetTenantID` request header.
        ...
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param non_versioned: If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.
        :type non_versioned: bool
        :param prefer: When `NonVersioned: true`, use `Prefer` to optionally specify if API calls should be subject to locking. Locking prevents incremental changes in multiple API calls from overwriting each other. The `Prefer` header works alongside a tenant feature flag. When enabled, the default is `nvLock=global`. When disabled, the default is not to lock API calls. Contact Visier Technical Support to enable the tenant feature flag. Valid values for the `Prefer` header: * `nvLock=global`: Run API calls sequentially. Sequential API calls prevent calls from unintentionally overwriting each other. * `nvLock=artifact`: Allow API calls in parallel. Parallel API calls only work if the calls do not conflict with each other. If a change wasn't applied, the request fails and returns the HTTP 409 conflict error. Run the request again until successful. * `nvLock=none`: Disable the global lock if the tenant feature flag is enabled.
        :type prefer: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def assign_permissions(
        ...
        :param non_versioned: If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.
        :type non_versioned: bool
        :param session_based_permissions: If `true`, the API call assigns user permissions that are only valid for the specified `SessionRepoId` without creating a new production version. When a user signs in to your application with the `SessionRepoId`, their session-based permissions are valid until the user session ends. Cannot be `true` if `NonVersioned` is `true`. Default is `false`.<br/>**Note**: <em>This header is in **limited availability**. If you are interested in using it, please contact your Customer Success Manager (CSM).</em>
        :type session_based_permissions: bool
        :param session_repo_id: Optionally, specify a session repository ID to overwrite the user's permissions that are associated with the `SessionRepoId`. Only valid with `SessionBasedPermissions`. If omitted and `SessionBasedPermissions` is `true`, the API creates a new `SessionRepoId`.
        :type session_repo_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._assign_permissions_serialize(
            ...
            target_tenant_id=target_tenant_id,
            non_versioned=non_versioned,
            session_based_permissions=session_based_permissions,
    ...
    def _assign_permissions_serialize(
        ...
        if non_versioned is not None:
            _header_params['NonVersioned'] = non_versioned
        if session_based_permissions is not None:
            _header_params['SessionBasedPermissions'] = session_based_permissions
        if session_repo_id is not None:
            _header_params['SessionRepoId'] = session_repo_id
        # process the form parameters
        # process the body parameter
    ...
    def delete_user(
        ...
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to delete a user in.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type user_id: str
        :param tenant_code: The tenant to delete a user in.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_all_permissions_xlsx(
        self,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve permissions from.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Export the list of permissions in a tenant. This report includes the name, description, and ID for each permission.  Administrating tenant users can export permission lists for their tenant and its assigned analytic tenants.

        :param tenant_code: The tenant to retrieve permissions from.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_all_user_groups(
        self,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve the list of user groups from.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of users to return. Maximum is 1000.")] = None,
        ...
        :param tenant_code: The tenant to retrieve the list of user groups from.
        :type tenant_code: str
        :param limit: The maximum number of users to return. Maximum is 1000.
        :type limit: int
    ...
    def get_all_users(
        self,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve a list of users from.")] = None,
        assigned_profiles: Annotated[Optional[StrictBool], Field(description="If `true`, returns a list of the user's assigned profiles.")] = None,
        assigned_permissions: Annotated[Optional[StrictBool], Field(description="If `true`, returns the user's assigned permissions.")] = None,
        assigned_user_groups: Annotated[Optional[StrictBool], Field(description="If `true`, returns the user's assigned user groups.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of users to return. Maximum is 1000.")] = None,
        start: Annotated[Optional[StrictInt], Field(description="The starting index of the first result to return. Default is 0.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        ...
        :param tenant_code: The tenant to retrieve a list of users from.
        :type tenant_code: str
        :param assigned_profiles: If `true`, returns a list of the user's assigned profiles.
        :type assigned_profiles: bool
        :param assigned_permissions: If `true`, returns the user's assigned permissions.
        :type assigned_permissions: bool
        :param assigned_user_groups: If `true`, returns the user's assigned user groups.
    ...
    def get_application_logs_xlsx(
        ...
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve Application Logs from.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Export Application Logs for a tenant. Application Logs track user activity and help you identify potential security issues.  Application Logs are retained for 180 days.  Administrating tenant users can export logs for their tenant and its assigned analytic tenants.
        ...
        :type end_time: str
        :param tenant_code: The tenant to retrieve Application Logs from.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_data_security_report_xlsx(
        self,
        user_id: Annotated[StrictStr, Field(description="The unique identifier of the user to retrieve the Data Security Report for.")],
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve the Data Security Report from.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Export the Data Security Report for a user. This report shows which populations and properties a user can access.  Administrating tenant users can export reports for users in their tenant and its assigned analytic tenants.

        :param user_id: The unique identifier of the user to retrieve the Data Security Report for. (required)
        :type user_id: str
        :param tenant_code: The tenant to retrieve the Data Security Report from.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_permission_assigned_users(
        self,
        permission_id: Annotated[StrictStr, Field(description="The unique identifier of the permission to retrieve users for.")],
        include_user_groups: Annotated[Optional[StrictBool], Field(description="If `true`, returns a list of all users that are assigned the permission, including users that are  assigned the permission through a user group.  If `false`, returns a list of the users that are directly assigned the permission.")] = None,
        tenant_filter: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve the list of users from.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of results to return. Maximum is 100.")] = None,
        start: Annotated[Optional[StrictInt], Field(description="The starting index of the first result to return. Default is 0.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        non_versioned: Annotated[Optional[StrictBool], Field(description="If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.")] = None,
        ...
        :param permission_id: The unique identifier of the permission to retrieve users for. (required)
        :type permission_id: str
        :param include_user_groups: If `true`, returns a list of all users that are assigned the permission, including users that are  assigned the permission through a user group.  If `false`, returns a list of the users that are directly assigned the permission.
        :type include_user_groups: bool
        :param tenant_filter: The tenant to retrieve the list of users from.
        :type tenant_filter: str
        :param limit: The maximum number of results to return. Maximum is 100.
        :type limit: int
        :param start: The starting index of the first result to return. Default is 0.
        :type start: int
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def get_profile_assignments_xlsx(
        self,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve profile assignments from.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Export profiles assigned to each user and their validity periods.  Administrating tenant users can export profile assignments for their tenant and its assigned analytic tenants.

        :param tenant_code: The tenant to retrieve profile assignments from.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def get_user_detail(
        ...
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve a user from.")] = None,
        assigned_profiles: Annotated[Optional[StrictBool], Field(description="If `true`, returns a list of the user's assigned profiles.")] = None,
        assigned_permissions: Annotated[Optional[StrictBool], Field(description="If `true`, returns the user's assigned permissions.")] = None,
        assigned_user_groups: Annotated[Optional[StrictBool], Field(description="If `true`, returns the user's assigned user groups.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        ...
        :type user_id: str
        :param tenant_code: The tenant to retrieve a user from.
        :type tenant_code: str
        :param assigned_profiles: If `true`, returns a list of the user's assigned profiles.
        :type assigned_profiles: bool
        :param assigned_permissions: If `true`, returns the user's assigned permissions.
    ...
    def get_user_group_users(
        self,
        user_group_id: Annotated[StrictStr, Field(description="The unique identifier of user group.")],
        ...
        limit: Annotated[Optional[StrictInt], Field(description="The maximum number of tenants to return. The maximum number of tenants to retrieve is 100.")] = None,
        start: Annotated[Optional[StrictInt], Field(description="The starting index of the first result to return. Default is 0.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        non_versioned: Annotated[Optional[StrictBool], Field(description="If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.")] = None,
        ...
        :param user_group_id: The unique identifier of user group. (required)
        :type user_group_id: str
        :param tenant_filter: Specifies the tenant to retrieve the list of users from.
        :type tenant_filter: str
        :param limit: The maximum number of tenants to return. The maximum number of tenants to retrieve is 100.
        :type limit: int
        :param start: The starting index of the first result to return. Default is 0.
        :type start: int
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def get_user_permissions_xlsx(
        self,
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to retrieve the permission assignments report from.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        Export user permission assignments for a tenant. This report summarizes assigned permissions, their usage across users, and users without assigned permissions.  Administrating tenant users can export permission assignments for their tenant and its assigned analytic tenants.

        :param tenant_code: The tenant to retrieve the permission assignments report from.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    @validate_call
    def get_vee_logs_xlsx(
        self,
        start_time: Annotated[StrictStr, Field(description="An inclusive date-time to start retrieving Vee Logs from in milliseconds since the Unix epoch.")],
        end_time: Annotated[StrictStr, Field(description="An exclusive date-time to stop retrieving Vee Logs from in milliseconds since the Unix epoch.")],
        tenant_code: Annotated[Optional[StrictStr], Field(description="Specify the tenant to retrieve Vee Logs from.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        This API allows you to download the Vee Logs for a tenant. The Vee Logs track  information about Vee queries executed by your users, including query content, execution status,  processing time, and user feedback. Performing regular audits will help you understand how users  are interacting with Vee and identify potential issues.   Administrating tenant users can export Vee Logs for the administrating tenant and the  analytic tenants those users belong to.

        :param start_time: An inclusive date-time to start retrieving Vee Logs from in milliseconds since the Unix epoch. (required)
        :type start_time: str
        :param end_time: An exclusive date-time to stop retrieving Vee Logs from in milliseconds since the Unix epoch. (required)
        :type end_time: str
        :param tenant_code: Specify the tenant to retrieve Vee Logs from.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
        ...
        _param = self._get_vee_logs_xlsx_serialize(
            start_time=start_time,
            end_time=end_time,
            tenant_code=tenant_code,
            target_tenant_id=target_tenant_id,
    ...
    @validate_call
    def get_vee_logs_xlsx_with_http_info(
        self,
        start_time: Annotated[StrictStr, Field(description="An inclusive date-time to start retrieving Vee Logs from in milliseconds since the Unix epoch.")],
        end_time: Annotated[StrictStr, Field(description="An exclusive date-time to stop retrieving Vee Logs from in milliseconds since the Unix epoch.")],
        tenant_code: Annotated[Optional[StrictStr], Field(description="Specify the tenant to retrieve Vee Logs from.")] = None,
    ...
    @validate_call
    def get_vee_logs_xlsx_without_preload_content(
        self,
        start_time: Annotated[StrictStr, Field(description="An inclusive date-time to start retrieving Vee Logs from in milliseconds since the Unix epoch.")],
        end_time: Annotated[StrictStr, Field(description="An exclusive date-time to stop retrieving Vee Logs from in milliseconds since the Unix epoch.")],
        tenant_code: Annotated[Optional[StrictStr], Field(description="Specify the tenant to retrieve Vee Logs from.")] = None,
    ...
    def _get_vee_logs_xlsx_serialize(
        self,
        start_time,
        end_time,
        tenant_code,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/admin/users/reports/vee-logs',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def remove_users_from_user_group(
        ...
        Remove users from specific user groups.  Administrating tenants can remove users to user groups in multiple analytic tenants by providing a tenant code and project ID in the request body.   We recommend that administrating tenants set the analytic tenant in which to execute the API call using the `TargetTenantID` request header.
    ...
    def update_user(
        ...
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant to update a user in.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param tenant_code: The tenant to update a user in.
        :type tenant_code: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
