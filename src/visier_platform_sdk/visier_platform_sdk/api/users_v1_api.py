...
class UsersV1Api:
    ...
    def assign_permissions(
        ...
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        non_versioned: Annotated[Optional[StrictBool], Field(description="If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.<br>**Note:** <em>This header is in **limited availability**. If you are interested in using it, please contact your Customer Success Manager (CSM).</em>")] = None,
        session_based_permissions: Annotated[Optional[StrictBool], Field(description="Optionally, If `true`, the API call executes on session based and create/update actions take effect without a new production version, it doesn't work with NonVersioned=true header. If `false`, it's not a session based api call. Default is `false`.<br>**Note:** <em>This header is in **limited availability**. If you are interested in using it, please contact your Customer Success Manager (CSM).</em>")] = None,
        session_repo_id: Annotated[Optional[StrictStr], Field(description="Optionally, work with SessionBasedPermissions only. If specified, the API call overwrite the existing permissions assigned to the SessionRepoId, otherwise it created a new one.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param non_versioned: If `true`, the API call executes on non-versioned artifacts and create/update actions take effect without a new production version. If `false`, the API call executes on versioned artifacts and create/update actions release a new production version. Default is `false`.<br>**Note:** <em>This header is in **limited availability**. If you are interested in using it, please contact your Customer Success Manager (CSM).</em>
        :type non_versioned: bool
        :param session_based_permissions: Optionally, If `true`, the API call executes on session based and create/update actions take effect without a new production version, it doesn't work with NonVersioned=true header. If `false`, it's not a session based api call. Default is `false`.<br>**Note:** <em>This header is in **limited availability**. If you are interested in using it, please contact your Customer Success Manager (CSM).</em>
        :type session_based_permissions: bool
        :param session_repo_id: Optionally, work with SessionBasedPermissions only. If specified, the API call overwrite the existing permissions assigned to the SessionRepoId, otherwise it created a new one.
