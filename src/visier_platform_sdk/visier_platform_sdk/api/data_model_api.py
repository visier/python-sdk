...
class DataModelApi:
    ...
    def analytic_metrics(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve metrics for.")],
        ...
        :param id: The unique identifier of the analytic object to retrieve metrics for. (required)
        :type id: str
    ...
    def analytic_object(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The unique identifier of the analytic object to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def analytic_objects(
        self,
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the analytic objects to retrieve. Default is all analytic objects.")] = None,
        ...
        :param id: The unique identifiers of the analytic objects to retrieve. Default is all analytic objects.
        :type id: List[str]
    ...
    def call_property(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve.")],
        id: Annotated[List[StrictStr], Field(description="The unique identifier of the property to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param object_id: The unique identifier of the analytic object to retrieve. (required)
        :type object_id: str
        :param id: The unique identifier of the property to retrieve. (required)
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def _create_vee_sample_question_categories_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/data/model/vee/sample-question-categories',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _create_vee_sample_questions_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/data/model/vee/sample-questions',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def currency(
        self,
        id: Annotated[StrictStr, Field(description="The currency code in ISO 4217 format.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The currency code in ISO 4217 format. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def currency_rates(
        self,
        id: Annotated[StrictStr, Field(description="The currency to get rates for in ISO 4217 format.")],
        start_time: Annotated[Optional[StrictStr], Field(description="The earliest time instant to retrieve exchange rates from. Default is 0 milliseconds.")] = None,
        end_time: Annotated[Optional[StrictStr], Field(description="The latest time instant to retrieve exchange rates from. Default is the time of this request in milliseconds.")] = None,
        decimals: Annotated[Optional[StrictStr], Field(description="The number of decimals to round exchange rates to. Default is 2 decimal places.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The currency to get rates for in ISO 4217 format. (required)
        :type id: str
        :param start_time: The earliest time instant to retrieve exchange rates from. Default is 0 milliseconds.
        :type start_time: str
        :param end_time: The latest time instant to retrieve exchange rates from. Default is the time of this request in milliseconds.
        :type end_time: str
        :param decimals: The number of decimals to round exchange rates to. Default is 2 decimal places.
        :type decimals: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def currency_rates_with_to_currency(
        self,
        id: Annotated[StrictStr, Field(description="The currency to convert from in ISO 4217 format.")],
        to_id: Annotated[StrictStr, Field(description="The currency to convert to in ISO 4217 format.")],
        start_time: Annotated[Optional[StrictStr], Field(description="The earliest time instant to retrieve exchange rates from. Default is 0 milliseconds.")] = None,
        end_time: Annotated[Optional[StrictStr], Field(description="The latest time instant to retrieve exchange rates from. Default is the time of this request in milliseconds.")] = None,
        decimals: Annotated[Optional[StrictStr], Field(description="The number of decimals to round exchange rates to. Default is 2 decimal places.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        ...
        :param id: The currency to convert from in ISO 4217 format. (required)
        :type id: str
        :param to_id: The currency to convert to in ISO 4217 format. (required)
        :type to_id: str
        :param start_time: The earliest time instant to retrieve exchange rates from. Default is 0 milliseconds.
        :type start_time: str
        :param end_time: The latest time instant to retrieve exchange rates from. Default is the time of this request in milliseconds.
    ...
    def dimension(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve.")],
        id: Annotated[StrictStr, Field(description="The unique identifier of the dimension to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param object_id: The unique identifier of the analytic object to retrieve. (required)
        :type object_id: str
        :param id: The unique identifier of the dimension to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def dimension_member_map_validation(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object.")],
        dimension_id: Annotated[StrictStr, Field(description="The unique identifier of a dimension of the member map.")],
        ...
        :param object_id: The unique identifier of the analytic object. (required)
        :type object_id: str
        :param dimension_id: The unique identifier of a dimension of the member map. (required)
    ...
    def dimensions(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve.")],
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the dimensions to retrieve. Default is all dimensions.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param object_id: The unique identifier of the analytic object to retrieve. (required)
        :type object_id: str
        :param id: The unique identifiers of the dimensions to retrieve. Default is all dimensions.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def get_vee_sample_question(
        self,
        question_id: Annotated[StrictStr, Field(description="The unique identifier of the Vee sample question to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param question_id: The unique identifier of the Vee sample question to retrieve. (required)
    ...
    def _get_vee_sample_question_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/data/model/vee/sample-questions/{questionId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_vee_sample_question_category(
        self,
        question_category_id: Annotated[StrictStr, Field(description="The unique identifier of the Vee sample question category to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :param question_category_id: The unique identifier of the Vee sample question category to retrieve. (required)
    ...
    def _get_vee_sample_question_category_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/data/model/vee/sample-question-categories/{questionCategoryId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def member(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object.")],
        dimension_id: Annotated[StrictStr, Field(description="The unique identifier of the dimension.")],
        id: StrictStr,
        id2: Annotated[Optional[StrictStr], Field(description="The unique identifier of the member to retrieve.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param object_id: The unique identifier of the analytic object. (required)
        :type object_id: str
        :param dimension_id: The unique identifier of the dimension. (required)
        :type dimension_id: str
        :param id: (required)
        :type id: str
        :param id2: The unique identifier of the member to retrieve.
        :type id2: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def members(
        ...
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object.")],
        dimension_id: Annotated[StrictStr, Field(description="The unique identifier of the dimension.")],
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the members to retrieve. Default is all members.")] = None,
        max_level: Annotated[Optional[StrictInt], Field(description="The maximum level in the hierarchy to retrieve. The top level of the hierarchy is 0. Default is all levels.")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="A regular expression that members must match to be retrieved. Default is all members.")] = None,
        var_field: Annotated[Optional[StrictStr], Field(description="Indicates the aspect of the member to apply the filter to. Default is `id`. Valid values:  - `id`: Match the filter to the member ID.  - `display`: Match the filter to the member's display name.  - `either`: Match the filter to the member ID or display name.")] = None,
        include_data_members: Annotated[Optional[StrictBool], Field(description="If `true`, data members are included in the response. Parent-child dimensions only. Default is `false`.")] = None,
        offset: Annotated[Optional[StrictInt], Field(description="For paginated member requests against high-cardinality dimensions, the offset of the first member to retrieve. Default is 0. If `offset` is a non-default value, all other non-pagination parameters are ignored.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="For paginated member requests against high-cardinality dimensions, the maximum number of members to retrieve. Default is -1 to return up to 15,000 members. If `limit` is a non-default value, all other non-pagination parameters are ignored. If pagination occurs, the response status code is 206.")] = None,
        sort_type: Annotated[Optional[StrictStr], Field(description="The order of the members in the response. Default is `natural`. Valid values:  - `configured`: Sorts members according to their configuration. For parent-child dimensions, sorts members by name in ascending order. For other dimensions, sorts members by their configured order in Studio.  - `natural`: Doesn't sort the members.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        Retrieve dimension members for an analytic object. Dimension members exist in fixed or non-uniform hierarchies. Leveled dimensions have fixed hierarchies, while parent-child dimensions have non-uniform levels. Returns the dimension level and path. Example for Vancouver in a Location dimension:   - All > Canada > British Columbia > Vancouver   Parent-child hierarchies are non-uniform and include dynamic traits, such as time dependence and data attributes. The response includes elements expressing validity ranges for retrieved members.

        :param object_id: The unique identifier of the analytic object. (required)
        :type object_id: str
        :param dimension_id: The unique identifier of the dimension. (required)
        :type dimension_id: str
        :param id: The unique identifiers of the members to retrieve. Default is all members.
        :type id: List[str]
        :param max_level: The maximum level in the hierarchy to retrieve. The top level of the hierarchy is 0. Default is all levels.
        :type max_level: int
        :param filter: A regular expression that members must match to be retrieved. Default is all members.
        :type filter: str
        :param var_field: Indicates the aspect of the member to apply the filter to. Default is `id`. Valid values:  - `id`: Match the filter to the member ID.  - `display`: Match the filter to the member's display name.  - `either`: Match the filter to the member ID or display name.
        :type var_field: str
        :param include_data_members: If `true`, data members are included in the response. Parent-child dimensions only. Default is `false`.
        :type include_data_members: bool
        :param offset: For paginated member requests against high-cardinality dimensions, the offset of the first member to retrieve. Default is 0. If `offset` is a non-default value, all other non-pagination parameters are ignored.
        :type offset: int
        :param limit: For paginated member requests against high-cardinality dimensions, the maximum number of members to retrieve. Default is -1 to return up to 15,000 members. If `limit` is a non-default value, all other non-pagination parameters are ignored. If pagination occurs, the response status code is 206.
        :type limit: int
        :param sort_type: The order of the members in the response. Default is `natural`. Valid values:  - `configured`: Sorts members according to their configuration. For parent-child dimensions, sorts members by name in ascending order. For other dimensions, sorts members by their configured order in Studio.  - `natural`: Doesn't sort the members.
        :type sort_type: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def metric(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the metric to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The unique identifier of the metric to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def metric_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DataModelMetricDTO]:
        """Retrieve a metric
    ...
    def metric_dimensions(
        self,
        metric_id: Annotated[StrictStr, Field(description="The unique identifier of the metric to retrieve.")],
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the dimensions to retrieve. Default is all dimensions.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
        ...
        :param metric_id: The unique identifier of the metric to retrieve. (required)
        :type metric_id: str
        :param id: The unique identifiers of the dimensions to retrieve. Default is all dimensions.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
    ...
    def metric_selection_concepts(
        self,
        metric_id: Annotated[StrictStr, Field(description="The unique identifier of the metric to retrieve.")],
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the selection concepts to retrieve. Default is all selection concepts.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param metric_id: The unique identifier of the metric to retrieve. (required)
        :type metric_id: str
        :param id: The unique identifiers of the selection concepts to retrieve. Default is all selection concepts.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def metrics(
        self,
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the metrics to retrieve. Default is all metrics.")] = None,
        ...
        :param id: The unique identifiers of the metrics to retrieve. Default is all metrics.
        :type id: List[str]
    ...
    def plan_data_loadl_list(
        ...
        plan_status: Annotated[Optional[StrictStr], Field(description="Returns plans with the specified plan status. Any other value returns an error. Valid values:  - `ASSIGNED`: The plan was created but work on it has not started. A primary plan always has this status.  - `IN_PROGRESS`: The subplanner has opened the subplan.  - `AWAITS_USER_ACTION`: The subplan is open but is blocked and cannot be worked on until its subplanner resolves what is blocking it. One case is a subplan whose promoted rows must be reconciled after its primary plan was rebaselined. Other blocking conditions may use this status in future, so don't assume a specific cause.  - `SUBMITTED`: The subplan has been submitted for review.  - `SENT_BACK`: The subplan was rejected and returned to the subplanner for editing.  - `CONSOLIDATED`: The subplan is closed. This includes subplans combined into the primary plan, and subplans closed when the collaboration ended without ever being combined.")] = None,
        created_start: Annotated[Optional[StrictStr], Field(description="Returns plans created on or after this date in YYYY-MM-DD format.")] = None,
        created_end: Annotated[Optional[StrictStr], Field(description="Return plans created on or before this date in YYYY-MM-DD format.")] = None,
        edited_start: Annotated[Optional[StrictStr], Field(description="Returns plans edited on or after this date in YYYY-MM-DD format.")] = None,
        edited_end: Annotated[Optional[StrictStr], Field(description="Returns plans edited on or before this date in YYYY-MM-DD format.")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Orders plan results by the specified value. Default is `LAST_EDITED_DATE`. Valid values:  - `LAST_EDITED_DATE`: Orders plans by the last edited date.  - `CREATED_DATE`: Orders plans by the creation date.  - `PLAN_MODEL`: Orders plans alphabetically by planning model.")] = None,
        sort_order: Annotated[Optional[StrictStr], Field(description="Sorts plan results by the specified value. Default is `DESCENDING`. Valid values: `ASCENDING` or `DESCENDING`.")] = None,
        ...
        page: Annotated[Optional[StrictStr], Field(description="Sets the results page to return. If unspecified, returns the first 50 results. To get the next 50 results, specify `page=2`.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type model: str
        :param plan_status: Returns plans with the specified plan status. Any other value returns an error. Valid values:  - `ASSIGNED`: The plan was created but work on it has not started. A primary plan always has this status.  - `IN_PROGRESS`: The subplanner has opened the subplan.  - `AWAITS_USER_ACTION`: The subplan is open but is blocked and cannot be worked on until its subplanner resolves what is blocking it. One case is a subplan whose promoted rows must be reconciled after its primary plan was rebaselined. Other blocking conditions may use this status in future, so don't assume a specific cause.  - `SUBMITTED`: The subplan has been submitted for review.  - `SENT_BACK`: The subplan was rejected and returned to the subplanner for editing.  - `CONSOLIDATED`: The subplan is closed. This includes subplans combined into the primary plan, and subplans closed when the collaboration ended without ever being combined.
        :type plan_status: str
        :param created_start: Returns plans created on or after this date in YYYY-MM-DD format.
        :type created_start: str
        :param created_end: Return plans created on or before this date in YYYY-MM-DD format.
        :type created_end: str
        :param edited_start: Returns plans edited on or after this date in YYYY-MM-DD format.
        :type edited_start: str
        :param edited_end: Returns plans edited on or before this date in YYYY-MM-DD format.
        :type edited_end: str
        :param order_by: Orders plan results by the specified value. Default is `LAST_EDITED_DATE`. Valid values:  - `LAST_EDITED_DATE`: Orders plans by the last edited date.  - `CREATED_DATE`: Orders plans by the creation date.  - `PLAN_MODEL`: Orders plans alphabetically by planning model.
        :type order_by: str
        :param sort_order: Sorts plan results by the specified value. Default is `DESCENDING`. Valid values: `ASCENDING` or `DESCENDING`.
        :type sort_order: str
        ...
        :param page: Sets the results page to return. If unspecified, returns the first 50 results. To get the next 50 results, specify `page=2`.
        :type page: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param _request_timeout: timeout setting for this request. If one
    ...
    def _plan_data_loadl_list_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/planning/model/plans',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def plan_info_with_schema(
        ...
        with_schema: Annotated[Optional[StrictBool], Field(description="If `true`, returns the plan's schema. Default is `false`.")] = None,
        segment_id_filter: Annotated[Optional[StrictStr], Field(description="If specified, returns segment levels and members for the specified segment.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
        ...
        :type id: str
        :param with_schema: If `true`, returns the plan's schema. Default is `false`.
        :type with_schema: bool
        :param segment_id_filter: If specified, returns segment levels and members for the specified segment.
    ...
    def _plan_info_with_schema_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/planning/model/plans/{id}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def planning_metrics(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the planning model to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The unique identifier of the planning model to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def planning_models(
        self,
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the planning models to retrieve. Default is all models.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The unique identifiers of the planning models to retrieve. Default is all models.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def planning_plan(
        self,
        model_id: Annotated[StrictStr, Field(description="The unique identifier of the planning model to retrieve.")],
        id: Annotated[StrictStr, Field(description="The unique identifier of the plan to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param model_id: The unique identifier of the planning model to retrieve. (required)
        :type model_id: str
        :param id: The unique identifier of the plan to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def planning_plans(
        self,
        model_id: Annotated[StrictStr, Field(description="The unique identifier of the planning model to retrieve.")],
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the plans to retrieve. Default is all plans.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param model_id: The unique identifier of the planning model to retrieve. (required)
        :type model_id: str
        :param id: The unique identifiers of the plans to retrieve. Default is all plans.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def prediction(
        self,
        id: Annotated[StrictStr, Field(description="The unique identifier of the prediction to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The unique identifier of the prediction to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def predictions(
        self,
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the predictions to retrieve. Default is all predictions.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param id: The unique identifiers of the predictions to retrieve. Default is all predictions.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def properties(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve.")],
        id: Annotated[Optional[List[StrictStr]], Field(description="The unique identifiers of the properties to retrieve. Default is all properties.")] = None,
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param object_id: The unique identifier of the analytic object to retrieve. (required)
        :type object_id: str
        :param id: The unique identifiers of the properties to retrieve. Default is all properties.
        :type id: List[str]
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
    ...
    def put_properties(
        ...
        Replace existing property definitions. Update up to 10 properties per tenant across up to 500 tenants per request.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed from the property.
    ...
    def put_vee_sample_question_categories(
        ...
        Replace existing Vee sample question category definitions, such as the display name or icon.    `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed from the question category.
    ...
    def put_vee_sample_questions(
        ...
        Replace existing sample question definitions.    `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted fields are removed from the sample question.
    ...
    def selection_concept(
        self,
        object_id: Annotated[StrictStr, Field(description="The unique identifier of the analytic object to retrieve.")],
        id: Annotated[StrictStr, Field(description="The unique identifier of the selection concept to retrieve.")],
        target_tenant_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.")] = None,
        project_id: Annotated[Optional[StrictStr], Field(description="Optionally, specify a project in which to make the request. If omitted, the request uses the production version.")] = None,
        _request_timeout: Union[
            None,
        ...
        :param object_id: The unique identifier of the analytic object to retrieve. (required)
        :type object_id: str
        :param id: The unique identifier of the selection concept to retrieve. (required)
        :type id: str
        :param target_tenant_id: Optionally, specify the tenant that you want to execute the API call on. This defines the tenant that you're logged into. If omitted, the request uses the administrating tenant as the login tenant.
        :type target_tenant_id: str
        :param project_id: Optionally, specify a project in which to make the request. If omitted, the request uses the production version.
