...
class DataModelApi:
    ...
    def create_vee_sample_question_categories(
        ...
        Create new sample question categories for Vee sample questions. Administrating tenants can specify the tenant in which to add sample question categories using the `TargetTenantID` header.
    ...
    def create_vee_sample_questions(
        ...
        Create new sample questions that your users can ask Vee. Administrating tenants can specify the tenant in which to add sample questions using the `TargetTenantID` header.
    ...
    def delete_vee_sample_question_categories(
        ...
        Delete existing Vee sample question categories. Administrating tenants can specify the tenant in which to delete categories using the `TargetTenantID` header.
    ...
    def get_vee_sample_question(
        ...
        Get the details of a specific Vee sample question where the ID is the `questionID` returned by `GET /v1/data/model/vee/sample-questions`.
    ...
    def get_vee_sample_question_category(
        ...
        Get the details of a specific Vee sample question category where the ID is the `categoryID` returned by `GET /v1/data/model/vee/sample-question-categories`.
    ...
    def plan_info_with_schema(
        ...
        Retrieve the details of a specific plan. The response returns plan information you can use to call the Plan Data Load API.
