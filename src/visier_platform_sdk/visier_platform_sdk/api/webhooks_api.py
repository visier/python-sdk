...
class WebhooksApi:
    ...
    def update_webhook(
        ...
        Update an existing webhook. You must know the ID of the webhook to update it. To retrieve webhook IDs, see `GET /v1/op/webhooks`. To update a webhook's credentials, see `PUT /v1/op/webhooks/{webhookId}/credentials`.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted values are removed from the webhook.
    ...
    def update_webhook_credentials(
        ...
        Update a webhook's credentials. You must know the ID of the webhook to update it. To retrieve webhook IDs, see `GET /v1/op/webhooks`. To update webhook details, see `PUT /v1/op/webhooks/{webhookId}`.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted values are removed from the webhook.
