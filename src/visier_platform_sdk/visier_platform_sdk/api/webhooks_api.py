...
from visier_platform_sdk.models.webhook_statuses_dto import WebhookStatusesDTO
...
class WebhooksApi:
    ...
    def _delete_webhook_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/op/webhooks/{webhookId}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def delete_webhook_credentials(
        ...
        Delete the credentials for a webhook. You must know the ID of the webhook to delete its credentials. To retrieve webhook IDs, see `GET /v1/op/webhooks`.
    ...
    def _delete_webhook_credentials_serialize(
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/v1/op/webhooks/{webhookId}/credentials',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def get_all_webhooks(
        self,
        event: Annotated[Optional[StrictStr], Field(description="Retrieve all webhooks listening for the specified event type. Default is to retrieve all webhooks.   The possible event types to listen for. Valid values:  - `jobResultSuccess`: A job completed successfully.  - `jobResultFailure`: A job failed to complete.  - `jobReschedule`: A job was rescheduled.  - `dvPublish`: A data version published to production.  - `alertNotification`: A personalized alert notification was triggered.  - `smartCompNotification`: A Smart Compensation event notification was triggered. This is available for Embedded Partners.  - `dataUploadNotification`: A data file was uploaded.  - `systemAlertNotification`: A system event alert notification was triggered.  - `planRowPromotionNotification`: A row in a plan was promoted.  - `auditEvent`: An audit event was triggered.")] = None,
        ...
        :param event: Retrieve all webhooks listening for the specified event type. Default is to retrieve all webhooks.   The possible event types to listen for. Valid values:  - `jobResultSuccess`: A job completed successfully.  - `jobResultFailure`: A job failed to complete.  - `jobReschedule`: A job was rescheduled.  - `dvPublish`: A data version published to production.  - `alertNotification`: A personalized alert notification was triggered.  - `smartCompNotification`: A Smart Compensation event notification was triggered. This is available for Embedded Partners.  - `dataUploadNotification`: A data file was uploaded.  - `systemAlertNotification`: A system event alert notification was triggered.  - `planRowPromotionNotification`: A row in a plan was promoted.  - `auditEvent`: An audit event was triggered.
        :type event: str
    ...
    def get_webhook(
        ...
        Retrieve the details of a specific webhook. You must know the ID of the webhook to retrieve its details. To retrieve webhook IDs, see `GET /v1/op/webhooks`.
    ...
    def get_webhooks_status(
        ...
        Retrieve the statuses of all webhooks, such as their active status and the event types they're listening for. API users can call this endpoint without any special capabilities.
        ...
        _param = self._get_webhooks_status_serialize(
            event=event,
            is_active=is_active,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_webhooks_status_with_http_info(
        self,
        event: Annotated[Optional[StrictStr], Field(description="Retrieve all webhooks listening for the specified event type. Default is to retrieve all webhooks.   The possible event types to listen for. Valid values:  - `jobResultSuccess`: A job completed successfully.  - `jobResultFailure`: A job failed to complete.  - `jobReschedule`: A job was rescheduled.  - `dvPublish`: A data version published to production.  - `alertNotification`: A personalized alert notification was triggered.  - `smartCompNotification`: A Smart Compensation event notification was triggered. This is available for Embedded Partners.  - `dataUploadNotification`: A data file was uploaded.  - `systemAlertNotification`: A system event alert notification was triggered.  - `planRowPromotionNotification`: A row in a plan was promoted.  - `auditEvent`: An audit event was triggered.")] = None,
        is_active: Annotated[Optional[StrictBool], Field(description="If `true`, retrieve active webhooks only. If `false`, retrieve active and inactive webhooks. Default is `false`.")] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[WebhookStatusesDTO]:
        """Retrieve webhook statuses
    ...
    @validate_call
    def get_webhooks_status_without_preload_content(
        self,
        event: Annotated[Optional[StrictStr], Field(description="Retrieve all webhooks listening for the specified event type. Default is to retrieve all webhooks.   The possible event types to listen for. Valid values:  - `jobResultSuccess`: A job completed successfully.  - `jobResultFailure`: A job failed to complete.  - `jobReschedule`: A job was rescheduled.  - `dvPublish`: A data version published to production.  - `alertNotification`: A personalized alert notification was triggered.  - `smartCompNotification`: A Smart Compensation event notification was triggered. This is available for Embedded Partners.  - `dataUploadNotification`: A data file was uploaded.  - `systemAlertNotification`: A system event alert notification was triggered.  - `planRowPromotionNotification`: A row in a plan was promoted.  - `auditEvent`: An audit event was triggered.")] = None,
        is_active: Annotated[Optional[StrictBool], Field(description="If `true`, retrieve active webhooks only. If `false`, retrieve active and inactive webhooks. Default is `false`.")] = None,
        _request_timeout: Union[
    ...
    def _get_webhooks_status_serialize(
        self,
        event,
        is_active,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1/op/webhooks-status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _send_test_event_serialize(
        ...
        return self.api_client.param_serialize(
            method='POST',
            resource_path='/v1/op/webhooks/{webhookId}/testEvent',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def update_webhook_credentials(
        ...
        Update the credentials to authenticate calls to the webhook endpoint. You must know the ID of the webhook to update it. To retrieve webhook IDs, see `GET /v1/op/webhooks`. To update a webhook's details, see `PUT /v1/op/webhooks/{webhookId}`.   When updating a webhook, the webhook definition in your API call replaces the prior definition. You must provide the entire definition in the `PUT` call. If you omit values from the update request, those values are removed from the webhook. We recommend that you retrieve a webhook's details before you update the webhook with new values.
