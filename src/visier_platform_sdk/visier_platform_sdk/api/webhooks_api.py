...
class WebhooksApi:
    ...
    def get_webhooks_status(
        ...
        Retrieve the statuses of all webhooks, such as their active status and the event types they're listening for. API users can call this endpoint without any special capabilities.   <br>**Note:** <em>This API is in **beta**. While in beta, APIs are interface-stable and implementation may change without notice. Rarely, interface changes may occur that are not backwards-compatible and require advance communication.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def _get_webhooks_status_serialize(
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v1beta/op/webhooks-status',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
