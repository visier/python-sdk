...
class DataVersionExportApi:
    ...
    def get_available_data_versions(
        ...
        Retrieve all data versions in the tenant.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_available_exports(
        ...
        Retrieve the details of all available data version exports. Exports remain available for 14 days after job completion.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_export(
        ...
        Retrieve the details of a specific data version export. Exports remain available for 14 days after completion. You must know the ID of a data version export to retrieve its details. To retrieve data version export IDs, see `GET/v1alpha/data/data-version-exports/exports`.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def get_export_job_status(
        ...
        Retrieve the status of a data version export job. Returns an `exportUuid` when completed to retrieve export details and files.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def schedule_export_job(
        ...
        Schedule a data version export job. The job schedules immediately and will begin when resources are available. The response returns a `jobUuid` to check export job status.   **Note**: Limit of 10 export jobs per tenant per day.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
