...
class ObjectConfigurationApi:
    ...
    def get_calculation_concept(
        self,
        concept_id: Annotated[StrictStr, Field(description="The unique identifier of the concept to retrieve the configuration for.")],
        ...
        :param concept_id: The unique identifier of the concept to retrieve the configuration for. (required)
        :type concept_id: str
    ...
    def map_calculation_concept(
        self,
        concept_id: Annotated[StrictStr, Field(description="The unique identifier of the concept to configure.")],
        ...
        Map dimension members to nodes in a calculation concept. Changes publish to production in a new project.   The request body acts as the source of truth for mapped members. Nodes without mapped members remove existing member mappings.

        :param concept_id: The unique identifier of the concept to configure. (required)
        :type concept_id: str
    ...
    def map_selection_concept(
        ...
        Map dimension members to a selection concept. Changes publish to production in a new project.   The request body acts as the source of truth for mapped members. Nodes without mapped members remove existing member mappings.
