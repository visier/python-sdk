...
class DataAndJobHandlingApi:
    ...
    def retrieve_data_uploads(
        ...
        tenant_code: Annotated[Optional[StrictInt], Field(description="This will be removed as of Spring 2026. Use `TargetTenantID` header instead. The tenant code of a specific analytic tenant that you want to retrieve the data uploads for.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of data uploads to retrieve across tenants. Default is 500. The maximum allowed value is 1000.")] = None,
        start: Annotated[Optional[StrictInt], Field(description="The index to start retrieving data uploads from, also known as offset. The index begins at 0.")] = None,
        number_of_data_uploads: Annotated[Optional[StrictInt], Field(description="This will be removed as of Spring 2026. Use `limit` instead. The maximum number of latest enabled data uploads to retrieve for each analytic tenant. The maximum value is 5. Default is 1.")] = None,
        ...
        Retrieve the data uploads that are connected to a source for either:  - An analytic tenant.  - A receiving job ID.
        ...
        :param tenant_code: This will be removed as of Spring 2026. Use `TargetTenantID` header instead. The tenant code of a specific analytic tenant that you want to retrieve the data uploads for.
        :type tenant_code: int
        :param limit: The limit of data uploads to retrieve across tenants. Default is 500. The maximum allowed value is 1000.
        :type limit: int
        :param start: The index to start retrieving data uploads from, also known as offset. The index begins at 0.
        :type start: int
        :param number_of_data_uploads: This will be removed as of Spring 2026. Use `limit` instead. The maximum number of latest enabled data uploads to retrieve for each analytic tenant. The maximum value is 5. Default is 1.
