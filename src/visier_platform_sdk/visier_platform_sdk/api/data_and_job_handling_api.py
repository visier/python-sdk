...
class DataAndJobHandlingApi:
    ...
    def adhoc_consolidated_analytics_job(
        ...
        Run a job for a consolidated analytics tenant. This request retrieves data for all source tenants in a consolidated analytics tenant. Optionally, set `runProcessingJob: true` in the request body to generate a data version for the consolidated analytics tenant.
