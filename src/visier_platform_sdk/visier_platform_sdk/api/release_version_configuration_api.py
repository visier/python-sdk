...
class ReleaseVersionConfigurationApi:
    ...
    def get_available_releases_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductReleasesDTO]:
        """Retrieve available product releases
    ...
    def get_release_versions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductVersionsDTO]:
        """Retrieve active product release versions
    ...
    def set_release_versions(
        self,
        product_versions_dto: ProductVersionsDTO,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        Set the product release version to activate it on selected tenants. Analytic tenants automatically inherit the release version from the administrating tenant. You cannot roll back to a previous version.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>

        :param product_versions_dto: (required)
        :type product_versions_dto: ProductVersionsDTO
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._set_release_versions_serialize(
            product_versions_dto=product_versions_dto,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
        ...
        _response_types_map: Dict[str, Optional[str]] = {
            '200': "ProductVersionsUpdateResponseDTO",
        }
        response_data = self.api_client.call_api(
            *_param,
            _request_timeout=_request_timeout
    ...
    def set_release_versions_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[ProductVersionsUpdateResponseDTO]:
        """Activate product release versions
    ...
    def _set_release_versions_serialize(
        ...
        # process the form parameters
        # process the body parameter
        if product_versions_dto is not None:
            _body_params = product_versions_dto
