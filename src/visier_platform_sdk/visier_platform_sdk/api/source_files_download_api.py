...
class SourceFilesDownloadApi:
    ...
    def download_source_file(
        self,
        identifier: Annotated[StrictStr, Field(description="The unique identifier of the source file.")],
        ...
        Download a single source file in ZIP format using its unique identifier. To retrieve file identifiers, see `GET /v1alpha/op/data/uploaded-files`.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>

        :param identifier: The unique identifier of the source file. (required)
        :type identifier: str
    ...
    def download_source_files(
        ...
        Download source files for a tenant. Download all included source files or specify sources by object name or unique identifier. Excluded source files aren't downloaded.   If `minTimestamp` and `maxTimestamp` are defined, downloads source files uploaded within the time range.   **Note:** <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
