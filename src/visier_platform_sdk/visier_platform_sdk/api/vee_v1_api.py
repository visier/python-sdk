...
class VeeV1Api:
    ...
    def vee_sample_question_categories(
        ...
        Get a list of categories for the Vee sample questions displayed in the conversation interface.
    ...
    def vee_sample_question_category(
        ...
        Get the details of a specific Vee sample question category where the ID is the `categoryID` returned by `GET /v1/vee/sample-question-categories`.
    ...
    def vee_sample_questions(
        ...
        Get a list of sample questions to help you start using Vee. The response returns a list of questions that you can ask Vee, such as \"What is the turnover rate?\".  You may occasionally encounter a sample question that can't be answered due to data availability or your data access
