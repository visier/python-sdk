...
class TenantsV2Api:
    ...
    def list_tenants(
        self,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of analytic tenants to return. Default and maximum are 400.")] = None,
        ...
        :param limit: The limit of analytic tenants to return. Default and maximum are 400.
        :type limit: int
