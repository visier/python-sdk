...
class OAuth2Api:
    ...
    def o_auth2_token(
        ...
        client_id: Annotated[Optional[StrictStr], Field(description="The unique identifier of the pre-registered client application.")] = None,
        ...
        :type grant_type: str
        :param client_id: The unique identifier of the pre-registered client application.
        :type client_id: str
    ...
    def oauth2_authorize(
        ...
        client_id: Annotated[StrictStr, Field(description="The unique identifier of the pre-registered client application.")],
        redirect_uri: Annotated[Optional[StrictStr], Field(description="The optional URI to redirect to after authorization.")] = None,
        scope: Annotated[Optional[StrictStr], Field(description="The OAuth 2.0 scope of the authorization request. Default is `read`. If the scope includes `visier:login:bypass_users`, the redirect login URL ends in `/auth/admin` instead of `/auth`. This allows single sign-on (SSO) Bypass Users to sign in through Visier instead of being redirected to the SSO login page.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param client_id: The unique identifier of the pre-registered client application. (required)
        :type client_id: str
        :param redirect_uri: The optional URI to redirect to after authorization.
        :type redirect_uri: str
        :param scope: The OAuth 2.0 scope of the authorization request. Default is `read`. If the scope includes `visier:login:bypass_users`, the redirect login URL ends in `/auth/admin` instead of `/auth`. This allows single sign-on (SSO) Bypass Users to sign in through Visier instead of being redirected to the SSO login page.
        :type scope: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
