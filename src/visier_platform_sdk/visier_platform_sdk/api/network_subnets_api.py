...
class NetworkSubnetsApi:
    ...
    def add_api_subnets(
        ...
        Add IP addresses to the allowed network subnets list that can call Visier APIs. Use Classless Inter-Domain Routing (CIDR) format: xxx.xxx.xxx.xxx/xx.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def delete_api_subnets(
        ...
        Remove IP addresses from the allowed network subnets list that can call Visier APIs. Use Classless Inter-Domain Routing (CIDR) format: xxx.xxx.xxx.xxx/xx.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted IP addresses are removed from the allowlist. Retrieve the current list before updating.   **Note**: Deleting allowed network subnets may remove your current IP address and lock you out from making API calls. Visier doesn't allow lockouts unless `confirmLockout` is `true`. Default is `false`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
    ...
    def set_api_subnets(
        ...
        Overwrite the allowed network subnets list with a new list. Use Classless Inter-Domain Routing (CIDR) format: xxx.xxx.xxx.xxx/xx.   `PUT` requests replace existing definitions. Provide the complete object definition in the request body. Omitted IP addresses are removed from the allowlist. Retrieve the current list before updating.   **Note**: Updating allowed network subnets may remove your current IP address and lock you out from making API calls. Visier doesn't allow lockouts unless `confirmLockout` is `true`. Default is `false`.   <br/>**Note**: <em>This API is in **alpha**. While in alpha, APIs may change in a breaking way without notice; functionality may be removed, and no deprecation notices will be issued.  If you are interested in using this API, please contact your Customer Success Manager (CSM).</em>
