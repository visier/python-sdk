...
class ReceivingJobStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the receiving job.", alias="jobId")
    ...
    receiving_jobs: Optional[List[ReceivingJob]] = Field(default=None, description="The receiving jobs to retrieve.", alias="receivingJobs")
