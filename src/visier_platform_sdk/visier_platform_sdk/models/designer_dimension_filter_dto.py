...
class DesignerDimensionFilterDTO(BaseModel):
    ...
    dimension_members: Optional[List[DimensionMemberDTO]] = Field(default=None, description="A list of dimension members to map to the perspective node.   If this array is empty, all dimension members will be removed for the node.", alias="dimensionMembers")
