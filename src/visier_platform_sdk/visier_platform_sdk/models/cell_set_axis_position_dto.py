...
class CellSetAxisPositionDTO(BaseModel):
    ...
    """ # noqa: E501
    path: Optional[List[StrictStr]] = Field(default=None, description="The members within a dimension path. For example,  a dimension for Location may have the paths \"Canada, BC, Vancouver\" and \"US, California, San Francisco\".")
