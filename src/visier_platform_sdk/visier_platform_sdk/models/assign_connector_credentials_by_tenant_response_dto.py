...
class AssignConnectorCredentialsByTenantResponseDTO(BaseModel):
    ...
    connectors: Optional[List[AssignConnectorWithCredentialsResponseDTO]] = Field(default=None, description="The assigned credentials and connectors.")
    status: Optional[StrictStr] = Field(default=None, description="The state of the credential assignment. Valid values: `Succeed` or `Failed`.")
