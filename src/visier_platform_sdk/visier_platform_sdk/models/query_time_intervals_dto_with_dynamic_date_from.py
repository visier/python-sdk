...
class QueryTimeIntervalsDTOWithDynamicDateFrom(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["dynamicDateFrom", "intervalPeriodType", "intervalPeriodCount", "intervalCount", "direction", "shift", "trailingPeriodType", "trailingPeriodCount"]
