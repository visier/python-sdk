...
class AssignRevokePermissionByTenantDTO(BaseModel):
    ...
    permissions: Optional[List[AssignRevokePermissionByPermissionDTO]] = Field(default=None, description="The assigned or removed permissions.")
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the project that the change was made in, if applicable.", alias="projectId")
