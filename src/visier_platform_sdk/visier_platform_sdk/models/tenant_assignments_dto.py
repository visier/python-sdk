...
class TenantAssignmentsDTO(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The state of the user group assignment. Valid values: `Succeed` or `Failed`.")
    message: Optional[StrictStr] = Field(default=None, description="A detailed description of the request outcome, if available.")
    assignments: Optional[List[UserSecurityAssignmentsDTO]] = Field(default=None, description="The user group and user assignments.")
