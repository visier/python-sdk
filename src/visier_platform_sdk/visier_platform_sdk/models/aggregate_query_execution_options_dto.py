...
class AggregateQueryExecutionOptionsDTO(BaseModel):
    """
    ...
    enable_sparse_results: Optional[StrictBool] = Field(default=None, description="If `true`, retrieve sparse cell sets. Sparse results only retrieve non-zero and non-null cells. Whether a result is truly sparse  or not is determined by the Visier server.", alias="enableSparseResults")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AggregateQueryExecutionOptionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AggregateQueryExecutionOptionsDTO from a dict"""
        if obj is None:
            return None
