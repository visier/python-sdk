...
class ExtractDataAndLoadDTO(BaseModel):
    ...
    disable_artifact_generation: Optional[StrictBool] = Field(default=None, description="If `true`, the job does not generate data load artifacts. Default is `false`.", alias="disableArtifactGeneration")
    ...
    spill_debug_info_partitions_dto: Optional[StrictStr] = Field(default=None, description="The partitioning of debugging info to be generated, if any. Valid values:  - `spillNone`: No debugging info is generated.  - `spillStagesAndRecords`: Debugging info is generated for stages and records.  - `spillAll`: Debugging info is generated for all partitions.", alias="spillDebugInfoPartitionsDTO")
    spill_debug_info_detail_level_dto: Optional[StrictStr] = Field(default=None, description="The detail level of the debugging info to be generated. Valid values:  - `fileAndLine`: Debugging info is generated for file and line.  - `mappingName`: Debugging info is generated for mapping name.", alias="spillDebugInfoDetailLevelDTO")
    ...
    last_extraction_time_offset_mode: Optional[StrictStr] = Field(default=None, description="The mode used to offset the last extraction time. Valid values: `\"WEEK\"`, `\"MONTH\"`. Default is `\"MONTH\"`.", alias="lastExtractionTimeOffsetMode")
    offset_week_option: Optional[StrictStr] = Field(default=None, description="The week options used to offset the last extraction time. Valid values: `\"CURRENT_DAY_OF_WEEK\"`, `\"FIRST_OF_WEEK\"`, `\"LAST_OF_WEEK\"`. Default is `\"CURRENT_DAY_OF_WEEK\"`.", alias="offsetWeekOption")
    offset_month_option: Optional[StrictStr] = Field(default=None, description="The month options used to offset the last extraction time. Valid values: `\"CURRENT_DAY_OF_MONTH\"`, `\"FIRST_OF_MONTH\"`, `\"LAST_OF_MONTH\"`. Default is `\"CURRENT_DAY_OF_MONTH\"`.", alias="offsetMonthOption")
    ...
    output_target: Optional[StrictStr] = Field(default=None, description="The output of the extraction. Default is `Receiving`. Valid values:  - `Receiving`: A receiving job.  - `SQL`: A SQL job for table sources.", alias="outputTarget")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputTarget": obj.get("outputTarget")
        })
        return _obj
