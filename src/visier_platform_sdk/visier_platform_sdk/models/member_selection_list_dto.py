...
class MemberSelectionListDTO(BaseModel):
    """
    The population members that the concept selects.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["memberSelections"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MemberSelectionListDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MemberSelectionListDTO from a dict"""
        if obj is None:
            return None
