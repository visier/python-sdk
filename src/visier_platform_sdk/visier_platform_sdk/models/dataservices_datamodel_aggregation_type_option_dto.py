...
class DataservicesDatamodelAggregationTypeOptionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "propertyName", "aggregationFunction", "isDefault"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelAggregationTypeOptionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelAggregationTypeOptionDTO from a dict"""
        if obj is None:
            return None
