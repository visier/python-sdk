...
class OtherMetricDTO(BaseModel):
    """
    Compare the metric against a different metric; for example, a Visier Benchmarks metric.
    """ # noqa: E501
    metric: Optional[MetricDTO] = Field(default=None, description="The metric to compare the alert metric against.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of OtherMetricDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of OtherMetricDTO from a dict"""
        if obj is None:
            return None
