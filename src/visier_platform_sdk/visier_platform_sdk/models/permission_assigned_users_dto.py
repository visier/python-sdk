...
class PermissionAssignedUsersDTO(BaseModel):
    ...
    """ # noqa: E501
    tenants: Optional[List[PermissionAssignedByTenantDTO]] = Field(default=None, description="The users assigned the specific permission, organized by the tenants the users belong to.")
    limit: Optional[StrictInt] = Field(default=None, description="The maximum number of results to return. Default is 100.")
