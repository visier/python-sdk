...
class SqlLike200Response(BaseModel):
    ...
    def __init__(self, *args, **kwargs) -> None:
        if args:
            ...
            # attempt to construct TableResponseDTO using arguments provided
            try:
                actual_instance = TableResponseDTO(**kwargs)
                match += 1
            except (ValidationError, ValueError) as e:
                error_messages.append(str(e))
            # attempt to construct CellSetDTO using arguments provided
            try:
                actual_instance = CellSetDTO(**kwargs)
                match += 1
            except (ValidationError, ValueError) as e:
                error_messages.append(str(e))
            ...
            if match > 1:
                # more than 1 match
                raise ValueError("Multiple matches found when constructing actual instance of SqlLike200Response with oneOf schemas: CellSetDTO, TableResponseDTO. Details: " + ", ".join(error_messages))
            elif match == 0:
                # no match
                raise ValueError("No match found when constructing actual instance of SqlLike200Response with oneOf schemas: CellSetDTO, TableResponseDTO. Details: " + ", ".join(error_messages))
            else:
    ...
    def from_json(cls, json_str: str) -> Self:
        ...
        try:
            instance.actual_instance = TableResponseDTO.from_json(json_str)
            match += 1
        except (ValidationError, ValueError) as e:
            error_messages.append(str(e))
