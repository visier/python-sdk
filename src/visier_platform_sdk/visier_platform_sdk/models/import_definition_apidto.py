...
class ImportDefinitionAPIDTO(BaseModel):
    ...
    credential_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the connector credentials currently assigned to this data connector.", alias="credentialId")
