...
class ObjectReferenceDTO(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the object reference.")
    ...
    from_object: Optional[StrictStr] = Field(default=None, description="The unique identifier of the referencing analytic object.", alias="fromObject")
    to_object: Optional[StrictStr] = Field(default=None, description="The unique identifier of the referenced analytic object.", alias="toObject")
