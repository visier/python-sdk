...
class FixedTimeTypeDTO(BaseModel):
    """
    ...
    end: Optional[StrictStr] = Field(default=None, description="The end time of the fixed time period.")
    period_count: Optional[StrictInt] = Field(default=None, description="The number of time periods per interval.", alias="periodCount")
    __properties: ClassVar[List[str]] = ["periodType", "end", "periodCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FixedTimeTypeDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FixedTimeTypeDTO from a dict"""
        if obj is None:
            return None
