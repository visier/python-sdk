...
class PushDataCancelResponse(BaseModel):
    """
    ...
    transfer_session_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the transfer session.", alias="transferSessionId")
    data_transfer_result_details: Optional[List[DataTransferResultDetail]] = Field(default=None, description="The results of the transfer session.", alias="dataTransferResultDetails")
