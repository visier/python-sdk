...
class VeeQuestionChangeFailureDTO(BaseModel):
    ...
    user_group_assignment: Optional[UserGroupAssignmentDTO] = Field(default=None, description="The user group IDs that were not successfully assigned to the sample question.", alias="userGroupAssignment")
