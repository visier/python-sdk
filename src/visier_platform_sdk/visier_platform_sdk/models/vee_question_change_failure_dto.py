...
class VeeQuestionChangeFailureDTO(BaseModel):
    """
    ...
    user_group_assignment: Optional[UserGroupAssignmentDTO] = Field(default=None, description="The user group IDs that were not successfully assigned to the sample question for spotlight.", alias="userGroupAssignment")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of VeeQuestionChangeFailureDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of VeeQuestionChangeFailureDTO from a dict"""
        if obj is None:
            return None
