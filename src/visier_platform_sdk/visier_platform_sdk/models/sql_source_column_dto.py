...
class SqlSourceColumnDTO(BaseModel):
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['UNSPECIFIED', 'STRING', 'TENANT_ID', 'INTEGER', 'LONG', 'DOUBLE', 'DECIMAL', 'BOOLEAN', 'DATE_TIME', 'DATE', 'JSON', 'BINARY']):
            raise ValueError("must be one of enum values ('UNSPECIFIED', 'STRING', 'TENANT_ID', 'INTEGER', 'LONG', 'DOUBLE', 'DECIMAL', 'BOOLEAN', 'DATE_TIME', 'DATE', 'JSON', 'BINARY')")
        return value
