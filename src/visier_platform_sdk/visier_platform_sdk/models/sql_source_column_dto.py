...
class SqlSourceColumnDTO(BaseModel):
    ...
    data_type: Optional[StrictStr] = Field(default=None, description="The SQL type of data stored in the column.  * `UNSPECIFIED`: The data type is unspecified.  * `STRING`: The data type is a string.  * `TENANT_ID`: The data type is a tenant code with the administrating tenant code prefix. Example: If the full tenant code is `WFF_j1r~c7o`, the tenant ID is `WFF_j1r~c7o`. If `CUSTOMER_ID` is specified, do not specify `TENANT_ID`.  * `CUSTOMER_ID`: The data type is an analytic tenant code without the administrating tenant code prefix. Use customer ID to filter inherited data by tenant. Example: If the full tenant code is `WFF_j1r~c7o`, the customer ID is `c7o`. If `TENANT_ID` is specified, do not specify `CUSTOMER_ID`.  * `INTEGER`: The data type is an integer.  * `LONG`: The data type is a long value.  * `DOUBLE`: The data type is a double.  * `DECIMAL`: The data type is a decimal.  * `BOOLEAN`: The data type is a Boolean value.  * `DATE_TIME`: The data type is a date and time value.   * `DATE`: The data type is date.  * `JSON`: The data type is in JSON format.  * `BINARY`: The data type is a binary blob.", alias="dataType")
    ...
    def data_type_validate_enum(cls, value):
        ...
        if value not in set(['UNSPECIFIED', 'STRING', 'TENANT_ID', 'CUSTOMER_ID', 'INTEGER', 'LONG', 'DOUBLE', 'DECIMAL', 'BOOLEAN', 'DATE_TIME', 'DATE', 'JSON', 'BINARY']):
            raise ValueError("must be one of enum values ('UNSPECIFIED', 'STRING', 'TENANT_ID', 'CUSTOMER_ID', 'INTEGER', 'LONG', 'DOUBLE', 'DECIMAL', 'BOOLEAN', 'DATE_TIME', 'DATE', 'JSON', 'BINARY')")
        return value
