...
class VeeOptionsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["includeVisual", "visualOptions", "includeData", "dataFormat", "includeRewordedQuestion", "includeDetailData", "includeRelatedAnalyses", "includeRelatedReports"]
