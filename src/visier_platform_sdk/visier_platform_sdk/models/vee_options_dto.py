...
class VeeOptionsDTO(BaseModel):
    ...
    include_detail_data: Optional[StrictBool] = Field(default=None, description="If `true`, returns detail data relevant to the question. Default is `false`.", alias="includeDetailData")
    include_related_analyses: Optional[StrictBool] = Field(default=None, description="If `true`, returns related analyses. Default is `false`.", alias="includeRelatedAnalyses")
    include_related_reports: Optional[StrictBool] = Field(default=None, description="If `true`, returns related reports. Default is `false`. Reports are available for Embedded Partners.", alias="includeRelatedReports")
    include_suggestions: Optional[StrictBool] = Field(default=None, description="If `true`, returns suggested follow-up questions. Default is `false`.", alias="includeSuggestions")
    __properties: ClassVar[List[str]] = ["includeVisual", "visualOptions", "includeData", "dataFormat", "includeRewordedQuestion", "includeDetailData", "includeRelatedAnalyses", "includeRelatedReports", "includeSuggestions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "includeDetailData": obj.get("includeDetailData"),
            "includeRelatedAnalyses": obj.get("includeRelatedAnalyses"),
            "includeRelatedReports": obj.get("includeRelatedReports"),
            "includeSuggestions": obj.get("includeSuggestions")
        })
        return _obj
