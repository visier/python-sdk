...
class GroupedMetricValueThresholdCriteriaDTO(BaseModel):
    ...
    relative_time_period: Optional[RelativeTimePeriodDTO] = Field(default=None, description="The time period in which to evaluate the alert. If unspecified, the default is the latest partial month.", alias="relativeTimePeriod")
    ...
    calendar_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the calendar to use when evaluating the metric.", alias="calendarId")
    __properties: ClassVar[List[str]] = ["metric", "filters", "dimension", "relativeTimePeriod", "ruleSet", "calendarId"]
