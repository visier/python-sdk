...
class AllUserGroupsAssignedForLocalTenantDTO(BaseModel):
    ...
    """ # noqa: E501
    assigned_user_groups: Optional[List[UserGroupAssignedForLocalTenantDTO]] = Field(default=None, description="The available user groups.", alias="assignedUserGroups")
