...
class DataCategoryResponseDTO(BaseModel):
    ...
    object_name: Optional[StrictStr] = Field(default=None, description="The object name of the data category.", alias="objectName")
    __properties: ClassVar[List[str]] = ["name", "id", "objectName"]
