...
class BenchmarkValue(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["percentile10", "percentile25", "percentile50", "percentile75", "percentile90", "alignedRangeMin", "alignedRangeMax", "referenceDate", "releaseDate", "industryId", "careerLevelId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of BenchmarkValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of BenchmarkValue from a dict"""
        if obj is None:
            return None
