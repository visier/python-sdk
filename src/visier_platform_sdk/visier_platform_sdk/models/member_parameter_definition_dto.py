...
from visier_platform_sdk.models.data_services_member_values_dto import DataServicesMemberValuesDTO
...
class MemberParameterDefinitionDTO(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the member parameter.")
    ...
    dimension_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the dimension on which the member parameter is based.", alias="dimensionId")
    ...
    default: Optional[DataServicesMemberValuesDTO] = Field(default=None, description="The default value if the end user does not select a member at run time.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "default": DataServicesMemberValuesDTO.from_dict(obj["default"]) if obj.get("default") is not None else None
        })
        return _obj
