...
class ReceivingJobAndStatusResponse(BaseModel):
    ...
    """ # noqa: E501
    parent_job_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the dispatching job that generated the extraction jobs.", alias="parentJobId")
    ...
    limit: Optional[StrictInt] = Field(default=None, description="The number of receiving jobs to return. Maximum is 1000.")
    start: Optional[StrictInt] = Field(default=None, description="The starting index of the first result to return. Default is 0.")
    receiving_jobs: Optional[List[ReceivingJob]] = Field(default=None, description="Receiving job information.", alias="receivingJobs")
