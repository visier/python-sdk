...
class GetCapabilitiesAPIResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    capabilities: Optional[List[CapabilityDTO]] = Field(default=None, description="A list of objects representing the available capabilities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "capabilities": [CapabilityDTO.from_dict(_item) for _item in obj["capabilities"]] if obj.get("capabilities") is not None else None
        })
        return _obj
