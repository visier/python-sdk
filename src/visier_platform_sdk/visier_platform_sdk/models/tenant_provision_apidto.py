...
class TenantProvisionAPIDTO(BaseModel):
    ...
    """ # noqa: E501
    tenant_code: StrictStr = Field(description="The unique identifier of the analytic tenant.", alias="tenantCode")
