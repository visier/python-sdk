...
class TenantProvisionAPIDTO(BaseModel):
    ...
    """ # noqa: E501
    tenant_code: Annotated[str, Field(min_length=1, strict=True, max_length=50)] = Field(description="An alphanumeric string that represents the unique identifier of the analytic tenant. Example: If the full tenant code is `WFF_j1r~c7o`, specify `c7o` in this field. The maximum is 50 characters for the full tenant code, including the automatically prefixed administrating tenant code (`WFF_j1r~` in the example).", alias="tenantCode")
    tenant_display_name: Annotated[str, Field(min_length=1, strict=True)] = Field(description="The display name that is assigned to the analytic tenant.", alias="tenantDisplayName")
