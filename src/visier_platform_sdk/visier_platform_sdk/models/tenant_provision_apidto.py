...
class TenantProvisionAPIDTO(BaseModel):
    ...
    """ # noqa: E501
    tenant_code: StrictStr = Field(description="The unique identifier of the analytic tenant. The maximum is 50 characters. This limit includes the administrating tenant code. For example, WFF_a1b2c~whatisthemaxlengthofatenantcode123456789 (50 characters).", alias="tenantCode")
    tenant_display_name: StrictStr = Field(description="The display name that is assigned to the analytic tenant.", alias="tenantDisplayName")
