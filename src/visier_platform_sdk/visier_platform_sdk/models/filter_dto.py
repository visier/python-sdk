...
class FilterDTO(BaseModel):
    ...
    advanced: Optional[AdvancedFilterDTO] = Field(default=None, description="A compound filter that combines a list of filters with `AND` or `OR`.    **Note**: Advanced filters are not available until Fall 2026.")
    __properties: ClassVar[List[str]] = ["selectionConcept", "memberSet", "conceptReference", "keyGroup", "persistedCohort", "timePeriod", "numericRange", "advanced"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "advanced": AdvancedFilterDTO.from_dict(obj["advanced"]) if obj.get("advanced") is not None else None
        })
        return _obj
