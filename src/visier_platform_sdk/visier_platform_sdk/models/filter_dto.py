...
class FilterDTO(BaseModel):
    ...
    advanced_filter: Optional[AdvancedFilterDTO] = Field(default=None, description="A compound filter that combines a list of filters with `AND` or `OR`.    **Note**: Advanced filters are not available until Fall 2026.", alias="advancedFilter")
    __properties: ClassVar[List[str]] = ["selectionConcept", "memberSet", "conceptReference", "keyGroup", "persistedCohort", "timePeriod", "numericRange", "advancedFilter"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of advanced_filter
        if self.advanced_filter:
            _dict['advancedFilter'] = self.advanced_filter.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "advancedFilter": AdvancedFilterDTO.from_dict(obj["advancedFilter"]) if obj.get("advancedFilter") is not None else None
        })
        return _obj

from visier_platform_sdk.models.advanced_filter_dto import AdvancedFilterDTO
# TODO: Rewrite to not use raise_errors
FilterDTO.model_rebuild(raise_errors=False)
