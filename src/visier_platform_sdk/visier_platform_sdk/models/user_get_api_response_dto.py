...
class UserGetAPIResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    user_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the user.", alias="userId")
    ...
    profiles: Optional[AllProfileAssignedForLocalTenantDTO] = Field(default=None, description="The list of available profiles. Not returned if the user has no profiles.")
    permissions: Optional[AllPermissionsAssignedForLocalTenantDTO] = Field(default=None, description="The user's permissions.")
    user_groups: Optional[AllUserGroupsAssignedForLocalTenantDTO] = Field(default=None, description="The available user groups.", alias="userGroups")
