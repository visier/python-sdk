...
class MetricDefinitionDTO(BaseModel):
    ...
    basic_information: Optional[BasicInformationDTO] = Field(default=None, description="Fields that identify and describe the metric, such as its display name, description, and explanation.", alias="basicInformation")
    details: Optional[MetricTypeDetailsDTO] = Field(default=None, description="The metric type and its details.")
    ...
    visible_in_analytics: Optional[StrictBool] = Field(default=None, description="If `true`, the object is visible to end users in the solution. Default is `true`.", alias="visibleInAnalytics")
    ...
    analytic_object_name: Optional[StrictStr] = Field(default=None, description="The metric's analytic object name.", alias="analyticObjectName")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "objectName", "basicInformation", "details", "additiveType", "visibleInAnalytics", "includeWithVee", "analyticObjectName", "tagList", "versionInformation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of MetricDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of MetricDefinitionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": MetricTypeDetailsDTO.from_dict(obj["details"]) if obj.get("details") is not None else None,
