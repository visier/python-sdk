...
class DynamicPropertyMappingDTO(BaseModel):
    ...
    """ # noqa: E501
    hierarchy_property_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the property.", alias="hierarchyPropertyId")
    user_property: Optional[UserPropertyDTO] = Field(default=None, description="The user property that to link the name property or organization head to.", alias="userProperty")
    hierarchy_property_status: Optional[StrictStr] = Field(default=None, description="The property's validity status. Valid values:  * `Valid`: The object exists and has loaded data.  * `NotFound`: The object doesn't exist.", alias="hierarchyPropertyStatus")
