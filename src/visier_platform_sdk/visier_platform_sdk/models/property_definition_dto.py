...
class PropertyDefinitionDTO(BaseModel):
    ...
    basic_information: Optional[BasicInformationDTO] = Field(default=None, description="Fields that identify and describe the property, such as its display name, description, and explanation.", alias="basicInformation")
    details: Optional[PropertyTypeDetailsDTO] = Field(default=None, description="The property type and its details.")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "objectName", "basicInformation", "details", "tagList", "includeWithVee", "versionInformation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PropertyDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PropertyDefinitionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": PropertyTypeDetailsDTO.from_dict(obj["details"]) if obj.get("details") is not None else None,
