...
class TenantDataUploadStatusResponseDTO(BaseModel):
    ...
    source_id: Optional[StrictStr] = Field(default=None, description="The UUID of the source that the file is associated with.", alias="sourceId")
    source_object_name: Optional[StrictStr] = Field(default=None, description="The object name of the source that the file is associated with.", alias="sourceObjectName")
    __properties: ClassVar[List[str]] = ["uploadTime", "included", "filename", "identifier", "sourceId", "sourceObjectName"]
