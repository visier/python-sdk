...
class DataProviderAuthParamsDTO(BaseModel):
    ...
    snowflake_v2_auth_params: Optional[SnowflakeV2AuthParamsDTO] = Field(default=None, alias="snowflakeV2AuthParams")
    sse_auth_params: Optional[SSEAuthParamsDTO] = Field(default=None, alias="sseAuthParams")
    cdk_auth_params: Optional[CdkAuthParamsDTO] = Field(default=None, alias="cdkAuthParams")
    viva_glint_auth_params: Optional[VivaGlintAuthParamsDTO] = Field(default=None, alias="vivaGlintAuthParams")
    databricks_oidc_auth_params: Optional[DatabricksOIDCAuthParamsDTO] = Field(default=None, alias="databricksOidcAuthParams")
    ...
    __properties: ClassVar[List[str]] = ["tenantDomainName", "provider", "bambooAuthParams", "greenhouseAuthParams", "googleSheetsAuthParams", "jiraAuthParams", "leverAuthParams", "namelyAuthParams", "qualtricsAuthParams", "salesforceAuthParams", "ultimateAuthParams", "workdayAuthParams", "icimsAuthParams", "serviceNowAuthParams", "jdbcAuthParams", "s3AuthParams", "internalS3AuthParams", "copyS3AuthParams", "redshiftAuthParams", "snowflakeAuthParams", "bigQueryAuthParams", "sqlServerAuthParams", "dimensionsAuthParams", "willowAuthParams", "emptyAuthParams", "successFactorsAuthParams", "fusionAuthParams", "adpAuthParams", "medalliaAuthParams", "salesforceV2AuthParams", "gongAuthParams", "zoomAuthParams", "dayforceV2AuthParams", "slackAuthParams", "mySqlAuthParams", "workdayRaasAuthParams", "ms365AuthParams", "googleWorkspaceAuthParams", "oracleDbAuthParams", "serviceNowV2AuthParams", "databricksAuthParams", "echoAuthParams", "snowflakeV2AuthParams", "sseAuthParams", "cdkAuthParams", "vivaGlintAuthParams", "databricksOidcAuthParams", "hasUpdates", "authContext", "sourceType"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of snowflake_v2_auth_params
        if self.snowflake_v2_auth_params:
            _dict['snowflakeV2AuthParams'] = self.snowflake_v2_auth_params.to_dict()
        # override the default output from pydantic by calling `to_dict()` of sse_auth_params
        if self.sse_auth_params:
            _dict['sseAuthParams'] = self.sse_auth_params.to_dict()
        # override the default output from pydantic by calling `to_dict()` of cdk_auth_params
        if self.cdk_auth_params:
            _dict['cdkAuthParams'] = self.cdk_auth_params.to_dict()
        # override the default output from pydantic by calling `to_dict()` of viva_glint_auth_params
        if self.viva_glint_auth_params:
            _dict['vivaGlintAuthParams'] = self.viva_glint_auth_params.to_dict()
        # override the default output from pydantic by calling `to_dict()` of databricks_oidc_auth_params
        if self.databricks_oidc_auth_params:
            _dict['databricksOidcAuthParams'] = self.databricks_oidc_auth_params.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "snowflakeV2AuthParams": SnowflakeV2AuthParamsDTO.from_dict(obj["snowflakeV2AuthParams"]) if obj.get("snowflakeV2AuthParams") is not None else None,
            "sseAuthParams": SSEAuthParamsDTO.from_dict(obj["sseAuthParams"]) if obj.get("sseAuthParams") is not None else None,
            "cdkAuthParams": CdkAuthParamsDTO.from_dict(obj["cdkAuthParams"]) if obj.get("cdkAuthParams") is not None else None,
            "vivaGlintAuthParams": VivaGlintAuthParamsDTO.from_dict(obj["vivaGlintAuthParams"]) if obj.get("vivaGlintAuthParams") is not None else None,
            "databricksOidcAuthParams": DatabricksOIDCAuthParamsDTO.from_dict(obj["databricksOidcAuthParams"]) if obj.get("databricksOidcAuthParams") is not None else None,
