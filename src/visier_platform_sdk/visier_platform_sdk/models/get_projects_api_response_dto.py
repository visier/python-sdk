...
class GetProjectsAPIResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    open_projects: Optional[List[ProjectDTO]] = Field(default=None, description="The accessible open projects for the user.", alias="openProjects")
    approval_projects: Optional[List[ProjectDTO]] = Field(default=None, description="The accessible approval projects for the user.", alias="approvalProjects")
    rejected_projects: Optional[List[ProjectDTO]] = Field(default=None, description="The accessible rejected projects for the user.", alias="rejectedProjects")
    archived_projects: Optional[List[ProjectDTO]] = Field(default=None, description="The accessible archived projects for the user.", alias="archivedProjects")
