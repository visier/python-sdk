...
class ServicingV2ObjectconfigurationProcessConceptMetricDefinitionDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["formula", "dataType", "visibleInAnalytics"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingV2ObjectconfigurationProcessConceptMetricDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingV2ObjectconfigurationProcessConceptMetricDefinitionDTO from a dict"""
        if obj is None:
            return None
