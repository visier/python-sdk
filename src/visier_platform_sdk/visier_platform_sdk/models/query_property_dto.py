...
class QueryPropertyDTO(BaseModel):
    ...
    selection_concept: Optional[DataModelSelectionConceptReferenceDTO] = Field(default=None, description="A selection concept-based property that returns true or false.", alias="selectionConcept")
    dimension: Optional[DataModelDimensionReferenceDTO] = Field(default=None, description="A dimension-based property that returns the full name path of the dimension member that the data point is mapped to.")
