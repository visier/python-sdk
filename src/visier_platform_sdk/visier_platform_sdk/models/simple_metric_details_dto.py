...
class SimpleMetricDetailsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["formula", "dataType", "visibleInAnalytics", "includeWithVee", "analyticObjectName"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SimpleMetricDetailsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SimpleMetricDetailsDTO from a dict"""
        if obj is None:
            return None
