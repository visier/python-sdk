...
class JobCancellationResultsDTO(BaseModel):
    ...
    """ # noqa: E501
    job_cancellation_results: Optional[List[JobCancellationResultDTO]] = Field(default=None, description="The job cancellation results.", alias="jobCancellationResults")
