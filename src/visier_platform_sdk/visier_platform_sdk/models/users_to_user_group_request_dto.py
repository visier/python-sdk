...
class UsersToUserGroupRequestDTO(BaseModel):
    ...
    user_ids: Optional[List[StrictStr]] = Field(default=None, description="The unique user IDs to assign to or remove from the user group. The maximum number of `userIds` per user group is 100.", alias="userIds")
