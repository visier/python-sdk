...
class DisableDVModel(BaseModel):
    ...
    DisableDVModel
    """ # noqa: E501
    data_version_objects: Optional[List[DataVersionObject]] = Field(default=None, description="The data version to disable for a particular analytic tenant. Maximum is 1000.", alias="dataVersionObjects")
