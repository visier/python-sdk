...
class QuestionCategoryAPIResponseDTO(BaseModel):
    """
    ...
    basic_information: Optional[QuestionCategoryBasicInformationDTO] = Field(default=None, description="Information that identifies and describes the question category, such as its display name and description.", alias="basicInformation")
    category_icon: Optional[CategoryIconDTO] = Field(default=None, description="The icon for the question category.", alias="categoryIcon")
    ...
    __properties: ClassVar[List[str]] = ["categoryId", "basicInformation", "categoryIcon", "versionInformation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QuestionCategoryAPIResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QuestionCategoryAPIResponseDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "basicInformation": QuestionCategoryBasicInformationDTO.from_dict(obj["basicInformation"]) if obj.get("basicInformation") is not None else None,
