...
class UserGroupDeleteFailureDTO(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the project in which the user group could not be deleted.", alias="projectId")
