...
class AccessibleTenantProfileRevokeResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    bad_tenant_codes: Optional[List[ReducedTenantCodeErrorDTO]] = Field(default=None, description="The tenants that returned errors.", alias="badTenantCodes")
    bad_user_ids: Optional[List[ReducedUserIdErrorDTO]] = Field(default=None, description="The user IDs that may not be valid.", alias="badUserIds")
    unaffected_users: Optional[List[SuccessfulLocalTenantProfileAssignmentDTO]] = Field(default=None, description="The valid user IDs that were not affected.", alias="unaffectedUsers")
    succeeded: Optional[List[SuccessfulLocalTenantProfileAssignmentDTO]] = Field(default=None, description="The valid user IDs that succeeded.")
