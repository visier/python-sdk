...
class QueryDimensionLevelPropertyDTO(BaseModel):
    ...
    member_value_mode: Optional[StrictStr] = Field(default=None, description="Controls how to display member values. Default is `NAME`.    Valid values:   * `NAME`: Returns the member's display name.  * `PATH`: Returns the member's name path.", alias="memberValueMode")
