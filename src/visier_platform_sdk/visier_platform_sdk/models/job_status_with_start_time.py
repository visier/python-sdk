...
class JobStatusWithStartTime(BaseModel):
    ...
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the job.", alias="jobId")
    ...
    parent_job_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the parent job, if applicable.", alias="parentJobId")
    __properties: ClassVar[List[str]] = ["jobId", "tenant", "status", "jobType", "startTime", "parentJobId"]
