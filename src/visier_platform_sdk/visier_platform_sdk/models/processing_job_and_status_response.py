...
class ProcessingJobAndStatusResponse(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="The number of processing jobs to return. Maximum is 1000.")
    start: Optional[StrictInt] = Field(default=None, description="The starting index of the first result to return. Default is 0.")
    processing_jobs: Optional[List[ProcessingJob]] = Field(default=None, description="Processing job information.", alias="processingJobs")
