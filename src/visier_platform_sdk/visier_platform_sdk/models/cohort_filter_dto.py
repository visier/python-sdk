...
from visier_platform_sdk.models.data_query_key_group_filter_dto import DataQueryKeyGroupFilterDTO
...
class CohortFilterDTO(BaseModel):
    ...
    """ # noqa: E501
    key_group: Optional[DataQueryKeyGroupFilterDTO] = Field(default=None, description="A key group is a collection of filters that define the shape of the analysis population.", alias="keyGroup")
    ...
    __properties: ClassVar[List[str]] = ["keyGroup", "exclude", "timeInterval"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "keyGroup": DataQueryKeyGroupFilterDTO.from_dict(obj["keyGroup"]) if obj.get("keyGroup") is not None else None,
