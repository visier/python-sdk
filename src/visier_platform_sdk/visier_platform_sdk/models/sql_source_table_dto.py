...
class SqlSourceTableDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["uuid", "objectName", "basicInformation", "columns", "canChildrenInherit", "canChildrenInheritData", "excludeFromAutoProcessing", "snapshotRetentionDays", "materializedView"]
