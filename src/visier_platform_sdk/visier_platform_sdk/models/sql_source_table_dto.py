...
class SqlSourceTableDTO(BaseModel):
    ...
    snapshot_retention_days: Optional[StrictInt] = Field(default=None, description="The number of days to keep snapshots for this table before permanently deleting them. Must be between 1 and 180 days.  Default is 7 days. You cannot reset the table to a timestamp older than the retention period because older snapshots are permanently deleted.", alias="snapshotRetentionDays")
