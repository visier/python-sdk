...
class SqlSourceTableDTO(BaseModel):
    ...
    materialized_view_config: Optional[SqlSourceMaterializedViewConfigDTO] = Field(default=None, description="The materialized view configuration for this table. Omit or leave `enabled` as `false` for regular tables.", alias="materializedViewConfig")
    __properties: ClassVar[List[str]] = ["uuid", "objectName", "basicInformation", "columns", "canChildrenInherit", "canChildrenInheritData", "excludeFromAutoProcessing", "snapshotRetentionDays", "materializedViewConfig"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of materialized_view_config
        if self.materialized_view_config:
            _dict['materializedViewConfig'] = self.materialized_view_config.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "materializedViewConfig": SqlSourceMaterializedViewConfigDTO.from_dict(obj["materializedViewConfig"]) if obj.get("materializedViewConfig") is not None else None
        })
        return _obj
