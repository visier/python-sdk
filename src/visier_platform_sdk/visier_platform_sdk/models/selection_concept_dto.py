...
class SelectionConceptDTO(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the selection concept.")
    ...
    visible_in_app: Optional[StrictBool] = Field(default=None, description="If `true`, the selection concept is visible to end users in the solution.", alias="visibleInApp")
