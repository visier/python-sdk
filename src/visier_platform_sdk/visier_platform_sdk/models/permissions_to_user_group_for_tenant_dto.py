...
class PermissionsToUserGroupForTenantDTO(BaseModel):
    ...
    status: Optional[StrictStr] = Field(default=None, description="The state of the permission assignment or removal. Valid values: `Succeed` or `Failed`.")
    message: Optional[StrictStr] = Field(default=None, description="A detailed description of the request outcome, if available.")
    user_groups: Optional[List[UserGroupGetAPIResponseDTO]] = Field(default=None, description="The user groups and the permissions to assign to or remove from them.", alias="userGroups")
