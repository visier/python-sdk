...
class AggregationQuerySourceMetricDTO(BaseModel):
    ...
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the metric.  If `columnName` is omitted, `id` is the column name in the CSV file.")
