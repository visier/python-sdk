...
class AssignConnectorCredentialsResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    tenants: Optional[List[AssignConnectorCredentialsByTenantResponseDTO]] = Field(default=None, description="The tenants and data connectors that were assigned connector credentials.")
