...
class ProcessingJob(BaseModel):
    ...
    ProcessingJob
    """ # noqa: E501
    job_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the processing job for the analytic tenant.", alias="jobId")
    tenant_code: Optional[StrictStr] = Field(default=None, description="The analytic tenant code.", alias="tenantCode")
    data_version: Optional[StrictStr] = Field(default=None, description="The data version of the processing job.", alias="dataVersion")
