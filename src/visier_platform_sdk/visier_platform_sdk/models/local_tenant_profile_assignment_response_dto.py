...
class LocalTenantProfileAssignmentResponseDTO(BaseModel):
    ...
    bad_user_ids: Optional[List[UserIdErrorDTO]] = Field(default=None, description="The user IDs that may not be valid.", alias="badUserIds")
    failed_assignments: Optional[List[FailedLocalTenantProfileAssignmentDTO]] = Field(default=None, description="The errors that occurred during the assignment operation.", alias="failedAssignments")
    successful_assignments: Optional[List[SuccessfulLocalTenantProfileAssignmentDTO]] = Field(default=None, description="The user IDs that were successfully assigned the profile.", alias="successfulAssignments")
