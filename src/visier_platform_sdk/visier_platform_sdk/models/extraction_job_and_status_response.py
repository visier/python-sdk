...
class ExtractionJobAndStatusResponse(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="The number of extraction jobs to return. Maximum is 1000.")
    start: Optional[StrictInt] = Field(default=None, description="The starting index of the first result to return. Default is 0.")
    extraction_jobs: Optional[List[ExtractionJob]] = Field(default=None, description="Extraction job information.", alias="extractionJobs")
