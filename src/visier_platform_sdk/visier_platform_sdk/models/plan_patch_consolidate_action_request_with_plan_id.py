...
class PlanPatchConsolidateActionRequestWithPlanId(BaseModel):
    ...
    plan_id: UUID = Field(description="The `uuid` of the subplan. Required for `PATCH /v1alpha/planning/data/plans`. If you are consolidating subplans, this is the `uuid` of the main plan.", alias="planId")
