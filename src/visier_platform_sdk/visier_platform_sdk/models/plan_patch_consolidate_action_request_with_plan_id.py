...
class PlanPatchConsolidateActionRequestWithPlanId(BaseModel):
    """
    ...
    plan_id: StrictStr = Field(description="The `uuid` of the subplan. Required for `PATCH /v1alpha/planning/data/plans`. If you are consolidating subplans, this is the `uuid` of the main plan.", alias="planId")
    __properties: ClassVar[List[str]] = ["actionType", "consolidateActionPayload", "planId"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanPatchConsolidateActionRequestWithPlanId from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanPatchConsolidateActionRequestWithPlanId from a dict"""
        if obj is None:
            return None
