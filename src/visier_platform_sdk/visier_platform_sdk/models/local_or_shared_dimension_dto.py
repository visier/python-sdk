...
class LocalOrSharedDimensionDTO(BaseModel):
    ...
    shared: Optional[V2DimensionReferenceDTO] = Field(default=None, description="A reference to a shared dimension that is associated with one or more objects.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "shared": V2DimensionReferenceDTO.from_dict(obj["shared"]) if obj.get("shared") is not None else None
        })
        return _obj
