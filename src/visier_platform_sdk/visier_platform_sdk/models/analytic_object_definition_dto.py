...
class AnalyticObjectDefinitionDTO(BaseModel):
    ...
    def update_operation_validate_enum(cls, value):
        ...
        if value not in set(['unspecified', 'revertToBP', 'put']):
            raise ValueError("must be one of enum values ('unspecified', 'revertToBP', 'put')")
        return value
