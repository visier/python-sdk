...
class SampleQuestionAPIResponseDTO(BaseModel):
    """
    Information about the sample question.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["question", "questionId", "visibleInVee", "categoryId", "userGroupAssignment", "versionInformation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SampleQuestionAPIResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SampleQuestionAPIResponseDTO from a dict"""
        if obj is None:
            return None
