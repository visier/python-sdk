...
class DerivedMetricDetailsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["formula", "dataType", "visibleInAnalytics", "includeWithVee", "analyticObjectName", "baseMetricId", "derivedMetricType", "denominatorMetricName"]
