...
class TenantDetailAPIDTO(BaseModel):
    ...
    manually_added_modules: Optional[List[TenantModuleDTO]] = Field(default=None, description="The modules manually added to the analytic tenant. Manually added modules are not part of a purchased module bundle.", alias="manuallyAddedModules")
    __properties: ClassVar[List[str]] = ["tenantCode", "tenantDisplayName", "status", "provisionDate", "currentDataVersion", "dataVersionDate", "modules", "industryCode", "canAdministerOtherTenants", "embeddableDomains", "customProperties", "ssoInstanceIssuers", "vanityUrlName", "allowedOAuthIdpUrlDomains", "manuallyAddedModules"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in manually_added_modules (list)
        _items = []
        if self.manually_added_modules:
            for _item_manually_added_modules in self.manually_added_modules:
                if _item_manually_added_modules:
                    _items.append(_item_manually_added_modules.to_dict())
            _dict['manuallyAddedModules'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "manuallyAddedModules": [TenantModuleDTO.from_dict(_item) for _item in obj["manuallyAddedModules"]] if obj.get("manuallyAddedModules") is not None else None
        })
        return _obj
