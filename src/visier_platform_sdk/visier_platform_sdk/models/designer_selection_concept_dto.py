...
class DesignerSelectionConceptDTO(BaseModel):
    ...
    configuration: Optional[SelectionConceptConfigurationDTO] = Field(default=None, description="A list of objects representing the configuration for the selection concept.")
