...
class SqlSourceExecuteJobRequestDTO(BaseModel):
    ...
    tenants: Optional[List[StrictStr]] = Field(default=None, description="The tenants to schedule the job for. If this field isn't specified and a distribution mode is set, the job dispatches to the tenants detected from the input data. If this field isn't specified and no distribution mode is set, the job runs for the current tenant only.")
