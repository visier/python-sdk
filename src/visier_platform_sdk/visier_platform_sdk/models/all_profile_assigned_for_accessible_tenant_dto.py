...
class AllProfileAssignedForAccessibleTenantDTO(BaseModel):
    ...
    """ # noqa: E501
    assigned_profiles_for_accessible_tenant: Optional[List[ProfileAssignedForAccessibleTenantDTO]] = Field(default=None, description="The user profiles assigned to the user and their validity range.", alias="assignedProfilesForAccessibleTenant")
