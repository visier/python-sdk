...
class ServicingDirectDataSchemaFieldDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["name", "dataType", "formats", "isMandatory", "emptyValuesAllowed"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingDirectDataSchemaFieldDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingDirectDataSchemaFieldDTO from a dict"""
        if obj is None:
            return None
