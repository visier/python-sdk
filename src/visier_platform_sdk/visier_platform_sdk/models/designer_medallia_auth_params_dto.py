...
class DesignerMedalliaAuthParamsDTO(BaseModel):
    """
    DesignerMedalliaAuthParamsDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["tenantDomainName", "instanceUrl", "clientId", "clientSecret"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerMedalliaAuthParamsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerMedalliaAuthParamsDTO from a dict"""
        if obj is None:
            return None
