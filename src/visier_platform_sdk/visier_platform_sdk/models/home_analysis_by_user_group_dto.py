...
class HomeAnalysisByUserGroupDTO(BaseModel):
    ...
    home_analysis_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the analysis to show for this user group when a user logs in.", alias="homeAnalysisId")
