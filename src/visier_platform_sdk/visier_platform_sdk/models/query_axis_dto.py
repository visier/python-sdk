...
class QueryAxisDTO(BaseModel):
    ...
    selection_concept: Optional[DataModelSelectionConceptReferenceDTO] = Field(default=None, description="An axis that uses an existing selection concept in Visier.  The resulting axis consists of 3 positions: True, False, and Unknown.", alias="selectionConcept")
    ...
    dimension_data_member_selection: Optional[QueryDimensionDataMemberSelectionDTO] = Field(default=None, description="An axis comprised of all leaf members and data members for an existing dimension in Visier.", alias="dimensionDataMemberSelection")
    ...
    sort_and_limit_options: Optional[QueryAxisSortAndLimitOptionsDTO] = Field(default=None, description="Optional sorting and limits to apply to the axis.", alias="sortAndLimitOptions")
    __properties: ClassVar[List[str]] = ["formula", "selectionConcept", "dimensionMemberSelection", "memberMapSelection", "numericRanges", "dimensionLevelSelection", "dimensionLeafMemberSelection", "dimensionDataMemberSelection", "dimensionLevelWithUncategorizedValueSelection", "tableAxisOptions", "sortAndLimitOptions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of sort_and_limit_options
        if self.sort_and_limit_options:
            _dict['sortAndLimitOptions'] = self.sort_and_limit_options.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "selectionConcept": DataModelSelectionConceptReferenceDTO.from_dict(obj["selectionConcept"]) if obj.get("selectionConcept") is not None else None,
            ...
            "sortAndLimitOptions": QueryAxisSortAndLimitOptionsDTO.from_dict(obj["sortAndLimitOptions"]) if obj.get("sortAndLimitOptions") is not None else None
        })
        return _obj
