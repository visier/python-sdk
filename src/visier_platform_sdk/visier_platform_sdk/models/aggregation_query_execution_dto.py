...
class AggregationQueryExecutionDTO(BaseModel):
    ...
    options: Optional[AggregateQueryExecutionOptionsDTO] = Field(default=None, description="Additional instructions for your query, such as a calendar type or conversion information.")
