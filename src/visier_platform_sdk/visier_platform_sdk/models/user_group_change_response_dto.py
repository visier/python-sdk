...
class UserGroupChangeResponseDTO(BaseModel):
    """
    UserGroupChangeResponseDTO
    """ # noqa: E501
    successes: Optional[List[UserGroupChangeSuccessDTO]] = Field(default=None, description="The user groups that were successfully changed (created, updated, patched, or reverted).")
    failures: Optional[List[UserGroupChangeFailureDTO]] = Field(default=None, description="The user groups that were not successfully changed (created, updated, patched, or reverted).")
