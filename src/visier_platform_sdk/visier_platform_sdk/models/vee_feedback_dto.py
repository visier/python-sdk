...
class VeeFeedbackDTO(BaseModel):
    ...
    """ # noqa: E501
    conversation: Optional[VeeConversationDTO] = Field(default=None, description="Details of the Vee conversation you want to provide feedback about.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "conversation": VeeConversationDTO.from_dict(obj["conversation"]) if obj.get("conversation") is not None else None,
