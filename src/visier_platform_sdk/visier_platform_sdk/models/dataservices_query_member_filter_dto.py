...
class DataservicesQueryMemberFilterDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    dimension: Optional[DataservicesDatamodelDimensionReferenceDTO] = Field(default=None, description="The dimension in which the members belong.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryMemberFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryMemberFilterDTO from a dict"""
        if obj is None:
            return None
