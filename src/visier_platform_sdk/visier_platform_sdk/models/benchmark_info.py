...
class BenchmarkInfo(BaseModel):
    ...
    api_release_date: StrictStr = Field(description="The date that API changes are released. ", alias="apiReleaseDate")
    __properties: ClassVar[List[str]] = ["referenceDate", "releaseDate", "apiReleaseDate"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "apiReleaseDate": obj.get("apiReleaseDate")
        })
        return _obj
