...
class TenantManagementAPIListResponseDTO(BaseModel):
    ...
    limit: Optional[StrictInt] = Field(default=None, description="The limit of analytic tenants to return.")
    start: Optional[StrictInt] = Field(default=None, description="The starting index to retrieve values from, also known as offset.")
