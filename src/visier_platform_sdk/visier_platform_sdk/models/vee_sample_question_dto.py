...
class VeeSampleQuestionDTO(BaseModel):
    ...
    is_assigned_to_user: Optional[StrictBool] = Field(default=None, description="If `true`, the sample question is spotlighted for at least one of the user's user groups.", alias="isAssignedToUser")
