...
class AllPermissionsAssignedForLocalTenantDTO(BaseModel):
    ...
    """ # noqa: E501
    assigned_permissions: Optional[List[PermissionAssignedForLocalTenantDTO]] = Field(default=None, description="The user's permissions.", alias="assignedPermissions")
