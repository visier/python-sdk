...
class MemberFilterConfigDTO(BaseModel):
    ...
    """ # noqa: E501
    dimension_filters: Optional[List[DimensionFilterDTO]] = Field(default=None, description="The custom filters that define population access for the item.   A custom filter can be a member filter (`staticDimensionFilter`) or a dynamic filter (`dynamicDimensionFilter`).", alias="dimensionFilters")
