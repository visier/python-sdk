...
class StaticDimensionFilterDTO(BaseModel):
    ...
    """ # noqa: E501
    dimension_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the dimension associated with the filter.", alias="dimensionId")
    ...
    member_selections: Optional[List[MemberSelectionDTO]] = Field(default=None, description="The dimension members assigned population access in the member filter.", alias="memberSelections")
    dimension_status: Optional[StrictStr] = Field(default=None, description="The dimension's validity status. Valid values:  * `Valid`: The object exists and has loaded data.  * `NoData`: The object exists but doesn't have loaded data.  * `NotFound`: The object doesn't exist.", alias="dimensionStatus")
