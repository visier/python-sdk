...
class TenantManagementAPIUpdateResponseDTO(BaseModel):
    ...
    force_logins_with_session_based_permissions: Optional[StrictBool] = Field(default=None, description="If `true`, user sign in must also provide a `SessionRepoId`. Only set if `SessionBasedPermissions` feature is enabled. Default is `false`.", alias="forceLoginsWithSessionBasedPermissions")
    __properties: ClassVar[List[str]] = ["tenantCode", "tenantDisplayName", "industryCode", "primaryBusinessLocation", "purchasedModules", "embeddableDomains", "customProperties", "ssoInstanceIssuers", "homeAnalysisId", "homeAnalysisByUserGroup", "status", "clickThroughLink", "vanityUrlName", "defaultCurrency", "allowedOAuthIdpUrlDomains", "forceLoginsWithSessionBasedPermissions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "forceLoginsWithSessionBasedPermissions": obj.get("forceLoginsWithSessionBasedPermissions")
        })
        return _obj
