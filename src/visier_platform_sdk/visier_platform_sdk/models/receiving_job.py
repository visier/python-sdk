...
class ReceivingJob(BaseModel):
    ...
    ReceivingJob
    """ # noqa: E501
    receiving_job_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the receiving job for the analytic tenant.", alias="receivingJobId")
