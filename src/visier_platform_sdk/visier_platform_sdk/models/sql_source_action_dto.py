...
class SqlSourceActionDTO(BaseModel):
    ...
    """ # noqa: E501
    query: Optional[SqlSourceQueryActionDTO] = Field(default=None, alias="QUERY")
    upsert: Optional[SqlSourceUpsertActionDTO] = Field(default=None, alias="UPSERT")
    replace: Optional[SqlSourceReplaceActionDTO] = Field(default=None, alias="REPLACE")
    capturechanges: Optional[SqlSourceCaptureChangesActionDTO] = Field(default=None, alias="CAPTURECHANGES")
    rollback: Optional[Dict[str, Any]] = Field(default=None, description="A rollback action.", alias="ROLLBACK")
    commit: Optional[Dict[str, Any]] = Field(default=None, description="A commit action.", alias="COMMIT")
    process: Optional[SqlSourceProcessActionDTO] = Field(default=None, alias="PROCESS")
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of capturechanges
        if self.capturechanges:
            _dict['CAPTURECHANGES'] = self.capturechanges.to_dict()
