...
class SqlSourceActionDTO(BaseModel):
    ...
    reset: Optional[SqlSourceResetActionDTO] = None
    __properties: ClassVar[List[str]] = ["query", "upsert", "replace", "captureChanges", "rollback", "commit", "process", "setMetadata", "reset"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "reset": SqlSourceResetActionDTO.from_dict(obj["reset"]) if obj.get("reset") is not None else None
        })
        return _obj
