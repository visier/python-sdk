...
class ExtractorSettingAPIDTO(BaseModel):
    ...
    connector_settings: Optional[List[ExtractorSettingKeyValueAPIDTO]] = Field(default=None, description="The settings that are available for the data connector.", alias="connectorSettings")
