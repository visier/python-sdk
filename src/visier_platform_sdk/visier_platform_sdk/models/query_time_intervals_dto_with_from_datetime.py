...
class QueryTimeIntervalsDTOWithFromDatetime(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["fromDateTime", "intervalPeriodType", "intervalPeriodCount", "intervalCount", "direction", "shift", "trailingPeriodType", "trailingPeriodCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryTimeIntervalsDTOWithFromDatetime from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryTimeIntervalsDTOWithFromDatetime from a dict"""
        if obj is None:
            return None
