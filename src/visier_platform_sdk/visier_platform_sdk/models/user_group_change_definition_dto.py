...
class UserGroupChangeDefinitionDTO(BaseModel):
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="The project in which to update or create the user group.  If omitted and the `ProjectID` request header is unspecified, the change is published to production immediately.", alias="projectId")
    ...
    __properties: ClassVar[List[str]] = ["userGroupId", "displayName", "description", "permissionIds", "users", "tenantCode", "projectId", "visibleForSelection", "correlationId"]
