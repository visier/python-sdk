...
class UserGroupChangeDefinitionDTO(BaseModel):
    ...
    visible_for_selection: Optional[VisibleForSelectionDTO] = Field(default=None, description="The features in which your users can see and select this user group. If omitted, the user group is visible in all features.  **Note**: User group visibility is not available until Summer 2025.", alias="visibleForSelection")
