...
class PlanningPlanDTO(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the plan.")
    name: Optional[StrictStr] = Field(default=None, description="The name of the plan.")
    subject_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of subject for the plan.", alias="subjectId")
