...
class UserGroupDeleteDTO(BaseModel):
    """
    UserGroupDeleteDTO
    """ # noqa: E501
    ...
    project_id: Optional[StrictStr] = Field(default=None, description="The project ID in which to delete the user group.  If omitted and the `ProjectID` request header is unspecified, the change is published to production immediately.", alias="projectId")
