...
class PredictionDTO(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the prediction.")
    ...
    subject_key: Optional[StrictStr] = Field(default=None, description="The unique identifier of the subject's property that the prediction applies to. For example, Employee.EmployeeID.", alias="subjectKey")
    subject_parent_key: Optional[StrictStr] = Field(default=None, description="The unique identifier of the reference that connects a subject member to other members. For example, Employee.Direct_Manager.  The `subjectParentKey` defines parent, child, and peer relationships between subject members.", alias="subjectParentKey")
    ...
    label_property: Optional[StrictStr] = Field(default=None, description="The unique identifier of the property label for the prediction. This is automatically generated.", alias="labelProperty")
