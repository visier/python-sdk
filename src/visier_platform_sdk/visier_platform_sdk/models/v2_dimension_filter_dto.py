...
from visier_platform_sdk.models.v2_member_selection_dto import V2MemberSelectionDTO
from typing import Optional, Set
from typing_extensions import Self

class V2DimensionFilterDTO(BaseModel):
    """
    ...
    member_selections: Optional[List[V2MemberSelectionDTO]] = Field(default=None, description="The dimension members in a member selection concept.", alias="memberSelections")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of V2DimensionFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of V2DimensionFilterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "memberSelections": [V2MemberSelectionDTO.from_dict(_item) for _item in obj["memberSelections"]] if obj.get("memberSelections") is not None else None
        })
        return _obj
