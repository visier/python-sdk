...
class CalculationConceptDTO(BaseModel):
    ...
    """ # noqa: E501
    uuid: Optional[StrictStr] = Field(default=None, description="The unique identifier of the calculation concept.")
    name: Optional[StrictStr] = Field(default=None, description="The display name of the calculation concept.")
    configuration: Optional[CalculationConceptConfigurationDTO] = Field(default=None, description="The configuration for the calculation concept.")
