...
class OAuth2UserInfoDTO(BaseModel):
    ...
    """ # noqa: E501
    sub: Optional[StrictStr] = Field(default=None, description="The user's Common Name.")
    ...
    visier_user_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the user.", alias="visier:user_id")
    ...
    visier_tenant_details: Optional[OAuth2UserTenantDetailsDTO] = Field(default=None, description="Detailed information about the analytic tenant. Included in the response if `includeTenantDetails` is `true`.", alias="visier:tenant_details")
    visier_tenant_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the user's tenant.", alias="visier:tenant_id")
    __properties: ClassVar[List[str]] = ["sub", "name", "email", "visier:user_id", "visier:capabilities", "visier:subnets", "visier:export_subnets", "visier:tenant_details", "visier:tenant_id"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "visier:tenant_id": obj.get("visier:tenant_id")
        })
        return _obj
