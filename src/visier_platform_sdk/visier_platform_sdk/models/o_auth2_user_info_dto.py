...
class OAuth2UserInfoDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["subject", "name", "email", "visier:user_id", "visier:capabilities", "visier:subnets", "visier:export_subnets", "visier:tenant_details", "visier:tenant_id"]
