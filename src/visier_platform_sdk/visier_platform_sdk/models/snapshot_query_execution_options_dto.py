...
class SnapshotQueryExecutionOptionsDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["limit", "queryMode", "omitHeader", "calendarType", "currencyConversionDate", "page", "multipleTables", "currencyConversionCode", "dateTimeDisplayMode", "calendarId"]
