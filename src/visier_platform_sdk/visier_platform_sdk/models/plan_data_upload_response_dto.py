...
class PlanDataUploadResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    updated_cells_count: Optional[StrictInt] = Field(default=None, description="The number of cells updated from the data load process.", alias="updatedCellsCount")
