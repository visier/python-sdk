...
class DirectDataJobConfigDTO(BaseModel):
    ...
    """ # noqa: E501
    supplemental_mode: Optional[StrictStr] = Field(default=None, description="The configuration for the processing job as a primary job (default) or a supplemental job. If a primary job is already defined, the direct data   intake job must be supplemental. Valid values: `IS_PRIMARY`, `IS_SUPPLEMENTAL`, and `UNCHANGED`.", alias="supplementalMode")
