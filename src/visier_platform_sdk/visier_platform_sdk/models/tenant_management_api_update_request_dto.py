...
class TenantManagementAPIUpdateRequestDTO(BaseModel):
    ...
    """ # noqa: E501
    tenant_code: Optional[StrictStr] = Field(default=None, description="A unique identifier for the newly created analytic tenant. Required if creating new tenants. The maximum is 50 characters. This limit includes the administrating tenant code. For example, WFF_a1b2c~whatisthemaxlengthofatenantcode123456789 (50 characters).", alias="tenantCode")
