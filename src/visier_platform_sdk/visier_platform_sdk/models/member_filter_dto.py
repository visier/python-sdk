...
class MemberFilterDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    dimension: Optional[DimensionReferenceDTO] = Field(default=None, description="The dimension in which the members belong.")
    values: Optional[MemberValuesDTO] = Field(default=None, description="The dimension members to filter by.")
