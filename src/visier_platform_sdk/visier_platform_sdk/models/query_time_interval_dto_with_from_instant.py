...
class QueryTimeIntervalDTOWithFromInstant(BaseModel):
    """
    QueryTimeIntervalDTOWithFromInstant
    """ # noqa: E501
    from_instant: StrictStr = Field(description="The instant from which to extend in the specified `direction`, in milliseconds since 1970-01-01T00:00:00Z.  Events that occur on this date are excluded. Subject-based data that ends on this date is included.  Note: Epochs are expressed as 64-bit integers and represented as stringified longs in JSON due to  JSON's inherent limitation in representing large numbers.", alias="fromInstant")
    ...
    __properties: ClassVar[List[str]] = ["fromInstant", "intervalPeriodType", "intervalPeriodCount", "direction", "shift"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryTimeIntervalDTOWithFromInstant from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryTimeIntervalDTOWithFromInstant from a dict"""
        if obj is None:
            return None
