...
class JobStandardizationInput(BaseModel):
    ...
    include_archived: Optional[StrictBool] = Field(default=False, description="If `true`, both `active` and `archived` members are returned. Default is `false`. Members are archived when taxonomy changes are made. ", alias="includeArchived")
    __properties: ClassVar[List[str]] = ["terms", "naicsCode", "numMatches", "semanticOnly", "lexicalOnly", "typicalTitlesSearch", "includeArchived"]
