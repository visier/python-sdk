...
class DataVersionObject(BaseModel):
    ...
    data_category: Optional[StrictStr] = Field(default=None, description="The object name of the data category. Default is the primary data category.  For administrating tenants, the data category must exist in the requesting tenant; that is, the administrating tenant or the tenant specified in `TargetTenantID`.", alias="dataCategory")
    __properties: ClassVar[List[str]] = ["tenantCode", "dataVersion", "dataCategory"]
