...
class DesignerWorkdayAuthParamsDTO(BaseModel):
    ...
    additional_header_params: Optional[List[DesignerPairDTO]] = Field(default=None, alias="additionalHeaderParams")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "additionalHeaderParams": [DesignerPairDTO.from_dict(_item) for _item in obj["additionalHeaderParams"]] if obj.get("additionalHeaderParams") is not None else None
        })
        return _obj
