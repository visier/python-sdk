...
class PlanSchemaDTO(BaseModel):
    ...
    plan_context: Optional[PlanContextDTO] = Field(default=None, description="The context the plan is scoped to, with each context member's full ancestor path expanded top-down. For example, a plan might be scoped to women, with a location segmentation down to the state and city levels, and organization levels one to three.  Omitted for top-level plans that have no context.", alias="planContext")
    __properties: ClassVar[List[str]] = ["planItems", "timePeriods", "planSegmentLevels", "planSegmentLevelMembers", "planContext"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of plan_context
        if self.plan_context:
            _dict['planContext'] = self.plan_context.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "planContext": PlanContextDTO.from_dict(obj["planContext"]) if obj.get("planContext") is not None else None
        })
        return _obj
