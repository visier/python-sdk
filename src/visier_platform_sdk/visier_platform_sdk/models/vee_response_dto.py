...
class VeeResponseDTO(BaseModel):
    ...
    detail_data: Optional[List[VeeDetailDataDTO]] = Field(default=None, description="Returns if `includeDetailData` is `true`. Provides additional detail data relevant to the questions.", alias="detailData")
    __properties: ClassVar[List[str]] = ["conversationState", "statusCode", "narrative", "chartUrl", "schema", "corrections", "data", "visual", "rewordedQuestion", "detailData"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in detail_data (list)
        _items = []
        if self.detail_data:
            for _item_detail_data in self.detail_data:
                if _item_detail_data:
                    _items.append(_item_detail_data.to_dict())
            _dict['detailData'] = _items
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "detailData": [VeeDetailDataDTO.from_dict(_item) for _item in obj["detailData"]] if obj.get("detailData") is not None else None
        })
        return _obj
