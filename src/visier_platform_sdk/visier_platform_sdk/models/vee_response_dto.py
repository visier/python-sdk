...
class VeeResponseDTO(BaseModel):
    ...
    chart_url: Optional[StrictStr] = Field(default=None, description="A URL to view the visualization in Visier. If a click-through link is configured, this field will show a custom URL that redirects users to the relevant content in your portal. To configure a click-through link, see `POST /v2/admin/tenants`.", alias="chartUrl")
    ...
    related_documents: Optional[VeeRelatedDocumentListDTO] = Field(default=None, description="A list of related analyses and reports that may be relevant to the question. Reports are available for Embedded Partners.", alias="relatedDocuments")
    suggestions: Optional[List[VeeSuggestionDTO]] = Field(default=None, description="A list of suggested follow-up questions.")
    __properties: ClassVar[List[str]] = ["conversationState", "statusCode", "narrative", "chartUrl", "schema", "corrections", "data", "visual", "rewordedQuestion", "relatedDocuments", "suggestions"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of related_documents
        if self.related_documents:
            _dict['relatedDocuments'] = self.related_documents.to_dict()
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "relatedDocuments": VeeRelatedDocumentListDTO.from_dict(obj["relatedDocuments"]) if obj.get("relatedDocuments") is not None else None,
            "suggestions": [VeeSuggestionDTO.from_dict(_item) for _item in obj["suggestions"]] if obj.get("suggestions") is not None else None
        })
        return _obj
