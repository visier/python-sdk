...
class MemberSelectionDTO(BaseModel):
    ...
    dimension_member_status: Optional[StrictStr] = Field(default=None, description="The dimension member's validity status. Valid values:  * `Valid`: The object exists and has loaded data.  * `NotFound`: The object doesn't exist.", alias="dimensionMemberStatus")
