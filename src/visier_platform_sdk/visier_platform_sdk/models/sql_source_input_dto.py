...
class SqlSourceInputDTO(BaseModel):
    ...
    filename: Optional[StrictStr] = Field(default=None, description="The name of the input file. If specified, do not specify `filenames`.")
    ...
    filenames: Optional[List[StrictStr]] = Field(default=None, description="The names of multiple input files. Specifying multiple files concatenates the file records into a single input view in SQL. Useful for large inputs that are split across several files. If specified, do not specify `filename`.")
    __properties: ClassVar[List[str]] = ["id", "filename", "format", "tenantCodeColumn", "prependAdminTenantCode", "inputDistributionMode", "fileContainerName", "filenames"]
