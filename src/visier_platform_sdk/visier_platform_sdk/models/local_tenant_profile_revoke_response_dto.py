...
class LocalTenantProfileRevokeResponseDTO(BaseModel):
    ...
    """ # noqa: E501
    failed: Optional[List[FailedLocalTenantProfileRevokeDTO]] = Field(default=None, description="The errors that occurred during the assignment operation.")
    succeeded: Optional[List[SuccessfulLocalTenantProfileAssignmentDTO]] = Field(default=None, description="The user IDs that successfully had a profile removed.")
