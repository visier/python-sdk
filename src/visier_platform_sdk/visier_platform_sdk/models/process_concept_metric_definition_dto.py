...
class ProcessConceptMetricDefinitionDTO(BaseModel):
    """
    ...
    details: Optional[ProcessConceptMetricTypeDetailsDTO] = Field(default=None, description="The metric type and its details.")
    ...
    __properties: ClassVar[List[str]] = ["uuid", "objectName", "basicInformation", "details", "additiveType", "versionInformation"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ProcessConceptMetricDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ProcessConceptMetricDefinitionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "details": ProcessConceptMetricTypeDetailsDTO.from_dict(obj["details"]) if obj.get("details") is not None else None,
