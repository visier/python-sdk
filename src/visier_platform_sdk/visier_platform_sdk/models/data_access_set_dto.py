...
class DataAccessSetDTO(BaseModel):
    """
    DataAccessSetDTO
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the data access set.")
    ...
    analytic_object_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the analytic object that the data access set is for.", alias="analyticObjectId")
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "description", "analyticObjectId", "propertyAccessConfigs", "correlationId"]
