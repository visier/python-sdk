...
class ProjectDTO(BaseModel):
    ...
    ProjectDTO
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the project. Omit when creating a new project.")
    ...
    project_type: Optional[StrictStr] = Field(default=None, description="The type of the project. Omit when creating a new project.", alias="projectType")
    __properties: ClassVar[List[str]] = ["id", "name", "description", "releaseVersion", "ticketNumber", "versionNumber", "capabilities", "projectType"]
    ...
    def project_type_validate_enum(cls, value):
        ...
        if value not in set(['Standard', 'Prototype', 'UnknownType']):
            raise ValueError("must be one of enum values ('Standard', 'Prototype', 'UnknownType')")
        return value
