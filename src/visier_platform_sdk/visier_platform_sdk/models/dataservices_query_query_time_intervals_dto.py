...
class DataservicesQueryQueryTimeIntervalsDTO(BaseModel):
    """
    ...
    shift: Optional[DataservicesQueryTimeShiftDTO] = Field(default=None, description="The amount of time to shift the time interval by, such as backward by one year.")
    ...
    __properties: ClassVar[List[str]] = ["fromInstant", "fromDateTime", "dynamicDateFrom", "intervalPeriodType", "intervalPeriodCount", "intervalCount", "direction", "shift", "trailingPeriodType", "trailingPeriodCount"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryQueryTimeIntervalsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryQueryTimeIntervalsDTO from a dict"""
        if obj is None:
            return None
