...
class UserV3ApiResponseDTO(BaseModel):
    """
    The result of the update or insert (upsert) request.
    """ # noqa: E501
    ...
    user_group_ids: Optional[List[StrictStr]] = Field(default=None, description="The unique identifiers associated with each user groups.", alias="userGroupIds")
    profile_ids: Optional[List[StrictStr]] = Field(default=None, description="The unique identifiers associated with each profile.", alias="profileIds")
    permission_ids: Optional[List[StrictStr]] = Field(default=None, description="The unique identifiers associated with each permission.", alias="permissionIds")
    __properties: ClassVar[List[str]] = ["userId", "username", "displayName", "employeeId", "accountEnabled", "email", "userGroupIds", "profileIds", "permissionIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of UserV3ApiResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of UserV3ApiResponseDTO from a dict"""
        if obj is None:
            return None
