...
class AnalysisCommonReportListResponseDTO(BaseModel):
    """
    The information of all the reports you have access to in your tenant.
    """ # noqa: E501
    reports: Optional[List[AnalysisCommonReportDTO]] = Field(default=None, description="A list of reports.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalysisCommonReportListResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalysisCommonReportListResponseDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "reports": [AnalysisCommonReportDTO.from_dict(_item) for _item in obj["reports"]] if obj.get("reports") is not None else None
        })
        return _obj
