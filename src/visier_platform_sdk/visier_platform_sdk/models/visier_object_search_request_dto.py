...
class VisierObjectSearchRequestDTO(BaseModel):
    ...
    include_document_id_search: Optional[StrictBool] = Field(default=None, description="If `true`, the search includes document IDs. This is not valid for `DIMENSION_MEMBER` object type. Default is `false`.", alias="includeDocumentIdSearch")
