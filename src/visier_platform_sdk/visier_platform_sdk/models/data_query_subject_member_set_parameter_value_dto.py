...
class DataQuerySubjectMemberSetParameterValueDTO(BaseModel):
    """
    The value for a subject member set parameter.
    """ # noqa: E501
    parameter_id: Optional[StrictStr] = Field(default=None, description="The unique identifier of the subject member set parameter.", alias="parameterId")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataQuerySubjectMemberSetParameterValueDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataQuerySubjectMemberSetParameterValueDTO from a dict"""
        if obj is None:
            return None
