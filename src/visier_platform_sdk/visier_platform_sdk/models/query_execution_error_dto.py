...
class QueryExecutionErrorDTO(BaseModel):
    """
    ...
    all_errors: Optional[List[QueryExecutionErrorsDTO]] = Field(default=None, description="All errors", alias="allErrors")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of QueryExecutionErrorDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of QueryExecutionErrorDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "allErrors": [QueryExecutionErrorsDTO.from_dict(_item) for _item in obj["allErrors"]] if obj.get("allErrors") is not None else None
        })
        return _obj
