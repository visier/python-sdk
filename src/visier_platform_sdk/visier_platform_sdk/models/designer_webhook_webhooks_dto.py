...
class DesignerWebhookWebhooksDTO(BaseModel):
    """
    The returned list of webhooks.
    """ # noqa: E501
    webhooks: Optional[List[DesignerWebhookWebhookDTO]] = Field(default=None, description="A list of webhooks.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerWebhookWebhooksDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerWebhookWebhooksDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "webhooks": [DesignerWebhookWebhookDTO.from_dict(_item) for _item in obj["webhooks"]] if obj.get("webhooks") is not None else None
        })
        return _obj
