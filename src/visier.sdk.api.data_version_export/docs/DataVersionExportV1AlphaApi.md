# visier.sdk.api.data_version_export.DataVersionExportV1AlphaApi
...
with visier.sdk.api.data_version_export.ApiClient(configuration) as api_client:
    # Create an instance of the API class
    api_instance = visier.sdk.api.data_version_export.DataVersionExportV1AlphaApi(api_client)
    data_version_export_schedule_job_request_dto = visier.sdk.api.data_version_export.DataVersionExportScheduleJobRequestDTO() # DataVersionExportScheduleJobRequestDTO | 
