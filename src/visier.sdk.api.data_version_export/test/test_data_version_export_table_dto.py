    ...
    def make_instance(self, include_optional) -> DataVersionExportTableDTO:
        ...
        if include_optional:
            return DataVersionExportTableDTO(
                common_columns = visier.sdk.api.data_version_export.models.data_version_export_file_dto.DataVersionExportFileDTO(
                    columns = [
                ...
                name = '',
                new_columns = visier.sdk.api.data_version_export.models.data_version_export_file_dto.DataVersionExportFileDTO(
                    columns = [
                        visier.sdk.api.data_version_export.models.data_version_export_column_dto.DataVersionExportColumnDTO(
                            allows_null = True, 
                            data_type = '', 
