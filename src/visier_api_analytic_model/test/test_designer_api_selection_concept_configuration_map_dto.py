...
class TestDesignerApiSelectionConceptConfigurationMapDTO(unittest.TestCase):
    ...
    def testDesignerApiSelectionConceptConfigurationMapDTO(self):
        ...
        def validate_instance(instance):
            DesignerApiSelectionConceptConfigurationMapDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerApiSelectionConceptConfigurationMapDTO.from_dict(instance.to_dict())
