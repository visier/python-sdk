...
class TestDesignerApiSelectionConceptDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DesignerApiSelectionConceptDTO:
        ...
        if include_optional:
            return DesignerApiSelectionConceptDTO(
                uuid = '',
                name = '',
                configuration = visier_api_analytic_model.models.designer/api/selection_concept_configuration_dto.designer.api.SelectionConceptConfigurationDTO(
    ...
    def testDesignerApiSelectionConceptDTO(self):
        ...
        def validate_instance(instance):
            DesignerApiSelectionConceptDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerApiSelectionConceptDTO.from_dict(instance.to_dict())
