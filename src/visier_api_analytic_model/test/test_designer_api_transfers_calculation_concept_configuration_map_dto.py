...
class TestDesignerApiTransfersCalculationConceptConfigurationMapDTO(unittest.TestCase):
    """DesignerApiTransfersCalculationConceptConfigurationMapDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignerApiTransfersCalculationConceptConfigurationMapDTO:
        """Test DesignerApiTransfersCalculationConceptConfigurationMapDTO
    ...
    def testDesignerApiTransfersCalculationConceptConfigurationMapDTO(self):
        """Test DesignerApiTransfersCalculationConceptConfigurationMapDTO"""
        def validate_instance(instance):
            DesignerApiTransfersCalculationConceptConfigurationMapDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerApiTransfersCalculationConceptConfigurationMapDTO.from_dict(instance.to_dict())
