...
class TestServicingV2ObjectconfigurationSuccessfulChangeDTO(unittest.TestCase):
    ...
    def testServicingV2ObjectconfigurationSuccessfulChangeDTO(self):
        ...
        def validate_instance(instance):
            ServicingV2ObjectconfigurationSuccessfulChangeDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingV2ObjectconfigurationSuccessfulChangeDTO.from_dict(instance.to_dict())
