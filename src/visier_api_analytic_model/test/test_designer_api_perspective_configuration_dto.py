...
class TestDesignerApiPerspectiveConfigurationDTO(unittest.TestCase):
    """DesignerApiPerspectiveConfigurationDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignerApiPerspectiveConfigurationDTO:
        """Test DesignerApiPerspectiveConfigurationDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DesignerApiPerspectiveConfigurationDTO(
                perspective_id = '',
                perspective_name = '',
                perspective_nodes = [
    ...
    def testDesignerApiPerspectiveConfigurationDTO(self):
        """Test DesignerApiPerspectiveConfigurationDTO"""
        def validate_instance(instance):
            DesignerApiPerspectiveConfigurationDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerApiPerspectiveConfigurationDTO.from_dict(instance.to_dict())
