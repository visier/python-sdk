...
class TestServicingV2ObjectconfigurationAnalyticObjectDefinitionDTO(unittest.TestCase):
    ...
    def testServicingV2ObjectconfigurationAnalyticObjectDefinitionDTO(self):
        ...
        def validate_instance(instance):
            ServicingV2ObjectconfigurationAnalyticObjectDefinitionDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingV2ObjectconfigurationAnalyticObjectDefinitionDTO.from_dict(instance.to_dict())
