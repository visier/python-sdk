...
class TestServicingV2ObjectconfigurationCalculatedPropertyTypeDTO(unittest.TestCase):
    ...
    def testServicingV2ObjectconfigurationCalculatedPropertyTypeDTO(self):
        ...
        def validate_instance(instance):
            ServicingV2ObjectconfigurationCalculatedPropertyTypeDTO.model_validate(inst_req_only)
            instance_deserialized = ServicingV2ObjectconfigurationCalculatedPropertyTypeDTO.from_dict(instance.to_dict())
