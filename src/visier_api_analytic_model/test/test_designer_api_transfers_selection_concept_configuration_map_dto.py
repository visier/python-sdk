...
class TestDesignerApiTransfersSelectionConceptConfigurationMapDTO(unittest.TestCase):
    """DesignerApiTransfersSelectionConceptConfigurationMapDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DesignerApiTransfersSelectionConceptConfigurationMapDTO:
        """Test DesignerApiTransfersSelectionConceptConfigurationMapDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DesignerApiTransfersSelectionConceptConfigurationMapDTO(
    ...
    def testDesignerApiTransfersSelectionConceptConfigurationMapDTO(self):
        """Test DesignerApiTransfersSelectionConceptConfigurationMapDTO"""
        def validate_instance(instance):
            DesignerApiTransfersSelectionConceptConfigurationMapDTO.model_validate(inst_req_only)
            instance_deserialized = DesignerApiTransfersSelectionConceptConfigurationMapDTO.from_dict(instance.to_dict())
