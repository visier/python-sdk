...
class ServicingPublicapiObjectconfigurationPropertyChangeDefinitionDTO(BaseModel):
    """
    ...
    tags: Optional[ServicingPublicapiObjectconfigurationTagsDTO] = Field(default=None, description="The tags associated with the property.")
    type: Optional[ServicingPublicapiObjectconfigurationPropertyTypeDTO] = Field(default=None, description="The type of the property.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiObjectconfigurationPropertyChangeDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiObjectconfigurationPropertyChangeDefinitionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tags": ServicingPublicapiObjectconfigurationTagsDTO.from_dict(obj["tags"]) if obj.get("tags") is not None else None,
            "type": ServicingPublicapiObjectconfigurationPropertyTypeDTO.from_dict(obj["type"]) if obj.get("type") is not None else None
        })
        return _obj
