...
class ServicingObjectconfigurationDimensionChangeDefinitionDTO(BaseModel):
    """
    ServicingObjectconfigurationDimensionChangeDefinitionDTO
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["id", "displayName", "shortDisplayName", "description"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingObjectconfigurationDimensionChangeDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingObjectconfigurationDimensionChangeDefinitionDTO from a dict"""
        if obj is None:
            return None
