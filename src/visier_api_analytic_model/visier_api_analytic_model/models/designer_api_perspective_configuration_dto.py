...
class DesignerApiPerspectiveConfigurationDTO(BaseModel):
    """
    DesignerApiPerspectiveConfigurationDTO
    """ # noqa: E501
    ...
    perspective_nodes: Optional[List[DesignerApiPerspectiveNodeDTO]] = Field(default=None, description="A list of nodes in the perspective.", alias="perspectiveNodes")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerApiPerspectiveConfigurationDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerApiPerspectiveConfigurationDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "perspectiveNodes": [DesignerApiPerspectiveNodeDTO.from_dict(_item) for _item in obj["perspectiveNodes"]] if obj.get("perspectiveNodes") is not None else None
        })
        return _obj
