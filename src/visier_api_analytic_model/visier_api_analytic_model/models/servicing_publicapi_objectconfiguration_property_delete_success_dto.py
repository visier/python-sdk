...
class ServicingPublicapiObjectconfigurationPropertyDeleteSuccessDTO(BaseModel):
    """
    Details about a successful property deletion.
    """ # noqa: E501
    derived_dependents_deleted: Optional[List[ServicingPublicapiObjectconfigurationDependentDTO]] = Field(default=None, description="The derived dependents that were deleted along with the property.", alias="derivedDependentsDeleted")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiObjectconfigurationPropertyDeleteSuccessDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiObjectconfigurationPropertyDeleteSuccessDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "derivedDependentsDeleted": [ServicingPublicapiObjectconfigurationDependentDTO.from_dict(_item) for _item in obj["derivedDependentsDeleted"]] if obj.get("derivedDependentsDeleted") is not None else None,
            "displayName": obj.get("displayName"),
            "id": obj.get("id"),
            "projectId": obj.get("projectId"),
            "referenceDependentsIgnored": [ServicingPublicapiObjectconfigurationDependentDTO.from_dict(_item) for _item in obj["referenceDependentsIgnored"]] if obj.get("referenceDependentsIgnored") is not None else None,
