...
class DataservicesDatamodelMemberParameterDefinitionDTO(BaseModel):
    """
    ...
    default: Optional[DataservicesCommonMemberValuesDTO] = Field(default=None, description="The default value if the end user does not select a member at run time.")
    __properties: ClassVar[List[str]] = ["id", "displayName", "description", "dimensionId", "referencePath", "default"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelMemberParameterDefinitionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelMemberParameterDefinitionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "default": DataservicesCommonMemberValuesDTO.from_dict(obj["default"]) if obj.get("default") is not None else None
        })
        return _obj
