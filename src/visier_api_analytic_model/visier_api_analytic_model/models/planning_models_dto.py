...
class PlanningModelsDTO(BaseModel):
    """
    A collection of planning modules.
    """ # noqa: E501
    models: Optional[List[PlanningModelDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [PlanningModelDTO.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None
        })
        return _obj
