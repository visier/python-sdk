...
class ServicingV2ObjectconfigurationProcessConceptDefinitionDTO(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["analyticObjectName", "includeWithVee", "metricList", "onHoldConceptUuid", "outcomeList", "participationConceptUuid", "propertyList", "stageList", "statusDimensionObjectName", "tagList", "visibleInAnalytics"]
