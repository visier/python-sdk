...
class ServicingPublicapiObjectconfigurationPropertyDeleteFailureDTO(BaseModel):
    """
    Details about a failed property deletion.
    """ # noqa: E501
    derived_dependents_to_delete: Optional[List[ServicingPublicapiObjectconfigurationDependentDTO]] = Field(default=None, description="The derived dependents that would have been deleted if the deletion was successful.", alias="derivedDependentsToDelete")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingPublicapiObjectconfigurationPropertyDeleteFailureDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingPublicapiObjectconfigurationPropertyDeleteFailureDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "derivedDependentsToDelete": [ServicingPublicapiObjectconfigurationDependentDTO.from_dict(_item) for _item in obj["derivedDependentsToDelete"]] if obj.get("derivedDependentsToDelete") is not None else None,
            "displayName": obj.get("displayName"),
            "id": obj.get("id"),
            "message": obj.get("message"),
            "projectId": obj.get("projectId"),
            "rci": obj.get("rci"),
            "referenceDependentsToIgnore": [ServicingPublicapiObjectconfigurationDependentDTO.from_dict(_item) for _item in obj["referenceDependentsToIgnore"]] if obj.get("referenceDependentsToIgnore") is not None else None,
