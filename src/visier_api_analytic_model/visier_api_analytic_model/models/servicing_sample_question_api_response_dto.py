...
class ServicingSampleQuestionAPIResponseDTO(BaseModel):
    """
    ...
    visible_in_vee: Optional[StrictBool] = Field(default=None, description="If `true`, the sample question is visible in Vee.", alias="visibleInVee")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingSampleQuestionAPIResponseDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingSampleQuestionAPIResponseDTO from a dict"""
        if obj is None:
            return None
