...
class SelectionConceptListDTO(BaseModel):
    ...
    """ # noqa: E501
    concepts: Optional[List[SelectionConceptDTO]] = Field(default=None, description="A list of objects representing selection concepts.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "concepts": [SelectionConceptDTO.from_dict(_item) for _item in obj["concepts"]] if obj.get("concepts") is not None else None
        })
        return _obj
