...
class DataservicesDatamodelPredictionsDTO(BaseModel):
    """
    A collection of predictions.
    """ # noqa: E501
    predictions: Optional[List[DataservicesDatamodelPredictionDTO]] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelPredictionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelPredictionsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "predictions": [DataservicesDatamodelPredictionDTO.from_dict(_item) for _item in obj["predictions"]] if obj.get("predictions") is not None else None
        })
        return _obj
