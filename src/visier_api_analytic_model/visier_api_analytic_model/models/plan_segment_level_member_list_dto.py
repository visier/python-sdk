...
class PlanSegmentLevelMemberListDTO(BaseModel):
    """
    A collection of dimension members.
    """ # noqa: E501
    members: Optional[List[PlanSegmentLevelMemberDTO]] = Field(default=None, description="The dimension members.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanSegmentLevelMemberListDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanSegmentLevelMemberListDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "members": [PlanSegmentLevelMemberDTO.from_dict(_item) for _item in obj["members"]] if obj.get("members") is not None else None,
