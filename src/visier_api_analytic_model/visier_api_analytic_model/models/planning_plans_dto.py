...
class PlanningPlansDTO(BaseModel):
    """
    A collection of plan definitions.
    """ # noqa: E501
    plans: Optional[List[PlanningPlanDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "plans": [PlanningPlanDTO.from_dict(_item) for _item in obj["plans"]] if obj.get("plans") is not None else None
        })
        return _obj
