...
class ServicingV2ObjectconfigurationConceptWithContextDTO(BaseModel):
    """
    Information about the concept and the context of the API request, such as the tenant code and project ID.
    """ # noqa: E501
    concept: Optional[ServicingV2ObjectconfigurationConceptDefinitionDTO] = Field(default=None, description="Information about the concept, such as its UUID and concept type.")
    ...
    __properties: ClassVar[List[str]] = ["concept", "executionContext"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingV2ObjectconfigurationConceptWithContextDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingV2ObjectconfigurationConceptWithContextDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "concept": ServicingV2ObjectconfigurationConceptDefinitionDTO.from_dict(obj["concept"]) if obj.get("concept") is not None else None,
