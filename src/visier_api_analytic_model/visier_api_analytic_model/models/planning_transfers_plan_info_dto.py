...
class PlanningTransfersPlanInfoDTO(BaseModel):
    """
    ...
    scenarios: Optional[List[PlanningTransfersScenarioInfoDTO]] = Field(default=None, description="Information about the plan's scenarios.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PlanningTransfersPlanInfoDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PlanningTransfersPlanInfoDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "scenarios": [PlanningTransfersScenarioInfoDTO.from_dict(_item) for _item in obj["scenarios"]] if obj.get("scenarios") is not None else None,
            "uuid": obj.get("uuid")
        })
        return _obj
