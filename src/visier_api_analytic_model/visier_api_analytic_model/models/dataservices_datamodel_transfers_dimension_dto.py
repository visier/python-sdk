...
class DataservicesDatamodelTransfersDimensionDTO(BaseModel):
    """
    ...
    levels: Optional[List[DataservicesDatamodelTransfersLevelDTO]] = Field(default=None, description="The levels defined for the dimension. Note: For parent-child dimensions, a level name is generated by Visier.")
    ...
    __properties: ClassVar[List[str]] = ["description", "displayName", "explanation", "id", "levels", "memberCount", "tags", "unknownMember", "visibleInApp"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelTransfersDimensionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelTransfersDimensionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "levels": [DataservicesDatamodelTransfersLevelDTO.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None,
