...
class DataservicesDatamodelTransfersAggregationTypeParameterDTO(BaseModel):
    """
    ...
    parameter_options: Optional[List[DataservicesDatamodelTransfersAggregationTypeOptionDTO]] = Field(default=None, description="The options defined for the parameter.", alias="parameterOptions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelTransfersAggregationTypeParameterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelTransfersAggregationTypeParameterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "id": obj.get("id"),
            "parameterOptions": [DataservicesDatamodelTransfersAggregationTypeOptionDTO.from_dict(_item) for _item in obj["parameterOptions"]] if obj.get("parameterOptions") is not None else None
        })
        return _obj
