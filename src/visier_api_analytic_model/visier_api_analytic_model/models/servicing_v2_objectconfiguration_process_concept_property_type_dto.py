...
class ServicingV2ObjectconfigurationProcessConceptPropertyTypeDTO(BaseModel):
    """
    A process concept property that takes a value that comes directly from the data and creates a new value through a formula.
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["dataType", "formula", "primitiveType"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of ServicingV2ObjectconfigurationProcessConceptPropertyTypeDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of ServicingV2ObjectconfigurationProcessConceptPropertyTypeDTO from a dict"""
        if obj is None:
            return None
