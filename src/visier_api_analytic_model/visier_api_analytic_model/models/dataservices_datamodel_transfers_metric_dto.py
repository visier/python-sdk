...
class DataservicesDatamodelTransfersMetricDTO(BaseModel):
    """
    ...
    parameters: Optional[List[DataservicesDatamodelTransfersParameterDefinitionDTO]] = Field(default=None, description="The collection of parameters defined for the metric.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelTransfersMetricDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesDatamodelTransfersMetricDTO from a dict"""
        if obj is None:
            return None
