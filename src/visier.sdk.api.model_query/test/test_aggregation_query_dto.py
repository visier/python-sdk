    ...
    def make_instance(self, include_optional) -> AggregationQueryDTO:
        ...
        if include_optional:
            return AggregationQueryDTO(
                axes = [
                    visier.sdk.api.model_query.models.query_axis_dto.QueryAxisDTO(
                ...
                source = visier.sdk.api.model_query.models.aggregation_query_source_dto.AggregationQuerySourceDTO(
                    formula = '', 
                    metric = '', 
                    metrics = null, ),
