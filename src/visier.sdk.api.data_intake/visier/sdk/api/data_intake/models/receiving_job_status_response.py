...
class ReceivingJobStatusResponse(BaseModel):
    ...
    receiving_jobs: Optional[List[Job]] = Field(default=None, description="A list of objects representing the receiving jobs to retrieve.", alias="receivingJobs")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "receivingJobs": [Job.from_dict(_item) for _item in obj["receivingJobs"]] if obj.get("receivingJobs") is not None else None,
