...
from visier.sdk.api.data_intake.api_client import ApiClient, RequestSerialized
from visier.sdk.api.data_intake.api_response import ApiResponse
from visier.sdk.api.data_intake.rest import RESTResponseType
...
class DataIntakeApi:
    ...
    def get_processing_jobs_by_parent_receiving_job_id(
        ...
        _param = self._get_processing_jobs_by_parent_receiving_job_id_serialize(
    ...
    @validate_call
    def get_processing_jobs_by_parent_receiving_job_id_with_http_info(
        self,
        receiving_job_id: Annotated[StrictStr, Field(description="The receiving job ID.")],
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant code of the tenant you want to retrieve the processing jobs for. Use this if you are only interested in the results for one analytic tenant.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of processing jobs to retrieve per page.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetProcessingJobsResponse]:
        """Retrieve processing job statuses by receiving job ID
    ...
    @validate_call
    def get_processing_jobs_by_parent_receiving_job_id_without_preload_content(
        self,
        receiving_job_id: Annotated[StrictStr, Field(description="The receiving job ID.")],
        tenant_code: Annotated[Optional[StrictStr], Field(description="The tenant code of the tenant you want to retrieve the processing jobs for. Use this if you are only interested in the results for one analytic tenant.")] = None,
        limit: Annotated[Optional[StrictInt], Field(description="The limit of processing jobs to retrieve per page.")] = None,
    ...
    def _get_processing_jobs_by_parent_receiving_job_id_serialize(
        self,
        receiving_job_id,
        tenant_code,
        limit,
    ...
    def receiving_job_status(
        self,
        receiving_job_id: Annotated[StrictStr, Field(description="The **dataReceivingJobId** provided after a data transfer session completes. See **`/v1/op/jobs/receiving-jobs`**.")],
        jobs: Annotated[Optional[StrictBool], Field(description="If true, returns the status of receiving jobs spawned by the receiving job specified by receivingJobId.")] = None,
        ...
        :param receiving_job_id: The **dataReceivingJobId** provided after a data transfer session completes. See **`/v1/op/jobs/receiving-jobs`**. (required)
        :type receiving_job_id: str
        :param jobs: If true, returns the status of receiving jobs spawned by the receiving job specified by receivingJobId.
        :type jobs: bool
