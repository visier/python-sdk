...
class DataUploadApi:
    ...
    @validate_call
    def v1alpha_data_upload_files_filename_put(
        self,
        filename: Annotated[StrictStr, Field(description="The filename of the data file to upload, including the file extension (such as .zip or .csv).")],
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
        ...
        """(Deprecated) Upload a data file to Visier
        ...
        :return: Returns the result object.
        """ # noqa: E501
        warnings.warn("PUT /v1alpha/data/upload/files/{filename} is deprecated.", DeprecationWarning)

        _param = self._v1alpha_data_upload_files_filename_put_serialize(
            filename=filename,
            body=body,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def v1alpha_data_upload_files_filename_put_with_http_info(
        self,
        filename: Annotated[StrictStr, Field(description="The filename of the data file to upload, including the file extension (such as .zip or .csv).")],
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def v1alpha_data_upload_files_filename_put_without_preload_content(
        self,
        filename: Annotated[StrictStr, Field(description="The filename of the data file to upload, including the file extension (such as .zip or .csv).")],
        body: Optional[Union[StrictBytes, StrictStr]] = None,
        _request_timeout: Union[
    ...
    def _v1alpha_data_upload_files_filename_put_serialize(
        self,
        filename,
        body,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='PUT',
            resource_path='/v1alpha/data/upload/files/{filename}',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
