...
class VeeClarificationDTO(BaseModel):
    ...
    VeeClarificationDTO
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="If Vee needs more context to answer your question, the follow-up question should address this clarification.")
