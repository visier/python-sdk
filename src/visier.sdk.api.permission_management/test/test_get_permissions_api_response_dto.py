...
class TestGetPermissionsAPIResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> GetPermissionsAPIResponseDTO:
        ...
        # uncomment below to create an instance of `GetPermissionsAPIResponseDTO`
        """
        model = GetPermissionsAPIResponseDTO()
        if include_optional:
            return GetPermissionsAPIResponseDTO(
                permissions = [
                    visier.sdk.api.permission_management.models.permission_dto.PermissionDTO(
