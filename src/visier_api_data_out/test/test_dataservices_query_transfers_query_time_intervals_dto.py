...
class TestDataservicesQueryTransfersQueryTimeIntervalsDTO(unittest.TestCase):
    """DataservicesQueryTransfersQueryTimeIntervalsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryTransfersQueryTimeIntervalsDTO:
        ...
        if include_optional:
            return DataservicesQueryTransfersQueryTimeIntervalsDTO(
                direction = 'BACKWARD',
    ...
    def testDataservicesQueryTransfersQueryTimeIntervalsDTO(self):
        """Test DataservicesQueryTransfersQueryTimeIntervalsDTO"""
        def validate_instance(instance):
            DataservicesQueryTransfersQueryTimeIntervalsDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryTransfersQueryTimeIntervalsDTO.from_dict(instance.to_dict())
