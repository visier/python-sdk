...
class TestQueryDimensionDataMemberSelectionDTO(unittest.TestCase):
    ...
    def testQueryDimensionDataMemberSelectionDTO(self):
        ...
        def validate_instance(instance):
            QueryDimensionDataMemberSelectionDTO.model_validate(inst_req_only)
            instance_deserialized = QueryDimensionDataMemberSelectionDTO.from_dict(instance.to_dict())
