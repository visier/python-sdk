...
class TestDataservicesQueryTransfersCellSetDTO(unittest.TestCase):
    """DataservicesQueryTransfersCellSetDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryTransfersCellSetDTO:
        ...
        if include_optional:
            return DataservicesQueryTransfersCellSetDTO(
                axes = [
                ...
                lineage = visier_api_data_out.models.dataservices/query/transfers/lineage_dto.dataservices.query.transfers.LineageDTO(
                    cell_sets = [
    ...
    def testDataservicesQueryTransfersCellSetDTO(self):
        """Test DataservicesQueryTransfersCellSetDTO"""
        def validate_instance(instance):
            DataservicesQueryTransfersCellSetDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryTransfersCellSetDTO.from_dict(instance.to_dict())
