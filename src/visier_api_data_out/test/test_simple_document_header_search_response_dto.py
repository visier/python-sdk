...
class TestSimpleDocumentHeaderSearchResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleDocumentHeaderSearchResponseDTO:
        ...
        if include_optional:
            return SimpleDocumentHeaderSearchResponseDTO(
                document_headers = [
                    visier_api_data_out.models.simple_document_header_search_result_dto.SimpleDocumentHeaderSearchResultDTO(
                        description = '', 
                        display_name = '', 
                        relevance = 1.337, 
                        view_link = None, )
    ...
    def testSimpleDocumentHeaderSearchResponseDTO(self):
        ...
        def validate_instance(instance):
            SimpleDocumentHeaderSearchResponseDTO.model_validate(inst_req_only)
            instance_deserialized = SimpleDocumentHeaderSearchResponseDTO.from_dict(instance.to_dict())
