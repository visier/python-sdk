...
class TestDownloadSourceFilesResponseDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> DownloadSourceFilesResponseDTO:
        """Test DownloadSourceFilesResponseDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DownloadSourceFilesResponseDTO(
                messages = '',
                status = ''
            )
        else:
    ...
    def testDownloadSourceFilesResponseDTO(self):
        ...
        def validate_instance(instance):
            DownloadSourceFilesResponseDTO.model_validate(inst_req_only)
            instance_deserialized = DownloadSourceFilesResponseDTO.from_dict(instance.to_dict())
