...
class TestDataservicesQueryTransfersListQueryExecutionDTO(unittest.TestCase):
    """DataservicesQueryTransfersListQueryExecutionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryTransfersListQueryExecutionDTO:
        ...
        if include_optional:
            return DataservicesQueryTransfersListQueryExecutionDTO(
                columns = [
    ...
    def testDataservicesQueryTransfersListQueryExecutionDTO(self):
        """Test DataservicesQueryTransfersListQueryExecutionDTO"""
        def validate_instance(instance):
            DataservicesQueryTransfersListQueryExecutionDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryTransfersListQueryExecutionDTO.from_dict(instance.to_dict())
