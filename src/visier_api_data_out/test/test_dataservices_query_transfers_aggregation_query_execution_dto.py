...
class TestDataservicesQueryTransfersAggregationQueryExecutionDTO(unittest.TestCase):
    """DataservicesQueryTransfersAggregationQueryExecutionDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryTransfersAggregationQueryExecutionDTO:
        """Test DataservicesQueryTransfersAggregationQueryExecutionDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DataservicesQueryTransfersAggregationQueryExecutionDTO(
                options = visier_api_data_out.models.dataservices/query/transfers/query_execution_options_dto.dataservices.query.transfers.QueryExecutionOptionsDTO(
                ...
                query = visier_api_data_out.models.dataservices/query/transfers/aggregation_query_dto.dataservices.query.transfers.AggregationQueryDTO(
                    axes = [
    ...
    def testDataservicesQueryTransfersAggregationQueryExecutionDTO(self):
        """Test DataservicesQueryTransfersAggregationQueryExecutionDTO"""
        def validate_instance(instance):
            DataservicesQueryTransfersAggregationQueryExecutionDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryTransfersAggregationQueryExecutionDTO.from_dict(instance.to_dict())
