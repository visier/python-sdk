...
class TestMemberParameterValueDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> MemberParameterValueDTO:
        ...
        if include_optional:
            return MemberParameterValueDTO(
                ...
                values = visier_api_data_out.models.member_values_dto.MemberValuesDTO(
                    excluded = [
    ...
    def testMemberParameterValueDTO(self):
        ...
        def validate_instance(instance):
            MemberParameterValueDTO.model_validate(inst_req_only)
            instance_deserialized = MemberParameterValueDTO.from_dict(instance.to_dict())
