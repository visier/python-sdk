...
class TestDataservicesQueryCellSetAxisDTO(unittest.TestCase):
    """DataservicesQueryCellSetAxisDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryCellSetAxisDTO:
        """Test DataservicesQueryCellSetAxisDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DataservicesQueryCellSetAxisDTO(
    ...
    def testDataservicesQueryCellSetAxisDTO(self):
        """Test DataservicesQueryCellSetAxisDTO"""
        def validate_instance(instance):
            DataservicesQueryCellSetAxisDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryCellSetAxisDTO.from_dict(instance.to_dict())
