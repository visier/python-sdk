...
class TestDataVersionExportScheduleJobRequestDTO(unittest.TestCase):
    ...
    def testDataVersionExportScheduleJobRequestDTO(self):
        ...
        def validate_instance(instance):
            DataVersionExportScheduleJobRequestDTO.model_validate(inst_req_only)
            instance_deserialized = DataVersionExportScheduleJobRequestDTO.from_dict(instance.to_dict())
