...
class TestDataservicesQueryTransfersQueryMemberMapPropertyDTO(unittest.TestCase):
    """DataservicesQueryTransfersQueryMemberMapPropertyDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryTransfersQueryMemberMapPropertyDTO:
        """Test DataservicesQueryTransfersQueryMemberMapPropertyDTO
    ...
    def testDataservicesQueryTransfersQueryMemberMapPropertyDTO(self):
        """Test DataservicesQueryTransfersQueryMemberMapPropertyDTO"""
        def validate_instance(instance):
            DataservicesQueryTransfersQueryMemberMapPropertyDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryTransfersQueryMemberMapPropertyDTO.from_dict(instance.to_dict())
