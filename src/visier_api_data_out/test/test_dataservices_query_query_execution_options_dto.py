...
class TestDataservicesQueryQueryExecutionOptionsDTO(unittest.TestCase):
    """DataservicesQueryQueryExecutionOptionsDTO unit test stubs"""
    ...
    def make_instance(self, include_optional) -> DataservicesQueryQueryExecutionOptionsDTO:
        """Test DataservicesQueryQueryExecutionOptionsDTO
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """

        if include_optional:
            return DataservicesQueryQueryExecutionOptionsDTO(
    ...
    def testDataservicesQueryQueryExecutionOptionsDTO(self):
        """Test DataservicesQueryQueryExecutionOptionsDTO"""
        def validate_instance(instance):
            DataservicesQueryQueryExecutionOptionsDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryQueryExecutionOptionsDTO.from_dict(instance.to_dict())
