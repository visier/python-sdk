...
class TestSimpleDocumentHeaderSearchResultDTO(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> SimpleDocumentHeaderSearchResultDTO:
        ...
        if include_optional:
            return SimpleDocumentHeaderSearchResultDTO(
                ...
                display_name = '',
                relevance = 1.337,
                view_link = visier_api_data_out.models.document_search_link_dto.DocumentSearchLinkDTO(
                    href = '', 
                    verb = '', )
            )
        else:
    ...
    def testSimpleDocumentHeaderSearchResultDTO(self):
        ...
        def validate_instance(instance):
            SimpleDocumentHeaderSearchResultDTO.model_validate(inst_req_only)
            instance_deserialized = SimpleDocumentHeaderSearchResultDTO.from_dict(instance.to_dict())
