...
class TestDataservicesQueryTransfersListQueryExecutionOptionsDTO(unittest.TestCase):
    """DataservicesQueryTransfersListQueryExecutionOptionsDTO unit test stubs"""
    ...
    def testDataservicesQueryTransfersListQueryExecutionOptionsDTO(self):
        """Test DataservicesQueryTransfersListQueryExecutionOptionsDTO"""
        def validate_instance(instance):
            DataservicesQueryTransfersListQueryExecutionOptionsDTO.model_validate(inst_req_only)
            instance_deserialized = DataservicesQueryTransfersListQueryExecutionOptionsDTO.from_dict(instance.to_dict())
