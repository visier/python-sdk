...
class DataservicesQueryQueryNumericRangesDTO(BaseModel):
    """
    A QueryNumericRanges groups data into specified ranges based on a property value.
    """ # noqa: E501
    var_property: Optional[DataservicesQueryQueryPropertyDTO] = Field(default=None, description="The name and qualifying path of a numeric property. Non-numeric properties are not accepted.", alias="property")
    ...
    __properties: ClassVar[List[str]] = ["property", "ranges", "includeNegative", "includeIndependentZeroRange", "includeAllMember"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryQueryNumericRangesDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryQueryNumericRangesDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "property": DataservicesQueryQueryPropertyDTO.from_dict(obj["property"]) if obj.get("property") is not None else None,
