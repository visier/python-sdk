...
class DataservicesQueryPropertyColumnDTO(BaseModel):
    """
    ...
    column_definition: Optional[DataservicesQueryQueryPropertyDTO] = Field(default=None, description="The definition of the property to query on.", alias="columnDefinition")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryPropertyColumnDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryPropertyColumnDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "columnDefinition": DataservicesQueryQueryPropertyDTO.from_dict(obj["columnDefinition"]) if obj.get("columnDefinition") is not None else None
        })
        return _obj
