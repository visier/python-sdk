...
class DataservicesQueryTransfersListQueryExecutionDTO(BaseModel):
    """
    ...
    options: Optional[DataservicesQueryTransfersListQueryExecutionOptionsDTO] = Field(default=None, description="Additional instructions for your query, such as a calendar type or conversion information.")
    ...
    time_interval: Optional[DataservicesQueryTransfersQueryTimeIntervalDTO] = Field(default=None, description="The time that the data is valid, such as a specific day or period of months.", alias="timeInterval")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersListQueryExecutionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersListQueryExecutionDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "options": DataservicesQueryTransfersListQueryExecutionOptionsDTO.from_dict(obj["options"]) if obj.get("options") is not None else None,
            ...
            "timeInterval": DataservicesQueryTransfersQueryTimeIntervalDTO.from_dict(obj["timeInterval"]) if obj.get("timeInterval") is not None else None
        })
        return _obj
