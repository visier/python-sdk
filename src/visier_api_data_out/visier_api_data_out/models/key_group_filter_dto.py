...
class KeyGroupFilterDTO(BaseModel):
    """
    A collection of related filters that define a key group.
    """ # noqa: E501
    filters: Optional[List[KeyGroupFilterItemDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "filters": [KeyGroupFilterItemDTO.from_dict(_item) for _item in obj["filters"]] if obj.get("filters") is not None else None
        })
        return _obj
