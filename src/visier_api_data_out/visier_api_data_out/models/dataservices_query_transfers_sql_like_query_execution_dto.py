...
class DataservicesQueryTransfersSqlLikeQueryExecutionDTO(BaseModel):
    """
    *  Request body for SQL-like query executions
    """ # noqa: E501
    options: Optional[DataservicesQueryTransfersQueryExecutionOptionsDTO] = Field(default=None, description="Optional options that currently that cannot be expressed in SQL-like")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersSqlLikeQueryExecutionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersSqlLikeQueryExecutionDTO from a dict"""
        if obj is None:
            return None
