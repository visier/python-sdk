...
class DataservicesQueryTransfersQueryFilterDTO(BaseModel):
    """
    ...
    member_set: Optional[DataservicesQueryTransfersMemberFilterDTO] = Field(default=None, description="A filter that includes or excludes dimension members.", alias="memberSet")
    selection_concept: Optional[DataservicesDatamodelTransfersSelectionConceptReferenceDTO] = Field(default=None, description="A filter that uses an existing selection concept in Visier.", alias="selectionConcept")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersQueryFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersQueryFilterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cohort": DataservicesQueryTransfersCohortFilterDTO.from_dict(obj["cohort"]) if obj.get("cohort") is not None else None,
            "formula": obj.get("formula"),
            "memberSet": DataservicesQueryTransfersMemberFilterDTO.from_dict(obj["memberSet"]) if obj.get("memberSet") is not None else None,
