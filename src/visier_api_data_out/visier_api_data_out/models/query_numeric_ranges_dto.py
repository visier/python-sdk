...
class QueryNumericRangesDTO(BaseModel):
    """
    ...
    var_property: Optional[QueryPropertyDTO] = Field(default=None, description="The name and qualifying path of a numeric property. Non-numeric properties are not accepted.", alias="property")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "property": QueryPropertyDTO.from_dict(obj["property"]) if obj.get("property") is not None else None,
