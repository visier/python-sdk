...
class DataservicesQueryTransfersQueryDimensionLevelSelectionDTO(BaseModel):
    """
    ...
    level_ids: Optional[List[StrictStr]] = Field(default=None, description="The ordered collection of level identifiers for the dimension. See `Dimension`.", alias="levelIds")
    __properties: ClassVar[List[str]] = ["dimension", "levelIds"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersQueryDimensionLevelSelectionDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersQueryDimensionLevelSelectionDTO from a dict"""
        if obj is None:
            return None
