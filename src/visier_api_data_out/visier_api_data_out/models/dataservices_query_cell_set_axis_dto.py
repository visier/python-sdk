...
class DataservicesQueryCellSetAxisDTO(BaseModel):
    """
    The axis of a cell set associated with a dimension.
    """ # noqa: E501
    dimension: Optional[DataservicesDatamodelDimensionReferenceDTO] = Field(default=None, description="The dimension associated with the axis.")
    positions: Optional[List[DataservicesQueryCellSetAxisPositionDTO]] = Field(default=None, description="A list of paths that represent the data's positions along the axis.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryCellSetAxisDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryCellSetAxisDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "positions": [DataservicesQueryCellSetAxisPositionDTO.from_dict(_item) for _item in obj["positions"]] if obj.get("positions") is not None else None
        })
        return _obj
