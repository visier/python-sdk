...
class AnalysisCommonTransfersVeeFeedbackDTO(BaseModel):
    """
    ...
    response: Optional[AnalysisCommonTransfersVeeResponseDTO] = Field(default=None, description="Your feedback about Vee's answer. Include the response object from the `/question` call that you want to provide feedback about.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalysisCommonTransfersVeeFeedbackDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalysisCommonTransfersVeeFeedbackDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "response": AnalysisCommonTransfersVeeResponseDTO.from_dict(obj["response"]) if obj.get("response") is not None else None
        })
        return _obj
