...
class DataservicesQueryTransfersQueryExecutionOptionsDTO(BaseModel):
    """
    ...
    cell_distribution_options: Optional[DataservicesQueryTransfersCellDistributionOptionsDTO] = Field(default=None, alias="cellDistributionOptions")
    ...
    internal: Optional[DataservicesQueryTransfersInternalQueryExecutionOptionsDTO] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersQueryExecutionOptionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersQueryExecutionOptionsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "cellDistributionOptions": DataservicesQueryTransfersCellDistributionOptionsDTO.from_dict(obj["cellDistributionOptions"]) if obj.get("cellDistributionOptions") is not None else None,
            ...
            "internal": DataservicesQueryTransfersInternalQueryExecutionOptionsDTO.from_dict(obj["internal"]) if obj.get("internal") is not None else None,
