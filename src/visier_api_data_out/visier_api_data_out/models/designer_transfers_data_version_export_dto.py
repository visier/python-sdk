...
class DesignerTransfersDataVersionExportDTO(BaseModel):
    """
    ...
    tables: Optional[List[DesignerTransfersDataVersionExportTableDTO]] = Field(default=None, description="Information about the tables in the export.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DesignerTransfersDataVersionExportDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DesignerTransfersDataVersionExportDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "tables": [DesignerTransfersDataVersionExportTableDTO.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None,
