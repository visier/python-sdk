...
class DataservicesQueryListQueryExecutionOptionsDTO(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["limit", "queryMode", "omitHeader", "calendarType", "currencyConversionMode", "currencyConversionDate", "page", "multipleTables", "currencyConversionCode", "recordMode", "dateTimeDisplayMode"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryListQueryExecutionOptionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryListQueryExecutionOptionsDTO from a dict"""
        if obj is None:
            return None
