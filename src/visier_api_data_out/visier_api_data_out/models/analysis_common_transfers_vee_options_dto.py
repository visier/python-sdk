...
class AnalysisCommonTransfersVeeOptionsDTO(BaseModel):
    """
    AnalysisCommonTransfersVeeOptionsDTO
    """ # noqa: E501
    ...
    visual_options: Optional[AnalysisCommonTransfersVeeVisualOptionsDTO] = Field(default=None, description="Specify how to render the visualization.", alias="visualOptions")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalysisCommonTransfersVeeOptionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalysisCommonTransfersVeeOptionsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "visualOptions": AnalysisCommonTransfersVeeVisualOptionsDTO.from_dict(obj["visualOptions"]) if obj.get("visualOptions") is not None else None
        })
        return _obj
