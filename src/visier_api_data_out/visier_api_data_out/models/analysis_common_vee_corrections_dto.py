...
class AnalysisCommonVeeCorrectionsDTO(BaseModel):
    """
    AnalysisCommonVeeCorrectionsDTO
    """ # noqa: E501
    ...
    clarifications: Optional[List[AnalysisCommonVeeClarificationDTO]] = Field(default=None, description="A list of clarifying questions if Vee needs more context to answer your question; for example, if asking about someone named Adam, Vee might clarify which Adam by asking for Adam's email address.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalysisCommonVeeCorrectionsDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalysisCommonVeeCorrectionsDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "clarifications": [AnalysisCommonVeeClarificationDTO.from_dict(_item) for _item in obj["clarifications"]] if obj.get("clarifications") is not None else None
        })
        return _obj
