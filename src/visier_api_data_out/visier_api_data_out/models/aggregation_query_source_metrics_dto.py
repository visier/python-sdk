...
class AggregationQuerySourceMetricsDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    columns: Optional[List[AggregationQuerySourceMetricDTO]] = Field(default=None, description="An array of metric columns.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [AggregationQuerySourceMetricDTO.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
