...
class AnalysisCommonVeeClarificationDTO(BaseModel):
    """
    AnalysisCommonVeeClarificationDTO
    """ # noqa: E501
    message: Optional[StrictStr] = Field(default=None, description="Returned if Vee needs more context to answer your question.")
    questions: Optional[List[StrictStr]] = Field(default=None, description="Additional questions you can ask that are similar or related to your question.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AnalysisCommonVeeClarificationDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AnalysisCommonVeeClarificationDTO from a dict"""
        if obj is None:
            return None
