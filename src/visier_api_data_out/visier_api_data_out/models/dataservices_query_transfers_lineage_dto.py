...
class DataservicesQueryTransfersLineageDTO(BaseModel):
    """
    Lineage information for a given cell set. This describes how a cell set is created from other cell sets.
    """ # noqa: E501
    cell_sets: Optional[List[DataservicesQueryTransfersCellSetDTO]] = Field(default=None, description="The cell sets that constitute this lineage.", alias="cellSets")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersLineageDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryTransfersLineageDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "cellSets": [DataservicesQueryTransfersCellSetDTO.from_dict(_item) for _item in obj["cellSets"]] if obj.get("cellSets") is not None else None,
            "op": obj.get("op")
        })
        return _obj
...
DataservicesQueryTransfersLineageDTO.model_rebuild(raise_errors=False)
