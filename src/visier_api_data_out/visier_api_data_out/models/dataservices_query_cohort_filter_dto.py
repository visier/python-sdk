...
class DataservicesQueryCohortFilterDTO(BaseModel):
    """
    ...
    """ # noqa: E501
    key_group: Optional[DataservicesQueryKeyGroupFilterDTO] = Field(default=None, description="A key group is a collection of filters that define the shape of the analysis population.", alias="keyGroup")
    ...
    time_interval: Optional[DataservicesQueryQueryTimeIntervalDTO] = Field(default=None, description="The time at which to apply the key group, such as a specific day or period of months.", alias="timeInterval")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryCohortFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryCohortFilterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "keyGroup": DataservicesQueryKeyGroupFilterDTO.from_dict(obj["keyGroup"]) if obj.get("keyGroup") is not None else None,
