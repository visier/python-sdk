...
class DataservicesQueryQueryFilterDTO(BaseModel):
    """
    ...
    selection_concept: Optional[DataservicesDatamodelSelectionConceptReferenceDTO] = Field(default=None, description="A filter that uses an existing selection concept in Visier.", alias="selectionConcept")
    member_set: Optional[DataservicesQueryMemberFilterDTO] = Field(default=None, description="A filter that includes or excludes dimension members.", alias="memberSet")
    cohort: Optional[DataservicesQueryCohortFilterDTO] = Field(default=None, description="A filter that identifies a population at a specific time.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of DataservicesQueryQueryFilterDTO from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of DataservicesQueryQueryFilterDTO from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "memberSet": DataservicesQueryMemberFilterDTO.from_dict(obj["memberSet"]) if obj.get("memberSet") is not None else None,
            "cohort": DataservicesQueryCohortFilterDTO.from_dict(obj["cohort"]) if obj.get("cohort") is not None else None
        })
        return _obj
