...
from visier_api_core import RESTResponseType
from visier_api_data_in import StartTransferResponse, PushDataResponse, PushDataCompleteRequest, \
...
class TestDataIntakeApi(unittest.TestCase):
    ...
    def test_upload_data(self) -> None:
        ...
        try:
            ...
            push_complete_response = self.get_dto_from_response(push_complete_rest_response, PushDataCompleteResponse)
